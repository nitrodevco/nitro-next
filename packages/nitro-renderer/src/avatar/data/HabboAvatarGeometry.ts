            ...
            avatarSets: [
                {
                    ...
                    bodyParts: [
                        ...
                        {
                            id: AvatarBodyPartType.PetLeft,
                        },
                        {
                            id: AvatarBodyPartType.RightArm,
                        },
                        {
                            id: AvatarBodyPartType.PetRight,
                        },
                    ],
                },
                {
            ...
            bodyParts: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            id: AvatarFigurePartType.MiscLeft,
                            x: 0,
                            y: 0,
                            z: 0,
                            radius: 0.026,
                ...
                },
                {
                    ...
                    z: -0.51,
                    radius: 0.5,
                    orderBefore: AvatarBodyPartType.LeftArm,
                    items: [
                        {
                            id: AvatarFigurePartType.PetLeft,
                            x: 0,
                            y: 0,
                            z: 0,
                            radius: 0.027,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            id: AvatarFigurePartType.MiscRight,
                            x: 0,
                            y: 0,
                            z: 0,
                            radius: 0.026,
                ...
                },
                {
                    ...
                    z: -0.51,
                    radius: 0.5,
                    orderBefore: AvatarBodyPartType.RightArm,
                    items: [
                        {
                            id: AvatarFigurePartType.PetRight,
                            x: 0,
                            y: 0,
                            z: 0,
                            radius: 0.027,
