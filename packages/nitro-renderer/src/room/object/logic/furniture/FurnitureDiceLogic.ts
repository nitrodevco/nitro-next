import type { IRoomGeometry, IRoomSpriteMouseEvent, RoomObjectEvent } from '@nitrodevco/nitro-api';
import { MouseEventType, RoomObjectFurnitureActionEvent } from '@nitrodevco/nitro-api';
