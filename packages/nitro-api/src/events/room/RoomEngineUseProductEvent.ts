...
export class RoomEngineUseProductEvent extends RoomEngineObjectEvent {
    public static USE_PRODUCT_FROM_ROOM: string = 'ROSM_USE_PRODUCT_FROM_ROOM' as const;
    public static USE_PRODUCT_FROM_INVENTORY: string = 'ROSM_USE_PRODUCT_FROM_INVENTORY' as const;
