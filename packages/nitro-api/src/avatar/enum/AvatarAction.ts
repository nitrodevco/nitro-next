export class AvatarAction {
    ...
    public static getExpressionTimeout(expressionId: number): number {
        expressionId = parseInt(expressionId.toString());
    ...
    public static getExpression(expressionId: number): string | undefined {
        if (expressionId > AvatarAction.EXPRESSION_MAP.length) return undefined;
    ...
    public static getGesture(gestureId: number): string | undefined {
        if (gestureId > AvatarAction.GESTURE_MAP.length) return undefined;
