...
const ICON_ASSETS = {
    ...
    'icon-nav-view-mini': { url: '/assets/flash/navigator/mini_view.png', width: 11, height: 19 },
    'icon-nav-usercount': { url: '/assets/flash/navigator/usercount.png', width: 18, height: 18 },
    'icon-nav-quicklink-add': { url: '/assets/flash/navigator/quicklink_add.png', width: 18, height: 19 },
    'icon-nav-quicklink-remove': { url: '/assets/flash/navigator/quicklink_remove.png', width: 10, height: 10 },
    'icon-nav-room-info': { url: '/assets/flash/navigator/show_room_info.png', width: 18, height: 18 },
    'icon-nav-category-show-more': { url: '/assets/flash/navigator/category_show_more.png', width: 11, height: 19 },
    'icon-nav-default-room': { url: '/assets/flash/navigator/default_room.png', width: 110, height: 110 },
    'icon-nav-create-room': { url: '/assets/flash/navigator/create_room.png', width: 187, height: 59 },
    'icon-nav-random-room': { url: '/assets/flash/navigator/random_room.png', width: 187, height: 59 },
    'icon-nav-promote-room': { url: '/assets/flash/navigator/promote_room.png', width: 187, height: 59 },
    'icon-nav-small-pen': { url: '/assets/flash/navigator/small_pen.png', width: 17, height: 18 },
    'icon-nav-doormode-doorbell': { url: '/assets/flash/navigator/doormode_doorbell_small.png', width: 13, height: 16 },
    'icon-nav-doormode-password': { url: '/assets/flash/navigator/doormode_password_small.png', width: 13, height: 16 },
    'icon-nav-doormode-invisible': { url: '/assets/flash/navigator/doormode_invisible_small.png', width: 13, height: 16 },
    'icon-nav-room-group': { url: '/assets/flash/navigator/icon_group.png', width: 13, height: 11 },
    'icon-nav-close': { url: '/assets/flash/icons/close.png', width: 20, height: 20 },
