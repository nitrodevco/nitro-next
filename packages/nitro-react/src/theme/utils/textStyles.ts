...
export const TEXT_STYLES = {
    ...
    'text-style-headline-big': { fontFamily: 'GoldfishBold', fontSize: 18, habboKey: 'headline_big' },
    'text-style-headline-medium': { fontFamily: 'GoldfishBold', fontSize: 9, habboKey: 'headline_medium' },
    'text-style-headline-small': { fontFamily: 'GoldfishBold', fontSize: 9, habboKey: 'headline_small' },
