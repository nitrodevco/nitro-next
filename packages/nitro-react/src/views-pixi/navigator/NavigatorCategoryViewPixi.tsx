...
export interface NavigatorCategoryViewPixiProps {
 ...
 * equivalent and are dropped throughout this file - same for NavigatorRoomEntryViewPixi.tsx.
 */
export const NavigatorCategoryViewPixi = ({ block, onEnter, onShowInfo, onCollapse, onShowMore, onBack, onAddQuickLink, onToggleMode }: NavigatorCategoryViewPixiProps) => {
