...
export interface CatalogOfferImageViewPixiProps {
 ...
 */
export const CatalogOfferImageViewPixi = ({ offer }: CatalogOfferImageViewPixiProps) => {
    ...
    return <pixiSprite texture={texture} width={width} height={height} layout={{}} />;
};
