...
import { Box, ColorLayer, getPixiTextStyle, NitroIcon, useTextureFromUrl } from '#base/theme-pixi';
            ...
            >
                ...
                <Box layout={{ position: 'relative', flexDirection: 'row', alignItems: 'center', flex: 1, minHeight: 16 }}>
                    ...
                    <Box layout={{ flexDirection: 'row', alignItems: 'center', flex: 1, paddingLeft: 10, paddingRight: 10, justifyContent: 'space-between' }}>
                        <pixiText layout={{}} text={node.localization} style={getPixiTextStyle('text-style-u-bold', { fill: node.isActive ? '#ffffff' : '#666666' })} />
