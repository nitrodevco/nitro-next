...
export const CatalogPurchaseConfirmationViewPixi = () => {
    ...
    return (
        <Frame id="catalog-purchase-confirmation" variant="3" layout={{ position: 'absolute', top: 20, left: 480, width: 325, height: 240 }} caption={t('catalog.purchase_confirmation.title')} onClose={cancelPurchase}>
            <Box layout={{ flexDirection: 'column', alignItems: 'center', padding: 8, gap: 8, width: '100%', height: '100%' }}>
                <Box layout={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%' }}>
                    <Border variant="0" layout={{ width: 126, height: 152, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Box layout={{ flexDirection: 'row', gap: 8, width: '100%', height: '100%' }}>
                    <Button variant="3" onPress={cancelPurchase} layout={{ width: '100%' }}>{t('catalog.purchase_confirmation.cancel')}</Button>
                    <ButtonThick variant="3" tintColor="#00aa00" textColor="#ffffff" onPress={purchase} disabled={purchaseState === 'busy'} layout={{ width: '100%' }}>
