...
export const InfostandUserViewPixi = ({ objectData, onClose }: InfostandUserViewPixiProps) => {
        ...
        <Box layout={{ flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
            <Border variant="1" layout={{ flexDirection: 'column', minWidth: 190, maxWidth: 190, gap: 5, padding: 10 }}>
                ...
                <Box layout={{ flexDirection: 'row', width: '100%', gap: 8 }}>
                    <Border variant="0" tintColor="#666666" layout={{ width: 67, height: 130, justifyContent: 'center', alignItems: 'center' }}>
                        {avatarTexture && <pixiSprite texture={avatarTexture} width={avatarWidth} height={avatarHeight} layout={{}} />}
                    </Border>
                    <Box layout={{ flexDirection: 'column', width: '100%', gap: 4 }}>
                        <Box layout={{ flexDirection: 'row', width: '100%', height: 42, gap: 4 }}>
                            <ColorLayer color="#000000" layout={{ width: 42, height: 42 }} />
                            <ColorLayer color="#000000" layout={{ width: 42, height: 42 }} />
                        </Box>
                        <Box layout={{ flexDirection: 'row', width: '100%', height: 42, gap: 4 }}>
                            <ColorLayer color="#000000" layout={{ width: 42, height: 42 }} />
                ...
                <Border variant="0" tintColor="#666666" layout={{ flexDirection: 'row', alignItems: 'center', gap: 4, width: '100%', minHeight: 25, paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2 }}>
                    ...
                    {userData.isOwnUser && (
                        <>
                            <Box eventMode="static" cursor="pointer" onPointerTap={() => setIsEditingMotto(true)} layout={{ flexShrink: 0 }}>
