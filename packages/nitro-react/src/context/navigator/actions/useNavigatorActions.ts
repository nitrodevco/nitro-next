...
const actions = {
    ...
    setEnteredRoom: state.setEnteredRoom,
    updateEnteredRoom: state.updateEnteredRoom,
    setRoomRating: state.setRoomRating,
    setRoomFavourite: state.setRoomFavourite,
    setFavouriteRooms: state.setFavouriteRooms,
