 ...
 */
const actions = {
    setWiredPreferences: state.setWiredPreferences,
    setPreferredWiredStyle: state.setPreferredWiredStyle,
    setWiredPermissions: state.setWiredPermissions,
};

export const useWiredPreferencesActions = () => actions;
