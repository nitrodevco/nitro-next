...
export const ILLUMINA_WIRED_STYLE: WiredStyle = {
    ...
    templates: {
        ...
        text: { textStyle: 'text-style-il-regular', bold: false, color: null, height: 16 },
        textBold: { textStyle: 'text-style-il-regular', bold: true, color: null, height: 16 },
        html: { textStyle: 'text-style-il-regular', bold: false, color: null, height: 16 },
        input: {
            width: 178, height: 21, borderVariant: '105',
            fieldLeft: 4, fieldTop: 2, fieldRight: 4, fieldBottom: 3,
            textStyle: 'text-style-il-regular', textColor: '#4a4a4a', backgroundColor: '#ffffff',
        ...
        button: { variant: '102', width: 49, height: 22, textStyle: 'text-style-il-button' },
        assetButton: { variant: '102', size: 25, assetInset: 5, assetSize: 15 },
        ...
        quickMenu: {
            ...
            text: { textStyle: 'text-style-il-regular', bold: false, color: null, height: 16, x: 28, y: 3 },
