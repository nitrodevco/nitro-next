...
export const VOLTER_WIRED_STYLE: WiredStyle = {
    ...
    templates: {
        ...
        text: { textStyle: 'text-style-regular', bold: false, color: '#ffffff', height: 13 },
        textBold: { textStyle: 'text-style-bold', bold: false, color: '#ffffff', height: 13 },
        html: { textStyle: 'text-style-regular', bold: false, color: '#ffffff', height: 13 },
        input: {
            width: 112, height: 15, borderVariant: null,
            fieldLeft: 0, fieldTop: 0, fieldRight: 0, fieldBottom: 0,
            textStyle: 'text-style-regular', textColor: '#ffffff', backgroundColor: null,
        ...
        button: { variant: '1', width: 41, height: 22, textStyle: 'text-style-button-regular' },
        assetButton: { variant: '1', size: 25, assetInset: 5, assetSize: 15 },
        ...
        quickMenu: {
            ...
            text: { textStyle: 'text-style-regular', bold: false, color: '#ffffff', height: 13, x: 28, y: 3 },
