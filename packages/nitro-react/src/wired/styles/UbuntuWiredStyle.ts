...
export const UBUNTU_WIRED_STYLE: WiredStyle = {
    ...
    templates: {
        ...
        text: { textStyle: 'text-style-u-regular', bold: false, color: null, height: 17 },
        textBold: { textStyle: 'text-style-u-bold', bold: false, color: null, height: 17 },
        html: { textStyle: 'text-style-u-regular', bold: false, color: null, height: 17 },
        input: {
            width: 178, height: 24, borderVariant: '4',
            fieldLeft: 5, fieldTop: 3, fieldRight: 5, fieldBottom: 3,
            textStyle: 'text-style-u-regular', textColor: '#000000', backgroundColor: '#ffffff',
        ...
        button: { variant: '3', width: 43, height: 24, textStyle: 'text-style-button-shiny-regular' },
