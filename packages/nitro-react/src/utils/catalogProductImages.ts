/**
 * The catalogue pictures some offers show instead of their product - `§_-L1t§.PRODUCT_IMAGES`
 * (`catalog/viewer`), read by the purchase confirmation (`CatalogOfferImageView`) and the product
 * view. Checked against Flash by `scripts/drift/constants.py`.
 */
