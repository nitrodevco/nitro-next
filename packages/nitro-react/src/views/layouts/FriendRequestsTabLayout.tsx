...
export const FriendRequestsTabLayout = ({ layout, onButtonAccept, onButtonAcceptAll, onButtonClose }: FriendRequestsTabLayoutProps) => {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('friendbar.requests.title')}
                    ...
                    >
                        ...
                        >
                            <Region
                                ...
                                layout={{ width: 196, height: 50, flexShrink: 0 }}
                            >
                                <Region
                                    name="region_profile"
                                    params={145}
