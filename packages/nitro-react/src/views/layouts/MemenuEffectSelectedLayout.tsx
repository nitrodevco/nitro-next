...
export const MemenuEffectSelectedLayout = ({ layout }: MemenuEffectSelectedLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 154, height: 52, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widgets.memenu.effects.active.timeleft')}
                    ...
                    >
                        <ThemeText text={t('widget.memenu.effectname')} />
                    </Region>
                    <Region
