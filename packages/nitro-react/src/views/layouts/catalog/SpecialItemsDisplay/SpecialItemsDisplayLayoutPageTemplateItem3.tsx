...
export const SpecialItemsDisplayLayoutPageTemplateItem3 = ({ layout, onPageTemplate, srcPageImage, visiblePageImage }: SpecialItemsDisplayLayoutPageTemplateItem3Props) => {
    return (
        <Region
            name="page_template"
