...
export const LayoutSpacesNew_1657Layout = ({ layout, onGroupFloors, onGroupViews, onGroupWalls, srcCatalogFloorPreviewExample, srcCatalogSpacePreviewWindow, srcCatalogWallPreviewBRight }: LayoutSpacesNew_1657LayoutProps) => {
