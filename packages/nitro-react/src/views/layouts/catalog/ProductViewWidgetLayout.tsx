...
export const ProductViewWidgetLayout = ({ captionCtlgDescription, captionCtlgProductName, layout, onRoomCanvasContainer, onRotateAvatarLeft, onRotateAvatarRight, onTogglePreviewMagic, onTogglePreviewZoom, srcCtlgTeaserimg1, srcRecyclableIcon, srcTradeableIcon }: ProductViewWidgetLayoutProps) => {
    return (
