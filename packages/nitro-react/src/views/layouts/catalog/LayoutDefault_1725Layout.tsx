...
import { SoldLtdItemsWidget2, SoldLtdItemsWidget2Props } from '#base/views/layouts/catalog/widgets/SoldLtdItemsWidget2';
...
export interface LayoutDefault_1725LayoutProps {
    ...
    soldLtdItemsWidget?: SoldLtdItemsWidget2Props;
