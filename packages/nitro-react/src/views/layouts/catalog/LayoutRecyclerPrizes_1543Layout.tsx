...
export const LayoutRecyclerPrizes_1543Layout = ({ captionCtlgDescription, captionCtlgProductName, captionCtlgSelectproduct, layout, srcCtlgTeaserimg1 }: LayoutRecyclerPrizes_1543LayoutProps) => {
