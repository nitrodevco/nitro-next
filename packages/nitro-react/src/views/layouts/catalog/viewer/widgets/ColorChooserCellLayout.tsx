...
export const ColorChooserCellLayout = ({ layout, onColorChooserCell, srcBorder, srcChosen, srcColor, tintBorder, tintChosen, tintColor }: ColorChooserCellLayoutProps) => {
    return (
