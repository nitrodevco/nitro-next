...
export const LayoutBuildersClubAddonsLayout = ({ captionCtlgDescription, captionDiamondsPrice, captionItemHeader, captionItemPrice, captionTrialWarning, layout, onItemBuy, srcDiamondsIcon }: LayoutBuildersClubAddonsLayoutProps) => {
