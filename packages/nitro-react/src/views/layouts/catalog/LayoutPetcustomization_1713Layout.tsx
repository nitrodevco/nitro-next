...
export const LayoutPetcustomization_1713Layout = ({ captionCtlgDescription, captionCtlgProductName, captionCtlgSelectproduct, layout, srcCtlgTeaserimg1, visiblePetPreviewBackground }: LayoutPetcustomization_1713LayoutProps) => {
