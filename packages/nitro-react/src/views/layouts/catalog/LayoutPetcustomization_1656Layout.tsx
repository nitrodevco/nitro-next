...
export const LayoutPetcustomization_1656Layout = ({ captionCtlgDescription, captionCtlgProductName, captionCtlgSelectproduct, layout, srcCtlgTeaserimg1, visiblePetPreviewBackground }: LayoutPetcustomization_1656LayoutProps) => {
