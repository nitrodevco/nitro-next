...
export const CatalogUbuntuLayoutBuildersClubTopitemTemplateItem = ({ captionItemTitle, itemHilightInner, layout, onBuildersClubTopitemTemplate, srcIcon, visibleDropButton, visibleIcon, visibleItemHilightInner, visibleItemHilightOuter, visibleItemTitle }: CatalogUbuntuLayoutBuildersClubTopitemTemplateItemProps) => {
    return (
        <Region
