...
export const CatalogUbuntuLayoutBuildersClubSubitemTemplateItem = ({ captionItemTitle, itemHilightInner, layout, onBuildersClubSubitemTemplate, srcIcon, visibleDropButton, visibleIcon, visibleItemHilightInner, visibleItemHilightOuter, visibleItemTitle }: CatalogUbuntuLayoutBuildersClubSubitemTemplateItemProps) => {
    return (
        <Region
        ...
        >
            ...
            {(visibleItemTitle ?? true) && (
                <ThemeText
                    ...
                    name="item_title"
                    layout={{ position: 'absolute', left: 42, right: 82, top: 1, height: 17 }}
                />
            )}
