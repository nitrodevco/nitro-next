...
export const LayoutSingleBundle_1643Layout = ({ captionCtlgDescription, captionCtlgSpecialTxt, captionCtlgText1, layout, srcCtlgSpecialImg, srcCtlgTeaserimg1 }: LayoutSingleBundle_1643LayoutProps) => {
