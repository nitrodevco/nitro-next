...
export const LayoutMarketplace_1621Layout = ({ captionStatusText, itemsOfferList, layout, onSearchAdvanced, onSearchByActivity, onSearchByValue }: LayoutMarketplace_1621LayoutProps) => {
...
export const LayoutMarketplace_1621LayoutOfferItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemUsageState, captionOfferCount, layout, onBuyButton, onMoreButton, srcItemImage, srcUniqueItemBackgroundBitmap }: LayoutMarketplace_1621LayoutOfferItemItemProps) => {
    const t = useTranslation();
