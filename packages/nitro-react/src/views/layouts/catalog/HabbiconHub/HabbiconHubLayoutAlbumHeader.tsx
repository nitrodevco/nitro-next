        ...
        >
            ...
            >
                ...
                <ThemeText
                    ...
                    name="album_title"
                    layout={{ position: 'absolute', left: 100, width: 95, top: 14, height: 24 }}
                />
                <ThemeText
                    ...
                    name="album_subtitle"
                    verticalAlign="top"
                    layout={{ position: 'absolute', left: 100, width: 220, top: 39, height: 32 }}
                />
                <Border
                    variant="7"
                ...
                >
                    <ThemeText
                        ...
                        layout={{ position: 'absolute', left: 6, right: 6, top: 5, height: 15 }}
                    />
                    <ThemeText
                        ...
                        layout={{ position: 'absolute', left: 6, right: 6, top: 20, height: 18 }}
                    />
                </Border>
                <Border
                    variant="7"
                ...
                >
                    ...
                    <ThemeText
                        ...
                        layout={{ position: 'absolute', left: 312, width: 28, top: 3, height: 17 }}
                    />
                </Region>
            </Border>
        </Region>
