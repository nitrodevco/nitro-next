...
export const LayoutGuildFrontpage_1668Layout = ({ captionCtlgDescription, captionCtlgSpecialTxt, layout, onStartGuildPurchase, srcCtlgTeaserimg1 }: LayoutGuildFrontpage_1668LayoutProps) => {
