...
export const LayoutSoundmachine_1654Layout = ({ captionCtlgDescription, captionCtlgProductName, captionCtlgSelectproduct, captionCtlgSongLength, captionPlayPreviewText, layout, onListen, srcCtlgTeaserimg1 }: LayoutSoundmachine_1654LayoutProps) => {
