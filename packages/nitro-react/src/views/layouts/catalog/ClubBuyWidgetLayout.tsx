...
export const ClubBuyWidgetLayout = ({ captionClubHeader, captionClubInfo, captionClubLink, captionClubRemaining, layout }: ClubBuyWidgetLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 320, height: 345, ...layout }}>
            <Region
                ...
                params={16}
                layout={{ position: 'absolute', left: 0, width: 320, top: 0, height: 345, justifyContent: 'center' }}
            >
                <Border
                    variant="2"
                    params={16}
