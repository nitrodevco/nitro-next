...
/** Named region `price_container` of LayoutRoomads_1548Layout - configured through the parent's `priceContainer` prop. */
export interface LayoutRoomads_1548LayoutPriceContainerProps {
    layout?: BoxLayout;
}

export const LayoutRoomads_1548LayoutPriceContainer = ({ layout }: LayoutRoomads_1548LayoutPriceContainerProps) => {
    return (
        <Region
...
/** Named region `purchaseWidget` of LayoutRoomads_1548Layout - configured through the parent's `purchaseWidget` prop. */
export interface LayoutRoomads_1548LayoutPurchaseWidgetProps {
    layout?: BoxLayout;
}

export const LayoutRoomads_1548LayoutPurchaseWidget = ({ layout }: LayoutRoomads_1548LayoutPurchaseWidgetProps) => {
    return (
        <Region
            name="purchaseWidget"
            tags={[ 'NO_GIFT_OPTION', 'ROOM_INITIATE_PURCHASE' ]}
            params={1040}
            layout={{ position: 'absolute', left: 0, width: 360, bottom: 14, height: 30, ...layout }}
        />
    );
};

/** Named region `roomAdsCatalogWidget` of LayoutRoomads_1548Layout - configured through the parent's `roomAdsCatalogWidget` prop. */
export interface LayoutRoomads_1548LayoutRoomAdsCatalogWidgetProps {
    captionCtlgText1?: string;
    layout?: BoxLayout;
    onCategoriesList?: () => void;
    onRoomDropMenu?: () => void;
    priceContainer?: LayoutRoomads_1548LayoutPriceContainerProps;
    purchaseWidget?: LayoutRoomads_1548LayoutPurchaseWidgetProps;
}

export const LayoutRoomads_1548LayoutRoomAdsCatalogWidget = ({ captionCtlgText1, layout, onCategoriesList, onRoomDropMenu, priceContainer, purchaseWidget }: LayoutRoomads_1548LayoutRoomAdsCatalogWidgetProps) => {
    ...
    return (
        ...
        >
            ...
            />
            <LayoutRoomads_1548LayoutPriceContainer {...priceContainer} />
            <LayoutRoomads_1548LayoutPurchaseWidget {...purchaseWidget} />
        </Region>
    );
};
...
export interface LayoutRoomads_1548LayoutRoomadsProps {
    ...
    layout?: BoxLayout;
    roomAdsCatalogWidget?: LayoutRoomads_1548LayoutRoomAdsCatalogWidgetProps;
}
...
export const LayoutRoomads_1548LayoutRoomads = ({ captionCtlgPrice1, layout, roomAdsCatalogWidget }: LayoutRoomads_1548LayoutRoomadsProps) => {
    return (
        ...
        >
            ...
            <LayoutRoomads_1548LayoutRoomAdsCatalogWidget {...roomAdsCatalogWidget} />
        </Region>
    );
};
