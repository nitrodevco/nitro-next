...
export interface SingleViewWidgetLayoutProps {
    layout?: BoxLayout;
    singleViewWidget?: SingleViewWidgetLayoutSingleViewWidgetProps;
}
...
export const SingleViewWidgetLayout = ({ layout, singleViewWidget }: SingleViewWidgetLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 158, height: 207, ...layout }}>
            <SingleViewWidgetLayoutSingleViewWidget {...singleViewWidget} />
        </Region>
    );
};

/** Named region `singleViewWidget` of SingleViewWidgetLayout - configured through the parent's `singleViewWidget` prop. */
export interface SingleViewWidgetLayoutSingleViewWidgetProps {
...
export const SingleViewWidgetLayoutSingleViewWidget = ({ captionCtlgDescription, captionCtlgProductName, layout, srcCtlgTeaserimg1 }: SingleViewWidgetLayoutSingleViewWidgetProps) => {
    return (
        <Region
