...
export const LayoutTrophies_1695Layout = ({ captionTrophyDescription, captionTrophyEnscription, layout, onCtlgNextmodelButton, onCtlgPrevmodelButton, srcCtlgTeaserimg1 }: LayoutTrophies_1695LayoutProps) => {
