...
export const CollectibleRewardLayoutTopContainer = ({ captionProductName, captionTitleText, layout, srcGradient, srcRotatingStar }: CollectibleRewardLayoutTopContainerProps) => {
    const t = useTranslation();
