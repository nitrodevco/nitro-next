...
export const LayoutPets_1697Layout = ({ captionCtlgPrice1, captionCtlgText1, captionCtlgText2, captionCtlgText22, captionCtlgText3, captionCtlgText32, captionPetBreedText, layout, onTypeDropMenu, srcCtlgTeaserimg1, srcCtlgTeaserimg12 }: LayoutPets_1697LayoutProps) => {
