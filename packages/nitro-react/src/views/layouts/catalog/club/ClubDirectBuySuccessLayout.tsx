    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <Region layout={{ position: 'absolute', left: 131, width: 289, top: 15, height: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}>
                    <ThemeText
                ...
                <Region layout={{ position: 'absolute', left: 131, width: 292, top: 51, height: 28, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                    <ThemeText
                ...
                <Region layout={{ position: 'absolute', left: 131, width: 287, top: 78, height: 50, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                    <ThemeText
