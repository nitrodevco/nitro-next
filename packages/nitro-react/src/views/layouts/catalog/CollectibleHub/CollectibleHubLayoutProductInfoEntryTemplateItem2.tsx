...
export const CollectibleHubLayoutProductInfoEntryTemplateItem2 = ({ captionProductInfoKey, captionProductInfoValue, layout, visibleProductInfoKey, visibleProductInfoValue }: CollectibleHubLayoutProductInfoEntryTemplateItem2Props) => {
    return (
        <Region
