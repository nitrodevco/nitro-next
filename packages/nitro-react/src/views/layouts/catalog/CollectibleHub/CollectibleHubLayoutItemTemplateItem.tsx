...
export const CollectibleHubLayoutItemTemplateItem = ({ badgeImageWidget, captionNumber, layout, onItemTemplate, petImageWidget, srcBitmap, srcCheckmarkIcon, srcUnknownImage, tintBitmap, visibleBadgeImageWidget, visibleBitmap, visibleBorderBackground, visibleBorderOutline, visibleCheckmarkIcon, visibleNumber, visibleNumberContainer, visiblePetImageWidget, visibleTextBorder, visibleUnknownImage }: CollectibleHubLayoutItemTemplateItemProps) => {
    return (
        <Region
            name="item_template"
