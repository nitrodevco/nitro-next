...
export const LayoutBuildersClubFrontpageLayout = ({ captionCtlgDescription, layout, onSubscribeButton, onSubscribeButtonBig, onSubscribeButtonSms, onTryButton, visibleSubscribeButton, visibleSubscribeButtonBig, visibleSubscribeButtonSms }: LayoutBuildersClubFrontpageLayoutProps) => {
