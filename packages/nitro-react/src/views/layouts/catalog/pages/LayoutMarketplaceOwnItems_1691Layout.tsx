...
export const LayoutMarketplaceOwnItems_1691LayoutCtlgMarketplaceOwnItems = ({ layout, marketPlaceOwnItemsWidget, tags }: LayoutMarketplaceOwnItems_1691LayoutCtlgMarketplaceOwnItemsProps) => {
    return (
        <Region
