...
export const LayoutSpacesNew_1657LayoutCtlgSpacesNew = ({ activityPointDisplayWidget, layout, productViewWidget, purchaseWidget, roomPreviewWidget, spacesNewWidget }: LayoutSpacesNew_1657LayoutCtlgSpacesNewProps) => {
    return (
        ...
        >
            <ProductViewWidget
                noRoomCanvas
                layout={{ position: 'absolute', right: 10, width: 170, top: 150, height: 245 }}
                {...productViewWidget}
            />
            <RoomPreviewWidget
                layout={{ position: 'absolute', right: 0, width: 180, top: 150, height: 275 }}
                {...roomPreviewWidget}
            />
            <PurchaseWidget
            ...
            <ActivityPointDisplayWidget
                layout={{ position: 'absolute', right: 5, width: 175, top: 125, height: 28 }}
                {...activityPointDisplayWidget}
            />
        </Region>
    );
