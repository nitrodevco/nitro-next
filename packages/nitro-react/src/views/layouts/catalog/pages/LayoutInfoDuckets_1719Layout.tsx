...
export const LayoutInfoDuckets_1719LayoutCtlgInfoDuckets = ({ captionCtlgDescription, layout, srcDucketsInfoIllustration, tags }: LayoutInfoDuckets_1719LayoutCtlgInfoDucketsProps) => {
