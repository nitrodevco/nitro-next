...
export interface LayoutInfoPets2_1536LayoutProps {
    ctlgPets2?: LayoutInfoPets2_1536LayoutCtlgPets2Props;
    layout?: BoxLayout;
}

export const LayoutInfoPets2_1536Layout = ({ ctlgPets2, layout }: LayoutInfoPets2_1536LayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 360, height: 460, ...layout }}>
            <LayoutInfoPets2_1536LayoutCtlgPets2 {...ctlgPets2} />
        </Region>
    );
};

/** Named region `ctlg_pets2` of LayoutInfoPets2_1536Layout - configured through the parent's `ctlgPets2` prop. */
export interface LayoutInfoPets2_1536LayoutCtlgPets2Props {
...
export const LayoutInfoPets2_1536LayoutCtlgPets2 = ({ captionCtlgText1, captionCtlgText2, captionCtlgText3, layout, srcCtlgTeaserimg1, tags }: LayoutInfoPets2_1536LayoutCtlgPets2Props) => {
