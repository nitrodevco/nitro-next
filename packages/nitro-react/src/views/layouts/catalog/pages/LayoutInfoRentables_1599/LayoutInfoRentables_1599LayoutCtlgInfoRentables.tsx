...
/** Named region `ctlg_info_rentables` of LayoutInfoRentables_1599Layout - configured through the parent's `ctlgInfoRentables` prop. */
export interface LayoutInfoRentables_1599LayoutCtlgInfoRentablesProps {
                ...
                <Region layout={{ position: 'absolute', left: 10, width: 309, top: 9, bottom: 9, flexDirection: 'column', gap: 3 }}>
                    <Region layout={{ width: 306, height: 47, flexShrink: 0 }}>
                        ...
                        <ThemeText
                            ...
                            name="ctlg_text_1"
                            verticalAlign="top"
                            layout={{ position: 'absolute', left: 31, width: 232, top: 3, height: 44 }}
                        />
                        <ThemeImage
