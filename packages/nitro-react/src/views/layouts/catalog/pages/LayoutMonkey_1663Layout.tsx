...
export interface LayoutMonkey_1663LayoutProps {
    ctlgSpecialImgRegion?: ReactNode;
    ctlgTeaserimg1Region?: ReactNode;
    layout?: BoxLayout;
...
export const LayoutMonkey_1663Layout = ({ ctlgSpecialImgRegion, ctlgTeaserimg1Region, layout, onCtlgSpecialImgRegion, onCtlgTeaserimg1Region, srcCtlgSpecialImg, srcCtlgTeaserimg1 }: LayoutMonkey_1663LayoutProps) => {
    return (
