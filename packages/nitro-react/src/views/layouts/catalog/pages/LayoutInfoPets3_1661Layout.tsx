...
/** Generated from `1661_layout_info_pets3_xml` (layout "ctlg_pets3", 360x460) by scripts/generate-layout-views.ts - do not edit by hand. */
export interface LayoutInfoPets3_1661LayoutProps {
    ctlgPets2?: LayoutInfoPets3_1661LayoutCtlgPets2Props;
    layout?: BoxLayout;
}

export const LayoutInfoPets3_1661Layout = ({ ctlgPets2, layout }: LayoutInfoPets3_1661LayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 360, height: 460, ...layout }}>
            <LayoutInfoPets3_1661LayoutCtlgPets2 {...ctlgPets2} />
        </Region>
    );
};

/** Named region `ctlg_pets2` of LayoutInfoPets3_1661Layout - configured through the parent's `ctlgPets2` prop. */
export interface LayoutInfoPets3_1661LayoutCtlgPets2Props {
...
export const LayoutInfoPets3_1661LayoutCtlgPets2 = ({ captionCtlgText1, captionCtlgText2, captionCtlgText3, layout, srcCtlgTeaserimg1, tags }: LayoutInfoPets3_1661LayoutCtlgPets2Props) => {
