...
export const LayoutInfoRecycler_1578LayoutCtlgRecyclerInfo = ({ captionCtlgDescription, captionCtlgSpecialTxt, layout, srcCtlgTeaserimg1, tags }: LayoutInfoRecycler_1578LayoutCtlgRecyclerInfoProps) => {
