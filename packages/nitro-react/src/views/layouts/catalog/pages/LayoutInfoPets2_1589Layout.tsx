...
export const LayoutInfoPets2_1589LayoutCtlgPets2 = ({ captionCtlgText1, captionCtlgText2, captionCtlgText3, layout, srcCtlgTeaserimg1 }: LayoutInfoPets2_1589LayoutCtlgPets2Props) => {
