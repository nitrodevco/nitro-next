...
export const LayoutInfoPets2_1589Layout = ({ captionCtlgText1, captionCtlgText2, captionCtlgText3, layout, srcCtlgTeaserimg1 }: LayoutInfoPets2_1589LayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 360, height: 460, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    <Region
                        name="ctlg_text_2"
                        layout={{ position: 'absolute', marginLeft: -1.5, marginRight: 1.5, width: 297, top: 72, height: 139, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    <Region
                        name="ctlg_text_3"
                        layout={{ position: 'absolute', marginLeft: 3, marginRight: -3, width: 306, top: 240, height: 44, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
