...
export interface LayoutInfoPets3_1581LayoutProps {
    ctlgPets2?: LayoutInfoPets3_1581LayoutCtlgPets2Props;
    layout?: BoxLayout;
}

export const LayoutInfoPets3_1581Layout = ({ ctlgPets2, layout }: LayoutInfoPets3_1581LayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 360, height: 460, ...layout }}>
            <LayoutInfoPets3_1581LayoutCtlgPets2 {...ctlgPets2} />
        </Region>
    );
};

/** Named region `ctlg_pets2` of LayoutInfoPets3_1581Layout - configured through the parent's `ctlgPets2` prop. */
export interface LayoutInfoPets3_1581LayoutCtlgPets2Props {
