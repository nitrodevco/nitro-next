...
export const LayoutLoyaltyVipBuy_1714Layout = ({ captionVipInfo, captionVipLink, captionVipTitle, layout, srcCtlgTeaserimg1 }: LayoutLoyaltyVipBuy_1714LayoutProps) => {
