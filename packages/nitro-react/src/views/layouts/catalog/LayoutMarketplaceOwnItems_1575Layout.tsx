...
export const LayoutMarketplaceOwnItems_1575Layout = ({ captionRedeemInfo, captionStatusText, itemsItemList, itemsSearchContainer, layout, onMarkAsSeenButton, onRecallAllButton, visibleMarkAsSeenButton }: LayoutMarketplaceOwnItems_1575LayoutProps) => {
...
export const LayoutMarketplaceOwnItems_1575LayoutSearchInputBorderItem = ({ captionSearchPlaceholder, layout, onCancelSearchBtn, visibleCancelSearchBtn }: LayoutMarketplaceOwnItems_1575LayoutSearchInputBorderItemProps) => {
    const t = useTranslation();
...
export const LayoutMarketplaceOwnItems_1575LayoutOngoingItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemTime, layout, onPickButton, srcItemImage, srcUniqueItemBackgroundBitmap }: LayoutMarketplaceOwnItems_1575LayoutOngoingItemItemProps) => {
    const t = useTranslation();
...
export const LayoutMarketplaceOwnItems_1575LayoutSoldItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemSold, layout, srcItemImage, srcUniqueItemBackgroundBitmap }: LayoutMarketplaceOwnItems_1575LayoutSoldItemItemProps) => {
    const t = useTranslation();
...
export const LayoutMarketplaceOwnItems_1575LayoutExpiredItemItem = ({ captionItemDesc, captionItemExpired, captionItemName, layout, srcItemImage, srcUniqueItemBackgroundBitmap }: LayoutMarketplaceOwnItems_1575LayoutExpiredItemItemProps) => {
    const t = useTranslation();
