...
export const VipBenefitsLayout = ({ layout, onClose }: VipBenefitsLayoutProps) => {
    ...
    return (
        ...
        >
            ...
            />
            <Region layout={{ position: 'absolute', left: 0, right: -12, top: 55, height: 30, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                <ThemeText
            ...
            <Region layout={{ position: 'absolute', right: 7, width: 163, top: 98, height: 269, minWidth: 163, maxWidth: 163, minHeight: 269, maxHeight: 269, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                <ThemeText
            ...
            <Region layout={{ position: 'absolute', left: 27, width: 403, bottom: 8, height: 50, minWidth: 403, maxWidth: 403, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                <ThemeText
