...
export interface RecyclerWidgetLayoutSlotsWrapperProps {
    layout?: RecyclerWidgetLayoutLayoutProps;
...
export const RecyclerWidgetLayoutSlotsWrapper = ({ layout, slots }: RecyclerWidgetLayoutSlotsWrapperProps) => {
    return (
        ...
        >
            <RecyclerWidgetLayoutLayout {...layout} />
...
export interface RecyclerWidgetLayoutIndicatorWrapperProps {
    ...
    layout?: RecyclerWidgetLayoutLayout2Props;
}

export const RecyclerWidgetLayoutIndicatorWrapper = ({ indicator, layout }: RecyclerWidgetLayoutIndicatorWrapperProps) => {
    return (
        <Region
        ...
        >
            <RecyclerWidgetLayoutLayout2 {...layout} />
