...
export const TargetedOfferPurchaseConfirmationLayoutDisclaimerItem = ({ layout, onSpendingDisclaimer, visibleSpendingDisclaimer }: TargetedOfferPurchaseConfirmationLayoutDisclaimerItemProps) => {
