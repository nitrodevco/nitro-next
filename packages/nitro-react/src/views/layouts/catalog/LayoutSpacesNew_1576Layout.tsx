...
export const LayoutSpacesNew_1576Layout = ({ layout, onGroupFloors, onGroupViews, onGroupWalls, srcCatalogFloorPreviewExample, srcCatalogSpacePreviewWindow, srcCatalogWallPreviewBRight }: LayoutSpacesNew_1576LayoutProps) => {
