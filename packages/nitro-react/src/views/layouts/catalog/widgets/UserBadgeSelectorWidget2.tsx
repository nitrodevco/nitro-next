...
export const UserBadgeSelectorWidget2 = ({ captionSearchPlaceholder, itemsBadgeGrid, layout, onCancelSearchBtn, visibleCancelSearchBtn }: UserBadgeSelectorWidget2Props) => {
