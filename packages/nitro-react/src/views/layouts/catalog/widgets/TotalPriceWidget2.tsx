...
import { TotalPriceWidgetLayout, TotalPriceWidgetLayoutProps } from '#base/views/layouts/catalog/TotalPriceWidgetLayout';
 ...
 */
export type TotalPriceWidget2Props = Omit<TotalPriceWidgetLayoutProps, 'layout'> & { layout?: BoxLayout };
