 ...
 */
/** Named region `petsWidget` of PetsWidget2 - configured through the parent's `petsWidget` prop. */
export interface PetsWidget2Props extends CatalogWidgetFlags {
...
export const PetsWidget2 = ({ addOnBadgeViewWidget, captionCtlgText1, captionCtlgText2, captionCtlgText3, colourGridWidget, layout, onTypeDropMenu, purchaseWidget, srcCtlgTeaserimg1, tintCtlgTeaserimg1 }: PetsWidget2Props) => {
    ...
    return (
        ...
        >
            ...
            <Dropmenu
                ...
                layout={{ position: 'absolute', left: 10, right: 9, top: 244, height: 25 }}
            />
            <Border
                variant="4"
                tintColor="#cccccc"
                layout={{ position: 'absolute', left: 10, right: 9, top: 288, height: 25 }}
            >
                <TextInput
            ...
            <ColourGridWidget
                layout={{ position: 'absolute', left: 7, right: 5, alignSelf: 'center', height: 73 }}
                {...colourGridWidget}
            />
            <PurchaseWidget
                layout={{ position: 'absolute', left: 0, right: -1, bottom: 2, height: 30 }}
                {...purchaseWidget}
            />
