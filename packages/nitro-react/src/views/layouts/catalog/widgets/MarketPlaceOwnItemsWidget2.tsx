...
export const MarketPlaceOwnItemsWidget2SearchInputBorderItem = ({ captionSearchPlaceholder, layout, onCancelSearchBtn, visibleCancelSearchBtn }: MarketPlaceOwnItemsWidget2SearchInputBorderItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidget2OngoingItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemTime, layout, onPickButton, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidget2OngoingItemItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidget2SoldItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemSold, layout, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidget2SoldItemItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidget2ExpiredItemItem = ({ captionItemDesc, captionItemExpired, captionItemName, layout, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidget2ExpiredItemItemProps) => {
    const t = useTranslation();
