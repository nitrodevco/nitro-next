...
export const MarketPlaceOwnItemsWidget2SearchLabelItem = ({ captionSearchLabel, layout }: MarketPlaceOwnItemsWidget2SearchLabelItemProps) => {
...
/** Named region `cancel_search_btn` of MarketPlaceOwnItemsWidget2 - configured through the parent's `cancelSearchBtn` prop. */
export interface MarketPlaceOwnItemsWidget2CancelSearchBtnProps {
    layout?: BoxLayout;
    onCancelSearchBtn?: () => void;
    visibleCancelSearchBtn?: boolean;
}

export const MarketPlaceOwnItemsWidget2CancelSearchBtn = ({ layout, onCancelSearchBtn, visibleCancelSearchBtn }: MarketPlaceOwnItemsWidget2CancelSearchBtnProps) => {
    return (
        <Region
...
export interface MarketPlaceOwnItemsWidget2SearchInputBorderItemProps {
    cancelSearchBtn?: MarketPlaceOwnItemsWidget2CancelSearchBtnProps;
    captionSearchPlaceholder?: string;
    layout?: BoxLayout;
}

export const MarketPlaceOwnItemsWidget2SearchInputBorderItem = ({ cancelSearchBtn, captionSearchPlaceholder, layout }: MarketPlaceOwnItemsWidget2SearchInputBorderItemProps) => {
    const t = useTranslation();
    ...
    return (
        ...
        >
            ...
            <MarketPlaceOwnItemsWidget2CancelSearchBtn {...cancelSearchBtn} />
        </Border>
    );
};
...
/** Named region `image_container` of MarketPlaceOwnItemsWidget2 - configured through the parent's `imageContainer` prop. */
export interface MarketPlaceOwnItemsWidget2ImageContainerProps {
    layout?: BoxLayout;
    srcItemImage?: string;
    srcUniqueItemBackgroundBitmap?: string;
}

export const MarketPlaceOwnItemsWidget2ImageContainer = ({ layout, srcItemImage, srcUniqueItemBackgroundBitmap }: MarketPlaceOwnItemsWidget2ImageContainerProps) => {
    return (
        <Region
...
/** Row template `ongoing_item` of MarketPlaceOwnItemsWidget2 - pass real rows through its `items…` slot. */
export interface MarketPlaceOwnItemsWidget2OngoingItemItemProps {
    captionItemDesc?: string;
    captionItemName?: string;
    captionItemPrice?: string;
    captionItemTime?: string;
    imageContainer?: MarketPlaceOwnItemsWidget2ImageContainerProps;
    layout?: BoxLayout;
    onPickButton?: () => void;
}

export const MarketPlaceOwnItemsWidget2OngoingItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemTime, imageContainer, layout, onPickButton }: MarketPlaceOwnItemsWidget2OngoingItemItemProps) => {
    const t = useTranslation();
    ...
    return (
        ...
        >
            <MarketPlaceOwnItemsWidget2ImageContainer {...imageContainer} />
            <Region
                name="item_name"
                params={16}
...
/** Named region `image_container` of MarketPlaceOwnItemsWidget2 - configured through the parent's `imageContainer` prop. */
export interface MarketPlaceOwnItemsWidget2ImageContainer2Props {
    layout?: BoxLayout;
    srcItemImage?: string;
    srcUniqueItemBackgroundBitmap?: string;
}

export const MarketPlaceOwnItemsWidget2ImageContainer2 = ({ layout, srcItemImage, srcUniqueItemBackgroundBitmap }: MarketPlaceOwnItemsWidget2ImageContainer2Props) => {
    return (
        <Region
            name="image_container"
            params={16}
...
export interface MarketPlaceOwnItemsWidget2SoldItemItemProps {
    ...
    imageContainer?: MarketPlaceOwnItemsWidget2ImageContainer2Props;
    layout?: BoxLayout;
}

export const MarketPlaceOwnItemsWidget2SoldItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemSold, imageContainer, layout }: MarketPlaceOwnItemsWidget2SoldItemItemProps) => {
    const t = useTranslation();
    ...
    return (
        <Border
            ...
            layout={{ width: 340, height: 58, flexShrink: 0, ...layout }}
        >
            <MarketPlaceOwnItemsWidget2ImageContainer2 {...imageContainer} />
            <Region
                name="item_name"
                params={16}
                layout={{ position: 'absolute', left: 58, width: 74, top: 5, height: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
...
/** Named region `image_container` of MarketPlaceOwnItemsWidget2 - configured through the parent's `imageContainer` prop. */
export interface MarketPlaceOwnItemsWidget2ImageContainer3Props {
    layout?: BoxLayout;
    srcItemImage?: string;
    srcUniqueItemBackgroundBitmap?: string;
}

export const MarketPlaceOwnItemsWidget2ImageContainer3 = ({ layout, srcItemImage, srcUniqueItemBackgroundBitmap }: MarketPlaceOwnItemsWidget2ImageContainer3Props) => {
    return (
        <Region
            name="image_container"
            params={16}
...
export interface MarketPlaceOwnItemsWidget2ExpiredItemItemProps {
    ...
    captionItemName?: string;
    imageContainer?: MarketPlaceOwnItemsWidget2ImageContainer3Props;
    layout?: BoxLayout;
}

export const MarketPlaceOwnItemsWidget2ExpiredItemItem = ({ captionItemDesc, captionItemExpired, captionItemName, imageContainer, layout }: MarketPlaceOwnItemsWidget2ExpiredItemItemProps) => {
    const t = useTranslation();
    ...
    return (
        <Border
            ...
            layout={{ width: 340, height: 58, flexShrink: 0, ...layout }}
        >
            <MarketPlaceOwnItemsWidget2ImageContainer3 {...imageContainer} />
            <Region
                name="item_name"
                params={16}
                layout={{ position: 'absolute', left: 58, width: 74, top: 5, height: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
...
export interface MarketPlaceOwnItemsWidget2Props {
