...
export interface SoldLtdItemsWidgetLayoutProps {
    ...
    visibleCheckMarkeplaceLink?: boolean;
}

export const SoldLtdItemsWidgetLayout = ({ captionCheckMarkeplaceLink, captionNotAvailableText, layout, onCheckMarkeplaceLink, visibleCheckMarkeplaceLink }: SoldLtdItemsWidgetLayoutProps) => {
