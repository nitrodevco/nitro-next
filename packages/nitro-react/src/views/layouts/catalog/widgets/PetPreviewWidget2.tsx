...
export const PetPreviewWidget2 = ({ captionCtlgDescription, captionCtlgProductName, layout, srcCtlgTeaserimg1, tintCtlgTeaserimg1, visiblePetPreviewBackground }: PetPreviewWidget2Props) => {
