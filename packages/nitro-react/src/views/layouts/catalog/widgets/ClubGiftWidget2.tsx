...
import { ClubGiftWidgetLayout, ClubGiftWidgetLayoutProps } from '#base/views/layouts/catalog/ClubGiftWidgetLayout';
 ...
 */
export type ClubGiftWidget2Props = Omit<ClubGiftWidgetLayoutProps, 'layout'> & { layout?: BoxLayout };
