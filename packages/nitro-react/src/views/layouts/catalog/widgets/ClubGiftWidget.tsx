 ...
 */
export type ClubGiftWidgetProps = Omit<ClubGiftWidgetLayoutProps, 'layout' | 'tags'> & { layout?: BoxLayout; tags?: string[] };

export const ClubGiftWidget = ({ layout, tags, ...widget }: ClubGiftWidgetProps) => {
    return (
        <Region
            name="clubGiftWidget"
            tags={tags}
