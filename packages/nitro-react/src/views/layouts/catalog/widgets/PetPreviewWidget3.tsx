...
export interface PetPreviewWidget3Props extends CatalogWidgetFlags {
...
export const PetPreviewWidget3 = ({ captionCtlgDescription, captionCtlgProductName, layout, srcCtlgTeaserimg1, tintCtlgTeaserimg1, visiblePetPreviewBackground }: PetPreviewWidget3Props) => {
    ...
    return (
        ...
        >
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 8, width: 74, top: 12, height: 17 }}
            />
            <ThemeText
                ...
                verticalAlign="top"
                layout={{ position: 'absolute', left: 8, width: 162, top: 31, height: 17 }}
            />
        </Region>
    );
};
