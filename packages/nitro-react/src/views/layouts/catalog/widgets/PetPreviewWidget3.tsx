...
export const PetPreviewWidget3 = ({ captionCtlgDescription, captionCtlgProductName, layout, srcCtlgTeaserimg1, tintCtlgTeaserimg1 }: PetPreviewWidget3Props) => {
    return (
        <Region
        ...
        >
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 0, width: 71, top: 156, height: 17 }}
            />
            <ThemeText
                ...
                verticalAlign="top"
                layout={{ position: 'absolute', left: -2, right: -2, top: 173, height: 17 }}
            />
        </Region>
    );
};
