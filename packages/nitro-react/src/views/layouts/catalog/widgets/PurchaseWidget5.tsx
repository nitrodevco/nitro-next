 ...
 */
export type PurchaseWidget5Props = Omit<PurchaseWidgetLayoutProps, 'layout'> & { layout?: BoxLayout };

export const PurchaseWidget5 = ({ layout, ...widget }: PurchaseWidget5Props) => {
    return (
        <Region
            name="purchaseWidget"
