 ...
 */
/** Named region `addOnBadgeViewWidget` of AddOnBadgeViewWidget3 - configured through the parent's `addOnBadgeViewWidget` prop. */
export interface AddOnBadgeViewWidget3Props {
    layout?: BoxLayout;
}

export const AddOnBadgeViewWidget3 = ({ layout }: AddOnBadgeViewWidget3Props) => {
    return (
        <Region
