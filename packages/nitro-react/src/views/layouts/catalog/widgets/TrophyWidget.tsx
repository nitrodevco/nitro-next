...
export const TrophyWidget = ({ layout, onCtlgNextmodelButton, onCtlgPrevmodelButton, srcCtlgTeaserimg1, tintCtlgTeaserimg1 }: TrophyWidgetProps) => {
    return (
        <Region
            name="trophyWidget"
        ...
        >
            ...
            <ContainerButton
                ...
                layout={{ position: 'absolute', right: 200, width: 30, bottom: 1, height: 30, maxWidth: 100 }}
            >
                <Icon
                    variant="2"
                    name="icon"
            ...
            <ContainerButton
                ...
                layout={{ position: 'absolute', right: 140, width: 30, bottom: 1, height: 30, maxWidth: 100 }}
            >
                <Icon
                    variant="3"
                    name="icon"
