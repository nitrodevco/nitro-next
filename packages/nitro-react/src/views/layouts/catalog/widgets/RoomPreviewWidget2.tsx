...
export interface RoomPreviewWidget2Props {
    layout?: BoxLayout;
...
export const RoomPreviewWidget2 = ({ layout, srcCatalogFloorPreviewExample, srcCatalogSpacePreviewWindow, srcCatalogWallPreviewBRight, tags }: RoomPreviewWidget2Props) => {
    return (
        <Region
