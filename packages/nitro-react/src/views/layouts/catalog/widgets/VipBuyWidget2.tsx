...
export interface VipBuyWidget2Props extends CatalogWidgetFlags {
...
export const VipBuyWidget2 = ({ captionVipInfo, captionVipLink, captionVipTitle, itemsItemListVip, layout, srcCtlgTeaserimg1 }: VipBuyWidget2Props) => {
        ...
        >
            <Region layout={{ position: 'absolute', left: 161, width: 158, top: 3, height: 165, minWidth: 158, maxWidth: 158, minHeight: 165, maxHeight: 165, flexDirection: 'column', gap: 4 }}>
                ...
                <ThemeText
                    ...
                    name="vip_info"
                    verticalAlign="top"
                    layout={{ width: 158, height: 272, flexShrink: 0, minWidth: 158, maxWidth: 158 }}
                />
            </Region>
            <ThemeImage
            ...
            <ThemeText
                ...
                name="vip_link"
                layout={{ position: 'absolute', marginLeft: -8, marginRight: 8, width: 286, top: 330, height: 17 }}
            />
            <Region
                name="item_list_vip"
