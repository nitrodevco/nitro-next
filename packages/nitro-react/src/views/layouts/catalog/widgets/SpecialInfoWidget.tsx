 ...
 */
export type SpecialInfoWidgetProps = Omit<SpecialInfoWidgetLayoutProps, 'layout' | 'tags'> & { layout?: BoxLayout; tags?: string[] };

export const SpecialInfoWidget = ({ layout, tags, ...widget }: SpecialInfoWidgetProps) => {
    return (
        <Region
