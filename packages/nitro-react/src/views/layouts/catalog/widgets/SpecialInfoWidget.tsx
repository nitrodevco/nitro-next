...
import { SpecialInfoWidgetLayout, SpecialInfoWidgetLayoutProps } from '#base/views/layouts/catalog/SpecialInfoWidgetLayout';
 ...
 */
export type SpecialInfoWidgetProps = Omit<SpecialInfoWidgetLayoutProps, 'layout'> & { layout?: BoxLayout };
