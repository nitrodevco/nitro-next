    ...
    return (
        ...
        >
            <ThemeText
                ...
                name="ctlg_text_1"
                layout={{ position: 'absolute', left: 10, width: 142, top: 14, height: 19 }}
            />
            <Dropmenu
                variant="3"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 10, width: 105, top: 83, height: 15 }}
            />
            <Border
                variant="105"
            ...
            <ThemeText
                ...
                textStyle="text-style-u-small"
                layout={{ position: 'absolute', left: 10, width: 132, top: 149, height: 15 }}
            />
            <Border
                variant="105"
            ...
            <ThemeText
                ...
                textStyle="text-style-u-small"
                layout={{ position: 'absolute', left: 10, width: 130, bottom: 119, height: 15 }}
            />
            <Dropmenu
                variant="3"
                name="room_drop_menu"
