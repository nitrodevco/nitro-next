 ...
 */
/** Named region `quantitySelection` of SpinnerWidget - configured through the parent's `quantitySelection` prop. */
export interface SpinnerWidgetQuantitySelectionProps {
...
export interface SpinnerWidgetProps {
...
export const SpinnerWidget = ({ captionTextHeader, layout, onButtonLess, onButtonMore, quantitySelection, visibleButtonLess, visibleButtonMore }: SpinnerWidgetProps) => {
    ...
    return (
        ...
        >
            ...
            <SpinnerWidgetQuantitySelection {...quantitySelection} />
        </Region>
    );
};
