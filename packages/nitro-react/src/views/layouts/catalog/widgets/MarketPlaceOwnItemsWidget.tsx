...
export const MarketPlaceOwnItemsWidgetSearchInputBorderItem = ({ captionSearchPlaceholder, layout, onCancelSearchBtn, visibleCancelSearchBtn }: MarketPlaceOwnItemsWidgetSearchInputBorderItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidgetOngoingItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemTime, layout, onPickButton, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidgetOngoingItemItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidgetSoldItemItem = ({ captionItemDesc, captionItemName, captionItemPrice, captionItemSold, layout, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidgetSoldItemItemProps) => {
    const t = useTranslation();
...
export const MarketPlaceOwnItemsWidgetExpiredItemItem = ({ captionItemDesc, captionItemExpired, captionItemName, layout, srcItemImage, srcUniqueItemBackgroundBitmap, visibleRarityItemOverlayWidget, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayWidget }: MarketPlaceOwnItemsWidgetExpiredItemItemProps) => {
    const t = useTranslation();
