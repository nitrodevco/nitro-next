...
export const SpinnerWidget2 = ({ captionPromoInfo, captionQuantityLabel, captionTextHeader, layout, onButtonLess, onButtonMore, srcThumbStar, visibleButtonLess, visibleButtonMore, visibleDiscountContainer, visibleTextHeader }: SpinnerWidget2Props) => {
