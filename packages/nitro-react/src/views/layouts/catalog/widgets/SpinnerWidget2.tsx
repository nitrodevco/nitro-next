 ...
 */
export type SpinnerWidget2Props = Omit<SpinnerWidgetLayoutProps, 'layout' | 'tags'> & { layout?: BoxLayout; tags?: string[] };

export const SpinnerWidget2 = ({ layout, tags, ...widget }: SpinnerWidget2Props) => {
    return (
        <Region
            name="spinnerWidget"
            tags={tags}
