 ...
 */
export type ProductViewWidget3Props = Omit<ProductViewWidgetLayoutProps, 'layout'> & { layout?: BoxLayout };

export const ProductViewWidget3 = ({ layout, ...widget }: ProductViewWidget3Props) => {
    return (
        <Region
