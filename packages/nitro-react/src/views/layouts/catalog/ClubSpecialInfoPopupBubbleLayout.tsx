...
export const ClubSpecialInfoPopupBubbleLayout = ({ caption_247BhccenterBreakdownTitle7D, captionInfoCreditsspent, captionInfoFactor, captionInfoStreakbonus, captionInfoTotal, captionSpecialInfolink, layout, onSpecialInfolink }: ClubSpecialInfoPopupBubbleLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 374, height: 146, ...layout }}>
            ...
            >
                <Region
                    name="main_content"
                    params={8388611}
                    layout={{ position: 'absolute', left: 11, width: 345, top: -21, height: 120, flexDirection: 'column', gap: 3 }}
                >
                    <Border
                        variant="3"
                        params={19}
