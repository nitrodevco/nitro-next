...
export const CatalogUbuntuWithTabsLayoutNormalTopitemTemplateItem = ({ captionItemTitle, itemHilightInner, layout, onNormalTopitemTemplate, srcIcon, visibleDropButton, visibleIcon, visibleItemHilightInner, visibleItemHilightOuter, visibleItemTitle }: CatalogUbuntuWithTabsLayoutNormalTopitemTemplateItemProps) => {
    return (
        <Region
