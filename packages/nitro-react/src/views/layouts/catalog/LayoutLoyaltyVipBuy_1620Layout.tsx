...
/** Named region `item_list_vip` of LayoutLoyaltyVipBuy_1620Layout - configured through the parent's `itemListVip` prop. */
export interface LayoutLoyaltyVipBuy_1620LayoutItemListVipProps {
    layout?: BoxLayout;
}

export const LayoutLoyaltyVipBuy_1620LayoutItemListVip = ({ layout }: LayoutLoyaltyVipBuy_1620LayoutItemListVipProps) => {
    return (
        <Region
            name="item_list_vip"
            params={2064}
...
/** Named region `loyaltyVipBuyWidget` of LayoutLoyaltyVipBuy_1620Layout - configured through the parent's `loyaltyVipBuyWidget` prop. */
export interface LayoutLoyaltyVipBuy_1620LayoutLoyaltyVipBuyWidgetProps {
    captionVipInfo?: string;
    captionVipLink?: string;
    captionVipTitle?: string;
    itemListVip?: LayoutLoyaltyVipBuy_1620LayoutItemListVipProps;
    layout?: BoxLayout;
    srcCtlgTeaserimg1?: string;
}

export const LayoutLoyaltyVipBuy_1620LayoutLoyaltyVipBuyWidget = ({ captionVipInfo, captionVipLink, captionVipTitle, itemListVip, layout, srcCtlgTeaserimg1 }: LayoutLoyaltyVipBuy_1620LayoutLoyaltyVipBuyWidgetProps) => {
    ...
    return (
        ...
        >
            ...
            />
            <LayoutLoyaltyVipBuy_1620LayoutItemListVip {...itemListVip} />
            <Region
                name="vip_link"
                params={787473}
...
export interface LayoutLoyaltyVipBuy_1620LayoutCtlgLoyaltyVipBuyProps {
    layout?: BoxLayout;
    loyaltyVipBuyWidget?: LayoutLoyaltyVipBuy_1620LayoutLoyaltyVipBuyWidgetProps;
}
...
export const LayoutLoyaltyVipBuy_1620LayoutCtlgLoyaltyVipBuy = ({ layout, loyaltyVipBuyWidget }: LayoutLoyaltyVipBuy_1620LayoutCtlgLoyaltyVipBuyProps) => {
    return (
        ...
        >
            <LayoutLoyaltyVipBuy_1620LayoutLoyaltyVipBuyWidget {...loyaltyVipBuyWidget} />
        </Region>
    );
};
