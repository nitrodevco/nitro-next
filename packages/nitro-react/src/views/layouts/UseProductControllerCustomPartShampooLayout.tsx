...
export const UseProductControllerCustomPartShampooLayout = ({ layout, onSaveButton }: UseProductControllerCustomPartShampooLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text="${useproduct.widget.text.custompartshampoo "
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.info.custompartshampoo')}
