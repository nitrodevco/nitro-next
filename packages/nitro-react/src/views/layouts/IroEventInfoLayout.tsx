...
export const IroEventInfoLayout = ({ layout }: IroEventInfoLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 195, height: 135, ...layout }}>
            ...
            >
                <ThemeImage
                    ...
                    src="${image.library.url}Events/event_bg_visitor.png"
                    layout={{ position: 'absolute', left: 0, width: 195, top: 0, height: 135 }}
                />
                <ThemeImage
                    name="event_bg_owner"
                    src="${image.library.url}Events/event_bg_owner.png"
                    layout={{ position: 'absolute', left: 0, width: 195, top: 0, height: 135 }}
                />
                <ThemeImage
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('navigator.eventinprogress')}
                            textOptions={{ fill: '#ffffff' }}
                        />
                    </Region>
                    <Region
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('navigator.roominfo.editevent')}
                                textOptions={{ fill: '#ffffff' }}
                            />
                        </Region>
                    </Region>
                    ...
                    <ThemeImage
                        name="event_icon"
                        params={16}
                        src="${image.library.url}Events/event_icon.png"
