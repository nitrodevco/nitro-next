...
export const NotificationGiftUnlockedNotifyLayout = ({ layout, onClose, onReceivedOkBtn }: NotificationGiftUnlockedNotifyLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.notify.unlocked.title')}
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.notify.unlocked.desc')}
