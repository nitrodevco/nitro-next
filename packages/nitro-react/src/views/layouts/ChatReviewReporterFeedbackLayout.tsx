...
export const ChatReviewReporterFeedbackLayout = ({ layout, onClose, onCloseButton }: ChatReviewReporterFeedbackLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('guide.bully.request.reporter.sent.caption')}
                    ...
                    >
                        <ThemeText
                            text={t('guide.bully.request.reporter.sent.body')}
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('guide.bully.request.reporter.note')}
