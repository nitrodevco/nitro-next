...
export const NotificationGiftUnlockedLayout = ({ layout, onClose, onOpenBtn }: NotificationGiftUnlockedLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.unlocked.title')}
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.unlocked.desc')}
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('widget.furni.teaser.gift.get')}
                                textStyle="text-style-bold"
