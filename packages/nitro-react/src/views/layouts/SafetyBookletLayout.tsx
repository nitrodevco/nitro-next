...
export const SafetyBookletLayout = ({ layout, onBackButton, onBackButton2, onFrameClose, onNextButton, onOkButton, onPreviousButton, onQuizButton }: SafetyBookletLayoutProps) => {
                    ...
                    <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                        ...
                        >
                            ...
                            <ThemeImage
                                name="safety_image"
                                params={16}
                                src="${image.library.url}safetyquiz/safety_off.png"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ThemeText
                                        text="Keep your full name, address, phone numbers, photos and school name secret so nobody can scam, bully you or place you in danger."
                                        textOptions={{ wordWrap: true, wordWrapWidth: 210 }}
                                    />
                                </Region>
                            </Region>
