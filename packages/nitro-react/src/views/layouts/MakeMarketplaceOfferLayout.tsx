...
export const MakeMarketplaceOfferLayout = ({ layout, onCancelMakeOfferButton, onClose, onCopySuggestedPriceButton, onMakeOfferButton }: MakeMarketplaceOfferLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('002_lorem_ipsum_content')}
                            textOptions={{ wordWrap: true, wordWrapWidth: 190 }}
                        />
                    </Region>
                    <Region
                    ...
                    >
                        <ThemeText
                            text={t('inventory.marketplace.make_offer.expiration_info_days')}
                    ...
                    >
                        <ThemeText
                            text={t('sellinmarketplace.amount')}
                            textStyle="text-style-u-headline-small"
                            textOptions={{ align: 'right' }}
                        />
                    </Region>
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('inventory.marketplace.make_offer.average_price')} />
                        </Region>
                        <Region
                            name="lowest_price"
                            params={16}
                            layout={{ width: 268, height: 18, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText text={t('inventory.marketplace.make_offer.lowest_price')} />
                        </Region>
                        <Region
                            ...
                            layout={{ width: 268, height: 18, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText text={t('inventory.marketplace.make_offer.suggested_price')} />
                        </Region>
                        <Button
                            variant="3"
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('inventory.marketplace.make_offer.final_price')}
