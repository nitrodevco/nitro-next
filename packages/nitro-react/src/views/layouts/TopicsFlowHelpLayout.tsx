...
export const TopicsFlowHelpLayout = ({ layout, onBackButton, onButtonAccount, onButtonHabboHelp, onButtonUserReport, onChangeUser, onChatCheck, onChatText, onClose, onContinueButton, onFaqLink, onHabbowayLink, onInstructionsButton, onReasonPrototype, onReportsStatus, onSafetybookletLink, onSanctionInfoLink, onSubmitButton, onUnlawfulMessageConfirm }: TopicsFlowHelpLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('help.main.my.sanction.status')}
                            textStyle="text-style-u-bold"
                        />
                    </Region>
                    <ThemeImage
                    ...
                    >
                        <ThemeText
                            text={t('help.main.my.reports.status')}
                            textStyle="text-style-u-bold"
                        />
                    </Region>
                </Region>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('help.emergency.main.submit.button')}
                            textStyle="text-style-u-headline-medium"
                            textOptions={{ fill: '#ffffff', align: 'center' }}
                        />
                    </Region>
                    ...
                    >
                        ...
                        >
                            <Region
                                name="user_prototype"
                                params={17}
                                layout={{ width: 367, height: 57, flexShrink: 0 }}
                            >
                                <Border
                                    variant="2"
                                    name="user_bg"
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('help.cfh.selected_user.title')}
                            textStyle="text-style-u-bold"
                    ...
                    >
                        <ThemeText
                            text={t('help.cfh.selected_user.change')}
                    ...
                    >
                        ...
                        >
                            <ContainerButton
                                ...
                                layout={{ width: 355, height: 40, flexShrink: 0 }}
                            >
                                <Region
                                    name="name"
                                    params={16}
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('help.cfh.unlawful_activity.confirm_label')}
                        ...
                        >
                            ...
                            >
                                <Region
                                    name="chat_prototype"
                                    params={16}
                                    layout={{ width: 360, height: 20, flexShrink: 0 }}
                                >
                                    <CheckBox
                                        variant="3"
                                        name="chat_check"
