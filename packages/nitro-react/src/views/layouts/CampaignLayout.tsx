...
export const CampaignLayout = ({ layout }: CampaignLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 103, height: 114, ...layout }}>
            ...
            >
                ...
                <ThemeImage
                    ...
                    params={1232}
                    src="${image.library.questing.url}quest_counterbkg_disabled.png"
                    layout={{ position: 'absolute', left: 27, width: 49, top: 84, height: 20 }}
                />
                <ThemeImage
                    name="completion_bg_blue_bitmap"
                    params={1232}
                    src="${image.library.questing.url}quest_counterbkg_active.png"
                    layout={{ position: 'absolute', left: 27, width: 49, top: 84, height: 20 }}
                />
                <ThemeImage
                    name="completion_bg_green_bitmap"
                    params={1232}
                    src="${image.library.questing.url}quest_counterbkg_completed.png"
                    layout={{ position: 'absolute', left: 27, width: 49, top: 84, height: 20 }}
                />
                <Region
                    name="completion_txt"
