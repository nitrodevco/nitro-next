...
export const WelcomeTourPopupLayout = ({ layout, onClose, onTakeTour }: WelcomeTourPopupLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <Region
                        params={16}
                        layout={{ width: 326, height: 21, flexShrink: 0, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    <Region
                        params={16}
                        layout={{ width: 313, height: 44, flexShrink: 0, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                ...
                <Region
                    params={16}
                    layout={{ position: 'absolute', left: 83, width: 306, top: 80, height: 134 }}
                >
                    <Button
                        variant="3"
                        name="take_tour"
                    ...
                    >
                        ...
                        >
                            <Region
                                params={16}
                                layout={{ position: 'absolute', left: 11, width: 283, top: 9, height: 28, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
