...
export const FastfoodGamePromoLayout = ({ layout, onGoButton }: FastfoodGamePromoLayoutProps) => {
            ...
            >
                ...
                >
                    <ThemeImage
                        name="teaser_image"
                        params={16}
                        src="${image.library.url}reception/fastfood_promo.png"
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.fastfoodpromo.caption')}
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.fastfoodpromo.title')}
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.fastfoodpromo.info')}
                            textOptions={{ wordWrap: true, wordWrapWidth: 270 }}
                        />
                    </Region>
                    <Button
