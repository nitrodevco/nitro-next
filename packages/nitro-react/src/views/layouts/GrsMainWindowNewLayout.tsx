...
export const GrsMainWindowNewLayout = ({ layout, onClose, onCreateRoomBut, onGetEventBut, onMeSubNavi, onNavigatorTab1, onNavigatorTab2, onNavigatorTab3, onNavigatorTab4, onNavigatorTab5, onNavigatorTab6, onNextButton, onPrevButton, onRoomAdFilter, onRoomCtgFilter, onSearchBut, onSearchType }: GrsMainWindowNewLayoutProps) => {
                                ...
                                >
                                    ...
                                    >
                                        <Region
                                            ...
                                            params={16}
                                            backgroundColor="#ffffff"
                                            layout={{ width: 353, height: 1, flexShrink: 0 }}
                                        />
                                    </Region>
                                </ScrollArea>
                            </Region>
