...
export const ErrorInfoViewLayout = ({ layout, onClose }: ErrorInfoViewLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                <Region
                    name="contents"
                    params={147600}
                    layout={{ position: 'absolute', left: 8, width: 320, top: 3, height: 100, minHeight: 100 }}
                >
                    <ThemeImage
                        name="type_icon"
                        params={16}
                    ...
                    <Region
                        name="error_name"
                        params={3932176}
                        layout={{ position: 'absolute', left: 109, width: 101, top: 11, height: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                    >
                        <ThemeText text="EXECUTION_CAP" />
                    </Region>
                    <Region
                        name="error_text"
                        params={16400}
