...
export const StoriesImageWidgetLayout = ({ layout, onClosebutton, onMakeOwnButton, onRemovebutton, onReportButton, onShareButton }: StoriesImageWidgetLayoutProps) => {
                            ...
                            >
                                ...
                                >
                                    <ThemeImage
                                        ...
                                        tags={[ '#icon' ]}
                                        params={16}
                                        src={layoutImage('icons_facebook.png')}
                                        layout={{ position: 'absolute', left: 0, width: 32, top: 0, height: 32, minWidth: 32, minHeight: 32 }}
                                    />
                                </Region>
                                <Region
                                ...
                                >
                                    <ThemeImage
                                        ...
                                        tags={[ '#icon' ]}
                                        params={16}
                                        src={layoutImage('icons_twitter.png')}
                                        layout={{ position: 'absolute', left: 0, width: 32, top: 0, height: 32, minWidth: 32, minHeight: 32 }}
                                    />
                                </Region>
                            </Region>
