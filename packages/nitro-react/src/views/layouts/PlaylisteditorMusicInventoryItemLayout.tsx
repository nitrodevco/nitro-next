...
export const PlaylisteditorMusicInventoryItemLayout = ({ layout, onButtonPlayPause, onButtonToPlaylist }: PlaylisteditorMusicInventoryItemLayoutProps) => {
    return (
