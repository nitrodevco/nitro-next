...
export const MainHelpLayout = ({ layout, onBullyButton, onClose, onEmergencyButton, onHabbowayLink, onInstructionsButton, onLeaveRoom, onSafetybookletLink, onSelfHelpLink, onSelfHelpLink2 }: MainHelpLayoutProps) => {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('help.main.self.tips.content')}
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('help.main.self.habboway.title')}
                                    textStyle="text-style-il-heading-2"
                                    textOptions={{ align: 'center' }}
                                />
                            </Region>
                            ...
                            >
                                <ThemeText
                                    text={t('help.main.self.safetybooklet.title')}
                                    textStyle="text-style-il-heading-2"
                                    textOptions={{ align: 'center' }}
                                />
                            </Region>
