...
export const DailyQuestLayout = ({ layout, onAcceptButton, onGoButton }: DailyQuestLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 500, height: 194, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="...and everything must go, so get yourself some of the sweet, sweet plastic fantastic while you still can! You don't want to miss out on the classics!"
                    ...
                    >
                        ...
                        >
                            <ThemeText text="PH: Show me another easy quest" />
                        </Region>
                    </Region>
                    <Region
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('landing.view.quest.cancel')} />
                        </Region>
                    </Region>
                    <Border
                        variant="100"
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('landing.view.quest.currenttask')}
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('landing.view.quest.easy')} />
                        </Region>
                    </Region>
                    <ThemeImage
                        name="divider"
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('landing.view.quest.hard')} />
                        </Region>
                    </Region>
                </Region>
            </Region>
