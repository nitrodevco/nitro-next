...
export const ProductIconLayout = ({ layout, srcBitmap, srcUnknownImage, visibleBadgeImageWidget, visibleIcon, visiblePetImageWidget, visibleUnknownImage }: ProductIconLayoutProps) => {
    return (
