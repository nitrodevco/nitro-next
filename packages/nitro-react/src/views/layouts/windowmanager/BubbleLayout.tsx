    ...
    return (
        <Region layout={{ position: 'relative', width: 21, height: 21, ...layout }}>
            <BubblePointer
                ...
                params={208}
                direction="up"
                layout={{ position: 'absolute', left: '50%', marginLeft: -6.5, width: 13, top: 0, height: 9 }}
            />
            <BubblePointer
                name="down"
                tags={[ '_POINTER', '_INTERNAL', '_EXCLUDE', '_COLORIZE' ]}
                params={1232}
                direction="down"
                layout={{ position: 'absolute', left: '50%', marginLeft: -6.5, width: 13, bottom: 0, height: 9 }}
            />
            <BubblePointer
                name="left"
                tags={[ '_POINTER', '_INTERNAL', '_EXCLUDE', '_COLORIZE' ]}
                params={3088}
                direction="left"
                layout={{ position: 'absolute', left: 0, width: 8, top: '50%', marginTop: -6.5, height: 13 }}
            />
            <BubblePointer
                name="right"
                tags={[ '_POINTER', '_INTERNAL', '_EXCLUDE', '_COLORIZE' ]}
                params={3152}
                direction="right"
                layout={{ position: 'absolute', right: 0, width: 8, top: '50%', marginTop: -6.5, height: 13 }}
            />
            <Region
                name="content_area"
