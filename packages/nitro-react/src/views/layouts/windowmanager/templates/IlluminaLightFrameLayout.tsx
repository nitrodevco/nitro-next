...
export const IlluminaLightFrameLayout = ({ captionHeaderTitleText, contentArea, layout, onHeaderButtonClose, titlebar }: IlluminaLightFrameLayoutProps) => {
    return (
        ...
        >
            <IlluminaLightFrameLayoutContentArea
                tags={[ '_CONTENT', '_INTERNAL', '_EXCLUDE' ]}
                {...contentArea}
            />
            <IlluminaLightFrameLayoutTitlebar
...
export const IlluminaLightFrameLayoutContentArea = ({ layout, tags }: IlluminaLightFrameLayoutContentAreaProps) => {
    return (
        <Region
            name="content_area"
            tags={tags}
...
export const IlluminaLightFrameLayoutTitlebar = ({ layout, onTitlebar, tags }: IlluminaLightFrameLayoutTitlebarProps) => {
    return (
        <Region
            name="titlebar"
            tags={tags}
