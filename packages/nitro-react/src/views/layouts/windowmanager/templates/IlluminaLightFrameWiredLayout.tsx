...
export const IlluminaLightFrameWiredLayout = ({ captionHeaderTitleText, contentArea, layout, onHeaderButtonClose, onHeaderButtonMenu, titlebar, wiredBanner }: IlluminaLightFrameWiredLayoutProps) => {
    return (
        ...
        >
            <IlluminaLightFrameWiredLayoutWiredBanner
                tags={[ '_EXCLUDE', '_INTERNAL', 'wired_header_bg' ]}
                {...wiredBanner}
            />
            <IlluminaLightFrameWiredLayoutContentArea
                tags={[ '_CONTENT', '_INTERNAL', '_EXCLUDE' ]}
                {...contentArea}
            />
            <IlluminaLightFrameWiredLayoutTitlebar
...
export const IlluminaLightFrameWiredLayoutWiredBanner = ({ layout, srcBannerLeft, srcBannerRight, tags }: IlluminaLightFrameWiredLayoutWiredBannerProps) => {
    return (
        <Region
            name="wired_banner"
            tags={tags}
...
export const IlluminaLightFrameWiredLayoutContentArea = ({ layout, tags }: IlluminaLightFrameWiredLayoutContentAreaProps) => {
    return (
        <Region
            name="content_area"
            tags={tags}
...
export const IlluminaLightFrameWiredLayoutTitlebar = ({ layout, onTitlebar, tags }: IlluminaLightFrameWiredLayoutTitlebarProps) => {
    return (
        <Region
            name="titlebar"
            tags={tags}
