...
export const ScrollbarHorizontalLayout = ({ layout }: ScrollbarHorizontalLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 56, height: 17, ...layout }}>
            <ScrollbarSliderButtonLeft layout={{ position: 'absolute', left: 0, width: 16, top: 0, bottom: 0 }} />
            <ScrollbarSliderTrackHorizontal layout={{ position: 'absolute', left: 16, right: 16, top: 0, bottom: 0 }} />
            <ScrollbarSliderButtonRight layout={{ position: 'absolute', right: 0, width: 16, top: 0, bottom: 0 }} />
        </Region>
    );
};
