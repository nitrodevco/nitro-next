...
export const HeaderBlackLayout = ({ headerContainer, layout }: HeaderBlackLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 100, height: 15, ...layout }}>
            <HeaderBlackLayoutHeaderContainer {...headerContainer} />
        </Region>
    );
};
...
export const HeaderBlackLayoutHeaderContainer = ({ captionHeaderTitleText, layout, onHeaderButtonClose }: HeaderBlackLayoutHeaderContainerProps) => {
    return (
        <Region
