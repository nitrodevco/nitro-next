...
export const Header7LayoutHeaderContainer = ({ captionHeaderTitleText, layout, onHeaderButtonClose, onHeaderButtonHelp, tags }: Header7LayoutHeaderContainerProps) => {
    return (
        <Region
