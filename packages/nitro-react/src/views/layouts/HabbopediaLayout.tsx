...
export const HabbopediaLayout = ({ layout, onClose }: HabbopediaLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text="Here is some mighty text describing certain Hotel feature. Let's see what happens when it goes over the limit."
