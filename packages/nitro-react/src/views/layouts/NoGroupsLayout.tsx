...
export const NoGroupsLayout = ({ layout, onViewGroupsButton }: NoGroupsLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 343, height: 214, ...layout }}>
            ...
            >
                ...
                <ThemeImage
                    ...
                    params={16}
                    src="${image.library.url}guilds/ext_profile_grouppic.png"
