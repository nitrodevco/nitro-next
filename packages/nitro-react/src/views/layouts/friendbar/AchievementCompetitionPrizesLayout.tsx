        ...
        <Region layout={{ position: 'relative', width: 270, height: 352, ...layout }}>
            <Region layout={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0 }}>
                ...
                <ThemeText
                    ...
                    name="caption_txt"
                    layout={{ position: 'absolute', left: 8, width: 95, top: 31, height: 18 }}
                />
                <ThemeText
                    ...
                    name="info_txt"
                    verticalAlign="top"
                    layout={{ position: 'absolute', left: 8, width: 245, top: 52, height: 35 }}
                />
                <Border
                    variant="100"
                ...
                >
                    <ThemeText
                        ...
                        layout={{ position: 'absolute', left: 89, width: 107, top: 22, height: 14 }}
                    />
                    <ThemeText
                        ...
                        verticalAlign="top"
                        layout={{ position: 'absolute', left: 88, width: 146, top: 36, height: 50 }}
                    />
                    <ThemeImage
                        name="border_bar"
                    ...
                    <Region layout={{ position: 'absolute', left: 85, width: 150, top: 98, height: 46 }}>
                        <ThemeText
                            ...
                            textOptions={{ fill: colorableTextColor }}
                            name="rank_1_txt"
                            layout={{ position: 'absolute', left: 0, width: 41, top: 0, height: 15 }}
                        />
                        <ThemeText
                            text={captionRank1InfoTxt ?? 'Ranks 1-50'}
                            textOptions={{ fill: colorableTextColor, align: 'right' }}
                            name="rank_1_info_txt"
                            layout={{ position: 'absolute', left: 54, width: 95, top: 0, height: 15 }}
                        />
                        <ThemeText
                            ...
                            textOptions={{ fill: colorableTextColor }}
                            name="rank_2_txt"
                            layout={{ position: 'absolute', left: 0, width: 41, top: 15, height: 15 }}
                        />
                        <ThemeText
                            text={captionRank2InfoTxt ?? 'Ranks 1-50'}
                            textOptions={{ fill: colorableTextColor, align: 'right' }}
                            name="rank_2_info_txt"
                            layout={{ position: 'absolute', left: 54, width: 95, top: 15, height: 15 }}
                        />
                        <ThemeText
                            ...
                            textOptions={{ fill: colorableTextColor }}
                            name="rank_3_txt"
                            layout={{ position: 'absolute', left: 0, width: 41, top: 30, height: 15 }}
                        />
                        <ThemeText
                            text={captionRank3InfoTxt ?? 'Ranks 1-50'}
                            textOptions={{ fill: colorableTextColor, align: 'right' }}
                            name="rank_3_info_txt"
                            layout={{ position: 'absolute', left: 54, width: 95, top: 30, height: 15 }}
                        />
                    </Region>
                    <Border
                        variant="100"
                    ...
                    >
                        ...
                        <ThemeText
                            ...
                            textOptions={{ fill: colorableTextColor }}
                            name="user_rank_txt"
                            layout={{ position: 'absolute', left: 59, width: 118, top: 11, height: 16 }}
                        />
                        <ThemeText
                            ...
                            verticalAlign="top"
                            layout={{ position: 'absolute', left: 59, width: 151, top: 27, height: 33 }}
                        />
                    </Border>
                    <ThemeImage
                        name="reward_image"
