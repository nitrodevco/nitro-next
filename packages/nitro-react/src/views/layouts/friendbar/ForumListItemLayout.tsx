...
export const ForumListItemLayoutMainBox = ({ captionDetails, captionHeader, captionMessages1, captionMessages2, layout, onHeaderRegion, onUnreadRegion }: ForumListItemLayoutMainBoxProps) => {
    return (
        <Region
            name="main_box"
