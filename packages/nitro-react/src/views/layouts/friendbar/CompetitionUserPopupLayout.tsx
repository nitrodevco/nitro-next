            ...
            <Region layout={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, justifyContent: 'center' }}>
                ...
                >
                    ...
                    <ThemeText
                        ...
                        name="rank_desc_txt"
                        verticalAlign="top"
                        layout={{ position: 'absolute', right: 8, width: 133, bottom: 1, height: 27 }}
                    />
                    <ThemeText
                        text={captionUserNameTxt ?? 'Ibuxal'}
                        textStyle="text-style-il-heading-3"
                        name="user_name_txt"
                        layout={{ position: 'absolute', left: 37, width: 35, top: 13, height: 16 }}
                    />
                    <ThemeText
                        ...
                        name="score_txt"
                        layout={{ position: 'absolute', left: 12, width: 70, alignSelf: 'center', marginTop: 0.5, marginBottom: -0.5, height: 16 }}
                    />
                </Border>
                <ThemeImage
