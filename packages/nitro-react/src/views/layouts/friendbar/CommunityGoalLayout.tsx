...
export const CommunityGoalLayout = ({ captionCommunityTitle, captionCommunityTotalStatus, itemsInfoContainer, layout, srcBorderBar, srcHdrLine, srcMeterLevel0, srcMeterLevel1, srcMeterLevel1Icon, srcMeterLevel1IconLocked, srcMeterLevel2, srcMeterLevel2Icon, srcMeterLevel2IconLocked, srcMeterLevel3, srcMeterLevel3Icon, srcMeterLevel3IconLocked, srcMeterNeedle }: CommunityGoalLayoutProps) => {
