...
export const ElementConcurrentusersinfoLayout = ({ captionBadgeDesc, captionUsersDesc, layout, onActionButton, srcBadgeImage, visibleStateAchieved }: ElementConcurrentusersinfoLayoutProps) => {
