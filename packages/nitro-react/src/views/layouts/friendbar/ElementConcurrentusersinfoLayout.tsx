...
export const ElementConcurrentusersinfoLayoutStateActive = ({ captionUsersDesc, layout }: ElementConcurrentusersinfoLayoutStateActiveProps) => {
...
export const ElementConcurrentusersinfoLayoutStateAchieved = ({ captionBadgeDesc, layout, onActionButton, srcBadgeImage, visibleStateAchieved }: ElementConcurrentusersinfoLayoutStateAchievedProps) => {
    const t = useTranslation();
