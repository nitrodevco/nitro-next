    ...
    return (
        ...
        >
            ...
            <ThemeText
                ...
                name="list_header"
                layout={{ position: 'absolute', left: 0, right: -1, top: 115, height: 25 }}
            />
            <Border
                variant="7"
                name="list_border"
            ...
            <Region layout={{ position: 'absolute', right: 3, width: 165, bottom: 21, height: 30 }}>
                ...
                <ThemeText
                    ...
                    name="page_info"
                    layout={{ position: 'absolute', left: 58, width: 50, top: 5, height: 17 }}
                />
                <ContainerButton
                    variant="3"
                    name="show_next"
            ...
            <Region layout={{ position: 'absolute', right: 60, width: 300, bottom: -11, height: 20 }}>
                <ThemeText
                    ...
                    name="status"
                    layout={{ position: 'absolute', left: 3, right: -3, bottom: 1, height: 16 }}
                />
            </Region>
        </Frame>
    );
