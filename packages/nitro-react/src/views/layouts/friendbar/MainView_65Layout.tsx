...
export const MainView_65Layout = ({ captionBackButtonLabel, captionListHeader, captionPageInfo, captionPostButtonLabel, captionStatus, captionTopHeaderText, captionTopText, itemsShortcuts, layout, onBackButton, onClose, onPostButton, onShowFirst, onShowLast, onShowNext, onShowPrevious, onTopClickArea, srcHeaderIcon }: MainView_65LayoutProps) => {
