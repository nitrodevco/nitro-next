    ...
    return (
        ...
        >
            ...
            <ThemeText
                ...
                verticalAlign="top"
                layout={{ position: 'absolute', marginLeft: -121, marginRight: 121, width: 150, top: 44, height: 34 }}
            />
            {(visibleFriendsTxt ?? false) && (
                <ThemeText
                    ...
                    name="friends_txt"
                    verticalAlign="top"
                    layout={{ position: 'absolute', marginLeft: 54, marginRight: -54, width: 150, top: 44, height: 34 }}
                />
            )}
