...
export const QuestLayout = ({ layout, onAcceptButton }: QuestLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 362, height: 114, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="Frienship Quest 8/16: Share Love"
                ...
                >
                    <ThemeText text={t('quests.list.rewardcaption')} />
                </Region>
                <Region
                ...
                >
                    ...
                    >
                        <ThemeText text={t('quests.list.reject')} />
                    </Region>
                </Region>
                <ThemeImage
                ...
                >
                    ...
                    >
                        <ThemeText text={t('quests.list.opencatalog')} />
                    </Region>
                    <Region
                        name="link_navigator"
                        params={4194320}
                    ...
                    >
                        <ThemeText text={t('quests.list.opennavigator')} />
                    </Region>
                    <Region
                        name="link_room"
                        params={4194320}
                    ...
                    >
                        <ThemeText text={t('quests.gotocampaignroom')} />
                    </Region>
                </Region>
                <Region
                    name="delay_desc_txt"
                ...
                >
                    <ThemeText text={t('quests.list.nextquestavailable')} />
                </Region>
                <Region
                    name="delay_txt"
                    params={144}
