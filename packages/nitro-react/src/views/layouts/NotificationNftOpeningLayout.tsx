...
export const NotificationNftOpeningLayout = ({ layout, onRarityText }: NotificationNftOpeningLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 190, height: 110, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text={t('collectibles.reward_box.notif.desc')}
                ...
                <ThemeImage
                    ...
                    params={3088}
                    src={undefined}
                    layout={{ position: 'absolute', left: 8, width: 50, top: 30, height: 50 }}
                />
                <Region
                    name="bottom"
                    params={1168}
                    layout={{ position: 'absolute', left: 0, width: 190, top: 80, height: 30 }}
                >
                    <Region
                        params={144}
                        layout={{ position: 'absolute', left: 6, width: 178, top: 0, height: 25 }}
                    >
                        <Button
                            variant="3"
                            name="rarity_text"
                            ...
                            layout={{ position: 'absolute', left: 0, width: 178, top: 0, height: 25, minWidth: 178 }}
                        >
                            {'Rarity: '}
                        </Button>
                    </Region>
