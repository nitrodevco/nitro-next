...
export const UseProductControllerRebreedMonsterplantLayout = ({ layout, onCancelText, onSaveButton }: UseProductControllerRebreedMonsterplantLayoutProps) => {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('useproduct.widget.text.rebreed_monsterplant')}
                        ...
                        >
                            <ThemeText
                                text={t('useproduct.widget.info.rebreed_monsterplant')}
