...
export const ForumListItemLayout = ({ layout }: ForumListItemLayoutProps) => {
    return (
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText text="Some group header" />
                        </Region>
                    </Region>
                    <Region
                        name="details"
                    ...
                    >
                        <ThemeText text="Rating 1000, last message by LongLongLongName 30 seconds ago" />
                    </Region>
                </Region>
                <Region
