...
export const UseProductControllerCustomPartLayout = ({ layout, onSaveButton }: UseProductControllerCustomPartLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text="${useproduct.widget.text.custompart "
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.info.custompart')}
