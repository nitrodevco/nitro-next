                ...
                >
                    ...
                    >
                        ...
                        >
                            <Region
                                ...
                                layout={{ width: 277, height: 30, flexShrink: 0, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
                            ...
                            <Region
                                name="advanced_container"
                                params={16}
                                layout={{ width: 218, height: 82, flexShrink: 0 }}
                            >
                                <CheckBox
                                    variant="0"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('navigator.roomsettings.moderation.none')}
                                    textStyle="text-style-u-regular"
                                />
                            </Region>
                            <Region
                            ...
                            >
                                <ThemeText
                                    text={t('navigator.roomsettings.moderation.rights')}
                                    textStyle="text-style-u-regular"
                                />
                            </Region>
                        </Region>
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('navigator.roomsettings.moderation.all')}
                                    textStyle="text-style-u-regular"
                                />
                            </Region>
                            <RadioButton
