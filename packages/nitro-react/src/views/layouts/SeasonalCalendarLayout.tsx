...
export const SeasonalCalendarLayout = ({ layout, onBuyButton, onClose }: SeasonalCalendarLayoutProps) => {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('quests.seasonalcalendar.promo.header')}
                                    textStyle="text-style-u-bold"
                                />
                            </Region>
                            <Region
                            ...
                            >
                                <ThemeText
                                    text={t('quests.seasonalcalendar.promo.balance')}
                        ...
                        <ThemeImage
                            ...
                            params={16}
                            src="${image.library.questing.url}calendar_promobg.png"
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('quests.seasonalcalendar.rareteaser.header')}
                                textStyle="text-style-u-bold"
                            />
                        </Region>
                        <Region
                        ...
                        >
                            <ThemeText
                                text={t('quests.seasonalcalendar.rareteaser.info')}
                                textStyle="text-style-u-regular"
                            />
                        </Region>
                    </Region>
