...
export const MyReportsLayout = ({ layout, onAppealButton, onClose }: MyReportsLayoutProps) => {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('report.status.info.reported')}
                                    textStyle="text-style-u-bold"
                                />
                            </Region>
                            <Region
                        ...
                        >
                            <ThemeText
                                text={t('report.status.info.action')}
                                textStyle="text-style-u-bold"
                            />
                        </Region>
                        <Region
                        ...
                        >
                            <ThemeText
                                text={t('report.status.info.auto_moderated.no_action')}
