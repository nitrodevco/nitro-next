...
export const InventoryLayout = ({ layout, onBadges, onBots, onBuyrenteditemBtn, onClose, onCollectibles, onExtendrentBtn, onFilterOptions, onFilterOptions2, onFilterOptions3, onFilterOptions4, onFilterRarity, onFilterRarity2, onFurni, onGotoRoomBtn, onNextItemButton, onNextItemButton2, onOffertotradeBtn, onOffertotradeBtn2, onOpenCatalogBtn, onPets, onPlaceButton, onPlaceButton2, onPlaceinroomBtn, onPlacementOptions, onRentables, onSellBtn, onUseBtn, onViewItemButton, onViewItemButton2, onWearBadgeButton }: InventoryLayoutProps) => {
    const t = useTranslation();
    const [ filterValue, setFilterValue ] = useState('');
    const [ offertotradeCntValue, setOffertotradeCntValue ] = useState('');
    const [ filterValue2, setFilterValue2 ] = useState('');
    const [ offertotradeCntValue2, setOffertotradeCntValue2 ] = useState('');
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="image"
                            params={16}
                            src={layoutImage('inventory_inventory_empty.png')}
                    ...
                    >
                        <ThemeImage
                            name="download_image"
                            params={16}
                            src={layoutImage('inventory_download_icon.png')}
                    ...
                    >
                            ...
                            >
                                ...
                                >
                                    <Region
                                        ...
                                        tags={[ 'furni_name' ]}
                                        params={786576}
                                        layout={{ width: 190, height: 17, flexShrink: 0, minWidth: 190, maxWidth: 190, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                    >
                                        <ThemeText
                                            text="name"
                                    ...
                                    <Region
                                        ...
                                        tags={[ 'furni_description' ]}
                                        params={144}
                                        layout={{ width: 190, height: 30, flexShrink: 0, minWidth: 190, maxWidth: 190, maxHeight: 45, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                    >
                                        <ThemeText
                                            text="description lakjdsf lkjas dflkjalkjasdflkja sdlfkj asdf"
                                            textOptions={{ wordWrap: true, wordWrapWidth: 190 }}
                                        />
                                    </Region>
                                    <Region
                                    ...
                                    <Region
                                        name="spacer"
                                        params={16}
                                        layout={{ width: 30, height: 12, flexShrink: 0 }}
                                    />
                                    <Button
                                        variant="3"
                                    ...
                                    <Button
                                        ...
                                        textStyle="text-style-button-shiny-regular"
                                        layout={{ width: 165, height: 22, flexShrink: 0 }}
                                    >
                                    ...
                                    <Button
                                        ...
                                        textStyle="text-style-button-shiny-regular"
                                        layout={{ width: 148, height: 22, flexShrink: 0, minWidth: 60 }}
                                    >
                                    ...
                                    <Button
                                        ...
                                        textStyle="text-style-button-shiny-regular"
                                        layout={{ width: 125, height: 28, flexShrink: 0 }}
                                    >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Region
                                            ...
                                            tags={[ 'furni_description' ]}
                                            params={144}
                                            layout={{ width: 190, height: 17, flexShrink: 0, minWidth: 190, maxWidth: 190, maxHeight: 45, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                        >
                                            <ThemeText
                                                text="Type: furni fdgfgdf"
                                                textOptions={{ wordWrap: true, wordWrapWidth: 190 }}
                                            />
                                        </Region>
                                    </Region>
                                    ...
                                    >
                                        <TextInput
                                            value={offertotradeCntValue2}
                                            onChange={setOffertotradeCntValue2}
                                        ...
                                        <Button
                                            ...
                                            name="offertotrade_btn"
                                            params={393233}
                                            onPointerTap={onOffertotradeBtn2}
                                            textStyle="text-style-button-shiny-regular"
                                            layout={{ width: 148, height: 22, flexShrink: 0, minWidth: 60 }}
                                        >
                                            {t('inventory.trading.offer')}
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('inventory.badges.inactivebadges')}
                                    textStyle="text-style-u-headline-small"
                            ...
                            >
                                ...
                                >
                                    <Region
                                        name="badgeName"
                                        params={16}
                                        layout={{ width: 211, height: 17, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                                    >
                                        <ThemeText
                                    ...
                                    <Region
                                        ...
                                        params={16}
                                        visible={false}
                                        layout={{ width: 271, height: 4, flexShrink: 0, maxHeight: 28, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                    />
                                    <Region
                                        params={16}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <ThemeText
                                            text={t('achievements_score_description')}
