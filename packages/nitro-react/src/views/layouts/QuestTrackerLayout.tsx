...
export const QuestTrackerLayout = ({ layout }: QuestTrackerLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 192, height: 132, ...layout }}>
            ...
            >
                <ThemeImage
                    ...
                    src="${image.library.questing.url}quest_tracker_with_bar.png"
                ...
                >
                    ...
                    <ThemeImage
                        name="success_pic_1"
                        params={16}
                        src="${image.library.questing.url}checkanim1.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="success_pic_2"
                        params={16}
                        src="${image.library.questing.url}checkanim2.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="success_pic_3"
                        params={16}
                        src="${image.library.questing.url}checkanim3.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="success_pic_4"
                        params={16}
                        src="${image.library.questing.url}checkanim4.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="success_pic_5"
                        params={16}
                        src="${image.library.questing.url}checkanim5.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="success_pic_6"
                        params={16}
                        src="${image.library.questing.url}checkanim6.png"
                        layout={{ position: 'absolute', left: 15, width: 41, top: 32, height: 47 }}
                    />
                    <ThemeImage
                        name="prompt_pic_a"
