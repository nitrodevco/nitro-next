...
export const ClubCenterLayout = ({ layout, onBtnBuy, onBtnEarn, onBtnGift, onClose, onGeneralInfolink, onSpecialBreakdownLink, onSpecialInfolink }: ClubCenterLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="coverpic"
                            params={16}
                            src={layoutImage('hc_center_hc_center_cover.png')}
                    ...
                    >
                        ...
                        <ThemeImage
                            ...
                            params={16}
                            src={layoutImage('hc_center_hc_center_illustration.png')}
                ...
                >
                    <ThemeImage
                        name="hc_postit_bg"
                        params={16}
                        src={layoutImage('hc_center_hc_postit_bg.png')}
                    ...
                    <ThemeImage
                        ...
                        params={16}
                        src={layoutImage('hc_center_hc_center_timer.png')}
                        layout={{ position: 'absolute', left: 7, width: 24, top: 41, height: 24 }}
                    />
                    <ThemeImage
                        name="special_amount_icon"
                        params={16}
                        src={layoutImage('hc_center_icon_credits.png')}
