...
export const WelcomeScreenLayout = ({ layout, onClose, onFrame }: WelcomeScreenLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 251, height: 87, ...layout }}>
            ...
            >
                    ...
                    <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                        ...
                        >
                            <Region
                                name="text"
                                params={8388624}
                                layout={{ position: 'absolute', left: 0, width: 189, top: 0, height: 37, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
                                    text="welcome.scjkh kjh kjh kjh kjh kjh kjh kjhkjh kj hkj hkjhreen.message"
                ...
                <ThemeImage
                    name="arrow"
                    src={layoutImage('common_welcome_screen_arrow.png')}
