...
export const HabboModerationPromoLayout = ({ layout }: HabboModerationPromoLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 250, height: 192, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text={t('landing.view.moderationpromo.title')}
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.caption')}
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.info')}
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.cursing.caption')}
                            textStyle="text-style-il-heading-3"
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.cursing.info')}
                            textOptions={{ wordWrap: true, wordWrapWidth: 250 }}
                        />
                    </Region>
                    <Region
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.wrongdoers.caption')}
                            textStyle="text-style-il-heading-3"
                    ...
                    >
                        <ThemeText
                            text={t('landing.view.moderationpromo.wrongdoers.info')}
                            textOptions={{ wordWrap: true, wordWrapWidth: 250 }}
                        />
                    </Region>
                </Region>
