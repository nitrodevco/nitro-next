...
export const MannequinControllerSaveLayout = ({ layout, onSaveButton }: MannequinControllerSaveLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text="${mannequin.widget.savetext "
