...
export const CustomWordFilterSettingsLayout = ({ layout, onAddBtn, onBackBtn, onRemoveBtn }: CustomWordFilterSettingsLayoutProps) => {
                        ...
                        >
                            ...
                            >
                                <Region
                                    ...
                                    layout={{ width: 213, height: 18, flexShrink: 0 }}
                                >
                                    <Region
                                        name="bg_region"
                                        params={17}
