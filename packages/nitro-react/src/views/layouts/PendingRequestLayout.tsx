...
export const PendingRequestLayout = ({ layout, onClose, onDiscardButton, onKeepButton }: PendingRequestLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <Region
                        params={16}
                        layout={{ width: 217, height: 19, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    <Region
                        params={16}
                        layout={{ width: 351, height: 24, flexShrink: 0, minWidth: 351, maxWidth: 351, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    >
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 13, width: 192, top: 11, height: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
