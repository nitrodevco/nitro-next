...
export const GuildFurniMenuLayout = ({ layout, onButton, onButton2, onButton3 }: GuildFurniMenuLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 115, height: 140, ...layout }}>
            ...
            >
                <Region
                    name="border"
                    params={12582928}
                    layout={{ position: 'absolute', left: 0, width: 107, top: 0, height: 130 }}
                >
                    <Region
                        name="profile_link"
                        params={17}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ThemeText
                                        text={t('widget.furniture.button.join.group')}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ThemeText
                                        text={t('widget.furniture.button.go.to.group.home.room')}
                                        textStyle="text-style-u-regular"
                                        textOptions={{ fill: '#ffffff', align: 'center' }}
                                    />
                                </Region>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ThemeText
                                        text={t('widget.furniture.button.open_group_forum')}
                                        textStyle="text-style-u-regular"
                                        textOptions={{ fill: '#ffffff', align: 'center' }}
                                    />
                                </Region>
