...
export const MarketplaceOfferDetailsLayout = ({ layout, onBackButton, onBuyButton, onPriceDevelopment, onTradeVolume }: MarketplaceOfferDetailsLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 340, height: 460, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('catalog.marketplace.offer_details.price')}
                    ...
                    >
                        <ThemeText
                            text={t('catalog.marketplace.offer_details.offer_count')}
                            textStyle="text-style-u-small"
                        />
                    </Region>
                    <Region
                    ...
                    >
                        <ThemeText
                            text={t('catalog.marketplace.offer_details.average_price')}
                            textStyle="text-style-u-small"
                        />
                    </Region>
                </Region>
