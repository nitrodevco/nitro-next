...
export const AchievementCategoryLayout = ({ layout }: AchievementCategoryLayoutProps) => {
    return (
            ...
            >
                ...
                >
                    <ThemeImage
                        ...
                        params={3089}
                        src="${image.library.questing.url}achievement_background_active_1.png"
                        layout={{ position: 'absolute', left: 0, width: 112, top: 0, height: 105 }}
                    />
                </Region>
                <Region
                ...
                >
                    <ThemeImage
                        ...
                        params={3089}
                        src="${image.library.questing.url}achievement_background_active_2.png"
                        layout={{ position: 'absolute', left: 0, width: 112, top: 0, height: 105 }}
                    />
                </Region>
                <Region
                ...
                >
                    <ThemeImage
                        ...
                        params={3088}
                        src="${image.library.questing.url}achievement_category_bkg_empty_3.png"
                        layout={{ position: 'absolute', left: 0, width: 110, top: 1, height: 103 }}
                    />
                </Region>
                <Region
