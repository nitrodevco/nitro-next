...
export const PetpackageNewLayout = ({ layout, onClose, onPickName }: PetpackageNewLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    <ThemeImage
                        ...
                        params={16}
                        src="${image.library.url}client_static/petpackage_box.png"
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('petpackage.header.title')}
                        ...
                        >
                            <ThemeText
                                text={t('widgets.petpackage.name.select')}
