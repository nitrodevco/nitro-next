...
export const CraftingwidgetLayout = ({ layout, onBtnCancel, onBtnCraft, onClose }: CraftingwidgetLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text="Spellbook wdfsdf ef ewfwe fwfe wef ewf wefwe"
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="This spell will produce yy yy yyyyyyyy yyyyyy yy yyy xxxxxx xxx xxxxx"
                    ...
                    >
                        <ThemeText
                            text="This spell will produce xxxxxx xxx xxxxx"
