...
export const DailytasksUnclaimedLayout = ({ layout, onClose }: DailytasksUnclaimedLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <Region
                        name="spacing"
                        params={16}
                        layout={{ width: 452, height: 6, flexShrink: 0 }}
                    />
                    <ScrollArea
                        orientation="vertical"
                        layout={{ width: 426, height: 373, flexShrink: 0, minWidth: 426, maxWidth: 426, minHeight: 373, maxHeight: 500 }}
                    >
                        <Region
                            name="tasks_list"
                            params={144}
