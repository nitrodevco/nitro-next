...
export const IssueBrowserLayout = ({ layout, onAutoPick, onClose, onHandleButton, onMyIssues, onOpenIssues, onPickButton, onPickedIssues, onReleaseAll, onReleaseButton }: IssueBrowserLayoutProps) => {
    return (
        <Frame
            variant="0"
            params={98305}
                            ...
                            >
                                ...
                                >
                                    <Region
                                        name="item_prototype"
                                        params={145}
                                        layout={{ width: 517, height: 24, flexShrink: 0, minHeight: 24, maxHeight: 24 }}
                                    >
                                        <Region
                                        ...
                                        >
                                            ...
                                            >
                                                <ThemeText text="Sharing personal info" />
                                            </Region>
                                            <Region
                                                name="source"
                                                params={144}
