...
export const FurniChestContentsLayoutFurniTemplateItem = ({ captionFurniQuantity, layout, onFurniTemplate, srcOutlineFocus, srcUniqueItemBackgroundBitmap, visibleNumberContainer, visibleRarityItemOverlayContainer, visibleUniqueItemBackgroundBitmap, visibleUniqueItemOverlayContainer }: FurniChestContentsLayoutFurniTemplateItemProps) => {
    return (
        <Region
            name="furni_template"
...
export const FurniChestContentsLayoutRightPanel = ({ captionFurniName, itemsWithdrawCont, layout, onViewLogsByFurniBtn, srcPlaceholderPreviewImage, visiblePlaceholderPreviewImage, visibleViewLogsByFurniBtn }: FurniChestContentsLayoutRightPanelProps) => {
    const t = useTranslation();
