...
export const WiredStyleVolterBlueLayoutLeftPaddingItem2 = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleVolterBlueLayoutLeftPaddingItem2Props) => {
    return (
        <Region
            name="left_padding"
