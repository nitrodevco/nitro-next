...
export const WiredStyleVolterBlueLayoutRightPaddingItem2 = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterBlueLayoutRightPaddingItem2Props) => {
    return (
        <Region
            name="right_padding"
