...
export const WiredStyleVolterBlueLayoutMiniButtonBgItem = ({ layout, onMiniButtonClick, srcMiniButtonIcon, visibleMiniButtonClick, visibleMiniButtonIcon }: WiredStyleVolterBlueLayoutMiniButtonBgItemProps) => {
    return (
        <Region
            name="mini_button_bg"
