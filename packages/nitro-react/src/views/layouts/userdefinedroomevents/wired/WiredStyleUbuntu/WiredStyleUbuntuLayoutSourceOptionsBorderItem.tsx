...
import { WiredStyleUbuntuLayoutSourceBtnItem } from './WiredStyleUbuntuLayoutSourceBtnItem';
...
export const WiredStyleUbuntuLayoutSourceOptionsBorderItem = ({ itemsSourceOptionsList, layout, visibleSourceOptionsCont, visibleSourceOptionsList }: WiredStyleUbuntuLayoutSourceOptionsBorderItemProps) => {
    return (
        <Region
