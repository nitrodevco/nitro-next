...
export const WiredStyleUbuntuLayoutLeftPaddingItem = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleUbuntuLayoutLeftPaddingItemProps) => {
    return (
        <Region
            name="left_padding"
