...
export const WiredMenuViewLayoutVariableValuesContainer = ({ captionTitle, layout, onAddVarBtn, onCreateVarBtn, onDeleteVarBtn, variableValuesTableContainer, varPickerContainer, visibleCreateVarBubble }: WiredMenuViewLayoutVariableValuesContainerProps) => {
