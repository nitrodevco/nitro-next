...
export const WiredStyleVolterLayoutLeftPaddingItem2 = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleVolterLayoutLeftPaddingItem2Props) => {
    return (
        <Region
            name="left_padding"
