...
export const WiredStyleVolterLayoutRightPaddingItem = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterLayoutRightPaddingItemProps) => {
    return (
        <Region
            name="right_padding"
