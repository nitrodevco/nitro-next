...
export const WiredStyleVolterGreenLayoutRightPaddingItem = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterGreenLayoutRightPaddingItemProps) => {
    return (
        <Region
            name="right_padding"
