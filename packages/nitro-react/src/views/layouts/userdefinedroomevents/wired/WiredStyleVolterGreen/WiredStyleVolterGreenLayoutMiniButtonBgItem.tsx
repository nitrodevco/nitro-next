...
export const WiredStyleVolterGreenLayoutMiniButtonBgItem = ({ layout, onMiniButtonClick, srcMiniButtonIcon, visibleMiniButtonClick, visibleMiniButtonIcon }: WiredStyleVolterGreenLayoutMiniButtonBgItemProps) => {
    return (
        <Region
            name="mini_button_bg"
