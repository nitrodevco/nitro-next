...
export const WiredStyleVolterGreenLayoutRightPaddingItem2 = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterGreenLayoutRightPaddingItem2Props) => {
    return (
        <Region
            name="right_padding"
