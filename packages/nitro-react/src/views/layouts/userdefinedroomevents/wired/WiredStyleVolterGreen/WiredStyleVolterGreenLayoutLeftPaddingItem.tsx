...
export const WiredStyleVolterGreenLayoutLeftPaddingItem = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleVolterGreenLayoutLeftPaddingItemProps) => {
    return (
        <Region
            name="left_padding"
