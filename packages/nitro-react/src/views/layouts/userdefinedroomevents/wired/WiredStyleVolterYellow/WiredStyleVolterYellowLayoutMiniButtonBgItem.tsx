...
export const WiredStyleVolterYellowLayoutMiniButtonBgItem = ({ layout, onMiniButtonClick, srcMiniButtonIcon, visibleMiniButtonClick, visibleMiniButtonIcon }: WiredStyleVolterYellowLayoutMiniButtonBgItemProps) => {
    return (
        <Region
            name="mini_button_bg"
