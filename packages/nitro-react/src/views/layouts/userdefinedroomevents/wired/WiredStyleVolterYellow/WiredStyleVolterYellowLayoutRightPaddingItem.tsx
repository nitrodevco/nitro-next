...
export const WiredStyleVolterYellowLayoutRightPaddingItem = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterYellowLayoutRightPaddingItemProps) => {
    return (
        <Region
            name="right_padding"
