...
export const WiredStyleVolterYellowLayoutLeftPaddingItem = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleVolterYellowLayoutLeftPaddingItemProps) => {
    return (
        <Region
            name="left_padding"
