...
export const WiredStyleVolterYellowLayoutLeftPaddingItem2 = ({ border, layout, marginItemColorLeft, visibleBorder, visibleLeftPaddingBorder, visibleMarginItemColorLeft }: WiredStyleVolterYellowLayoutLeftPaddingItem2Props) => {
    return (
        <Region
            name="left_padding"
