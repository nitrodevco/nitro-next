...
export const WiredStyleVolterYellowLayoutRightPaddingItem2 = ({ border, layout, marginItemColorRight, visibleBorder, visibleMarginItemColorRight, visibleRightPaddingBorder }: WiredStyleVolterYellowLayoutRightPaddingItem2Props) => {
    return (
        <Region
            name="right_padding"
