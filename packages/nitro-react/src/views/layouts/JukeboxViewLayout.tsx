...
export const JukeboxViewLayout = ({ layout, onBuyoutButton, onCatalogButton, onClose, onExtendButton, onMove, onPickup, onRentButton, onRotate, onUse }: JukeboxViewLayoutProps) => {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('infostand.jukebox.text.not.playing')}
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('infostand.jukebox.text.track.name')}
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('infostand.jukebox.text.creator')}
                                    textOptions={{ fill: '#ffffff', wordWrap: true, wordWrapWidth: 150 }}
                                />
                            </Region>
                        </Region>
