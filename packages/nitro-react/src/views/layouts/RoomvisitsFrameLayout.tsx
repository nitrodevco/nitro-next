...
export const RoomvisitsFrameLayout = ({ layout, onClose }: RoomvisitsFrameLayoutProps) => {
    return (
        <Frame
            variant="0"
            params={98305}
                    ...
                    >
                        ...
                        >
                            <Region
                                name="visitrow"
                                params={144}
                                layout={{ width: 263, height: 14, flexShrink: 0 }}
                            >
                                <Region
                                    name="time_txt"
                                    params={80}
