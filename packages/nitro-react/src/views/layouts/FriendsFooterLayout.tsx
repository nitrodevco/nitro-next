...
export const FriendsFooterLayout = ({ layout, onButtonOpenHomepage, onButtonOpenMinimail, onButtonRemoveFriend, onButtonRoomInvite, onButtonSearch }: FriendsFooterLayoutProps) => {
