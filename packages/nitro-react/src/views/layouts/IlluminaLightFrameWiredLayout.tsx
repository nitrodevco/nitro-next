...
export const IlluminaLightFrameWiredLayout = ({ layout, onHeaderButtonClose, onHeaderButtonMenu }: IlluminaLightFrameWiredLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 50, height: 50, ...layout }}>
            ...
            >
                <ThemeImage
                    name="banner_left"
                    params={16}
                    src={layoutImage('illumina_wired_bg_left.png')}
