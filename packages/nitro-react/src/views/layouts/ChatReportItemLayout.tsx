...
export const ChatReportItemLayout = ({ layout }: ChatReportItemLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 307, height: 24, ...layout }}>
            ...
            >
                <Region
                    name="text"
                    params={3088}
                    layout={{ position: 'absolute', left: 0, width: 307, top: 0, height: 24, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                >
                    <ThemeText
                        text="foo faa fee"
