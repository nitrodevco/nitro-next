...
export const PollOfferLayout = ({ layout, onClose, onPollOfferButtonOk }: PollOfferLayoutProps) => {
                ...
                >
                    ...
                    >
                        <Region
                            ...
                            params={144}
                            layout={{ width: 250, height: 30, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                                text={t('poll_offer_title')}
                ...
                >
                    ...
                    >
                        <Region
                            ...
                            params={144}
                            layout={{ width: 355, height: 17, flexShrink: 0, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                                text={t('poll_offer_summary')}
