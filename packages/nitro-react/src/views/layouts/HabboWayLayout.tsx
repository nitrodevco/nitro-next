...
export const HabboWayLayout = ({ layout, onBackButton, onFrameClose, onNextButton, onPreviousButton, onQuizButton }: HabboWayLayoutProps) => {
                    ...
                    <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                        ...
                        >
                            ...
                            <ThemeImage
                                name="dove_image"
                                params={16}
                                src={layoutImage('help_habboway_dove_off.png')}
                        ...
                        >
                            ...
                            <ThemeImage
                                ...
                                params={16}
                                src={layoutImage('help_habboway_correct.png')}
                            ...
                            >
                                <ThemeText
                                    text="In Habbo you can play many games, be who you want to be and have fun..."
                            ...
                            <ThemeImage
                                ...
                                params={16}
                                src={layoutImage('help_habboway_wrong.png')}
                            ...
                            >
                                <ThemeText
                                    text="as%20long%20as%20you%20don%u2019t%20hurt%20anyone%u2019s%20beliefs.%20Respect%20each%20and%20every%20other%20user."
                                    textOptions={{ wordWrap: true, wordWrapWidth: 210 }}
                                />
                            </Region>
                            <ContainerButton
