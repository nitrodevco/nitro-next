...
export const CameraEditorLayout = ({ layout, onCancelButton, onClose, onPurchaseButton }: CameraEditorLayoutProps) => {
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="download_image"
                            params={16}
                            src={layoutImage('tools_tools_download_icon.png')}
