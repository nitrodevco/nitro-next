...
export const RoomToolsToolbarLayout = ({ layout }: RoomToolsToolbarLayoutProps) => {
                ...
                >
                    ...
                    >
                        ...
                        <Region
                            ...
                            visible={false}
                            layout={{ width: 130, height: 25, flexShrink: 0 }}
                        >
                            <Region
                                params={16}
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('room.achievements.button.text')}
                                    textOptions={{ fill: '#cccccc' }}
                                />
                            </Region>
                        </Region>
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('room.settings.button.text')}
                                    textOptions={{ fill: '#cccccc' }}
                                />
                            </Region>
                        </Region>
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('room.chathistory.button.text')}
                                    textStyle="text-style-u-button-tab"
                                    textOptions={{ fill: '#bbbbbb' }}
                                />
                            </Region>
                        ...
                        >
                            ...
                            >
                                <ThemeText
                                    text={t('room.camera.button.text')}
                                    textStyle="text-style-u-button-tab"
                                    textOptions={{ fill: '#bbbbbb' }}
                                />
                            </Region>
                        ...
                        <Region
                            name="cnt_history"
                            layout={{ width: 115, height: 43, flexShrink: 0 }}
                        >
                            <Region
