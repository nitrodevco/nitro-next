...
export const GroupManagementWindowLayout = ({ layout, onBaseDropmenu, onBuyButton, onCbMemberRights, onClose, onEditTab1, onEditTab2, onEditTab3, onEditTab5, onNextStepButton, onRbTypeExclusive, onRbTypePrivate, onRbTypeRegular, onResetBadge, onResetColors }: GroupManagementWindowLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="gcreate_1_0"
                            params={16}
                            src="${image.library.url}guilds/gcreate_1_0.png"
                            layout={{ position: 'absolute', left: 0, width: 84, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_1_1"
                            params={16}
                            src="${image.library.url}guilds/gcreate_1_1.png"
                            layout={{ position: 'absolute', left: 0, width: 84, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_2_0"
                            params={16}
                            src="${image.library.url}guilds/gcreate_2_0.png"
                            layout={{ position: 'absolute', left: 77, width: 83, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_2_1"
                            params={16}
                            src="${image.library.url}guilds/gcreate_2_1.png"
                            layout={{ position: 'absolute', left: 77, width: 83, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_3_0"
                        ...
                        <ThemeImage
                            name="gcreate_4_0"
                            params={16}
                            src="${image.library.url}guilds/gcreate_4_0.png"
                            layout={{ position: 'absolute', left: 227, width: 133, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_4_1"
                            params={16}
                            src="${image.library.url}guilds/gcreate_4_1.png"
                            layout={{ position: 'absolute', left: 227, width: 133, top: 0, height: 33 }}
                        />
                        <ThemeImage
                            name="gcreate_icon_credit"
                            params={16}
                            src="${image.library.url}guilds/gcreate_icon_credit.png"
                        ...
                        >
                            <ThemeText
                                text={t('group.create.steplabel.1')}
                        ...
                        >
                            <ThemeText
                                text={t('group.create.steplabel.2')}
                                textOptions={{ fill: '#ffffff' }}
                            />
                        </Region>
                        <Region
                        ...
                        >
                            <ThemeText
                                text={t('group.create.steplabel.3')}
                                textOptions={{ fill: '#ffffff' }}
                            />
                        </Region>
                        <Region
                        ...
                        >
                            <ThemeText
                                text={t('group.create.steplabel.4')}
                                textOptions={{ fill: '#ffffff' }}
                            />
                        </Region>
                    </Region>
                    <ThemeImage
                        ...
                        params={16}
                        src="${image.library.url}guilds/group_UI_identity.png"
                        layout={{ position: 'absolute', left: 0, width: 114, top: 0, height: 62 }}
                    />
                    <ThemeImage
                        name="header_pic_bitmap_step_2"
                        params={16}
                        src="${image.library.url}guilds/group_UI_badge.png"
                        layout={{ position: 'absolute', left: 0, width: 114, top: 0, height: 62 }}
                    />
                    <ThemeImage
                        name="header_pic_bitmap_step_3"
                        params={16}
                        src="${image.library.url}guilds/group_UI_colors.png"
                        layout={{ position: 'absolute', left: 0, width: 114, top: 0, height: 62 }}
                    />
                    <ThemeImage
                        name="header_pic_bitmap_step_4"
                        params={16}
                        src="${image.library.url}guilds/group_UI_ready.png"
                        layout={{ position: 'absolute', left: 0, width: 114, top: 0, height: 62 }}
                    />
                    <ThemeImage
                ...
                >
                    ...
                    >
                        <ThemeText text={t('group.edit.name')} />
                    </Region>
                    <TextInput
                        value={nameTxtValue}
                    ...
                    >
                        <ThemeText text={t('group.edit.desc')} />
                    </Region>
                    <TextInput
                        value={descTxtValue}
                    ...
                    >
                        <ThemeText text={t('group.edit.base')} />
                    </Region>
                    <Dropmenu
                        variant="0"
                        name="base_dropmenu"
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="Group Name Here DIPPA DAPPA DII"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('group.create.previousstep')} />
                        </Region>
                    </Region>
                    <Border
                        variant="0"
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('group.create.confirm.buyinfo')}
                            ...
                            >
                                ...
                                >
                                    <ThemeImage
                                        ...
                                        params={16}
                                        src="${image.library.url}guilds/grouptype_icon_0.png"
