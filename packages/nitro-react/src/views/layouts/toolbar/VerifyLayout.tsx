...
export const VerifyLayout = ({ captionDidNotReceiveCodeLink, captionRetryWaitLabel, layout, onClose, onDidNotReceiveCodeLink, onOkButton, srcPen, srcPhone }: VerifyLayoutProps) => {
