        ...
        <Region layout={{ position: 'relative', width: 180, height: 140, ...layout }}>
            ...
            >
                <ThemeText
                    ...
                    name="settings_title"
                    layout={{ position: 'absolute', marginLeft: 0.5, marginRight: -0.5, width: 141, top: 5, height: 17, maxWidth: 150 }}
                />
                <Region
                    name="line"
                ...
                {(visibleIdentityText ?? false) && (
                    <ThemeText
                        ...
                        name="identity_text"
                        verticalAlign="top"
                        layout={{ position: 'absolute', left: 11, width: 159, top: 81, height: 20 }}
                    />
                )}
                <Button
                    variant="3"
