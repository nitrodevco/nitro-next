...
export const NuxGiftSelectionLayoutNuxGiftOptionItem2 = ({ captionOptionHeading, layout, onOptionButton, optionBitmapBg, srcOptionBitmap, visibleOptionBitmap, visibleOptionBitmapBg, visibleOptionButton, visibleOptionHeading, visibleOptionThumbnail }: NuxGiftSelectionLayoutNuxGiftOptionItem2Props) => {
