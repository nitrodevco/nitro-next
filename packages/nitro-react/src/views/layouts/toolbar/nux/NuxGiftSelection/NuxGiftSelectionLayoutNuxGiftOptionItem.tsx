...
export const NuxGiftSelectionLayoutNuxGiftOptionItem = ({ captionOptionHeading, layout, onOptionButton, optionBitmapBg, srcOptionBitmap, visibleOptionBitmap, visibleOptionBitmapBg, visibleOptionButton, visibleOptionHeading, visibleOptionThumbnail }: NuxGiftSelectionLayoutNuxGiftOptionItemProps) => {
