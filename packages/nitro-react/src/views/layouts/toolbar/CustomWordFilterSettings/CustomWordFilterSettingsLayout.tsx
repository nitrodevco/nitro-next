...
import { CustomWordFilterSettingsLayoutWordFilterListItemItem } from './CustomWordFilterSettingsLayoutWordFilterListItemItem';
...
export const CustomWordFilterSettingsLayout = ({ captionWordFilterTitle, itemsWordlist, layout, line, onAddBtn, onBackBtn, onRemoveBtn }: CustomWordFilterSettingsLayoutProps) => {
