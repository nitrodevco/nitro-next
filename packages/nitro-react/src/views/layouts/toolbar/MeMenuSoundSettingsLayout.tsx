                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="slider_base"
                            params={16}
                            src={srcSliderBase2 ?? layoutImage('toolbar_memenu_settings_slider_base.png')}
                            layout={{ position: 'absolute', left: 2, width: 139, top: 0, height: 20 }}
                        />
                        <Region
                            name="slider_movement_area"
                        ...
                        >
                            ...
                            >
                                <ThemeImage
                                    name="slider_bitmap"
                                    params={272}
                                    src={srcSliderBitmap2 ?? layoutImage('toolbar_memenu_settings_slider_button.png')}
                                    layout={{ position: 'absolute', left: 0, width: 12, top: 0, height: 15 }}
                                />
                            </Region>
                        </Region>
                    ...
                    >
                        <ThemeImage
                            name="sounds_off_icon"
                            params={16}
                            src={srcSoundsOffIcon2 ?? layoutImage('toolbar_memenu_settings_sounds_off_white.png')}
                            layout={{ position: 'absolute', left: 0, width: 29, top: 4, height: 22 }}
                        />
                    </Region>
                    <Region
                    ...
                    >
                        <ThemeImage
                            name="sounds_on_icon"
                            params={16}
                            src={srcSoundsOnIcon2 ?? layoutImage('toolbar_memenu_settings_sounds_on_white.png')}
                            layout={{ position: 'absolute', left: 0, width: 29, top: 4, height: 22 }}
                        />
                    </Region>
                </Region>
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="slider_base"
                            params={16}
                            src={srcSliderBase3 ?? layoutImage('toolbar_memenu_settings_slider_base.png')}
                            layout={{ position: 'absolute', left: 2, width: 139, top: 0, height: 20 }}
                        />
                        <Region
                            name="slider_movement_area"
                        ...
                        >
                            ...
                            >
                                <ThemeImage
                                    name="slider_bitmap"
                                    params={272}
                                    src={srcSliderBitmap3 ?? layoutImage('toolbar_memenu_settings_slider_button.png')}
                                    layout={{ position: 'absolute', left: 0, width: 12, top: 0, height: 15 }}
                                />
                            </Region>
                        </Region>
                    ...
                    >
                        <ThemeImage
                            name="sounds_off_icon"
                            params={16}
                            src={srcSoundsOffIcon3 ?? layoutImage('toolbar_memenu_settings_sounds_off_white.png')}
                            layout={{ position: 'absolute', left: 0, width: 29, top: 4, height: 22 }}
                        />
                    </Region>
                    <Region
                    ...
                    >
                        <ThemeImage
                            name="sounds_on_icon"
                            params={16}
                            src={srcSoundsOnIcon3 ?? layoutImage('toolbar_memenu_settings_sounds_on_white.png')}
                            layout={{ position: 'absolute', left: 0, width: 29, top: 4, height: 22 }}
                        />
                    </Region>
                </Region>
