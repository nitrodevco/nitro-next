...
export const WelcomeNameSelectionLayout = ({ layout, onCancelSelectionButton, onCheckNameButton, onSelectNameButton }: WelcomeNameSelectionLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 303, height: 193, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text={t('tutorial.name_change.info.select')}
