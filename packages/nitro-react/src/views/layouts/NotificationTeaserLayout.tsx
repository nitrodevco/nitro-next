...
export const NotificationTeaserLayout = ({ layout, onClose, onTeaserOkBtn }: NotificationTeaserLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.congrats')}
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.description')}
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('widget.furni.teaser.get')}
                                textStyle="text-style-bold"
