...
export const UseProductControllerPurchasableClothingLayout = ({ layout, onSaveButton }: UseProductControllerPurchasableClothingLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.text.bind_clothing')}
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.info.bind_clothing')}
