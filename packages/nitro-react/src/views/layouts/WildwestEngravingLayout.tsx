...
export const WildwestEngravingLayout = ({ layout }: WildwestEngravingLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 375, height: 210, ...layout }}>
            ...
            >
                <ThemeImage
                    name="background"
                    params={16}
                    src="${image.library.url}furniextras/loveLock_wildwest.png"
                    layout={{ position: 'absolute', left: 0, width: 375, top: 0, height: 210 }}
                />
                <Region
                    name="header"
                ...
                >
                    <ThemeText
                        text={t('wildwest.engraving.caption')}
                ...
                >
                    <ThemeText
                        text={t('wildwest.engraving.left')}
                        textStyle="text-style-u-bold"
                ...
                >
                    <ThemeText
                        text={t('wildwest.engraving.right')}
                        textStyle="text-style-u-bold"
