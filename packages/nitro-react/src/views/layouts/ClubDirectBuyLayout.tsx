...
export const ClubDirectBuyLayout = ({ layout, onBuy, onClose, onClubBenefitsLink }: ClubDirectBuyLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text={t('direct.club.buy.header.bold.text')}
                ...
                >
                    <ThemeText
                        text={t('direct.club.buy.header.standard.text')}
                ...
                >
                    <ThemeText
                        text={t('direct.club.buy.compare.club.benefits.link')}
                        textStyle="text-style-u-bold"
