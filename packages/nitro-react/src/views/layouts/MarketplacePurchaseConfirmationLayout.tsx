...
export const MarketplacePurchaseConfirmationLayout = ({ layout, onBuyButton, onCancelButton, onClose, onSpendingDisclaimer }: MarketplacePurchaseConfirmationLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('catalog.marketplace.offer_count')}
                            textStyle="text-style-u-small"
                            textOptions={{ wordWrap: true, wordWrapWidth: 246 }}
                        />
                    </Region>
