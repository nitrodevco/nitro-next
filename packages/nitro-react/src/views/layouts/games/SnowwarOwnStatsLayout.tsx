...
export const SnowwarOwnStatsLayout = ({ captionPersonalScore, captionPersonalScoreStroke, layout, srcBackgroundFlashImage, srcBackgroundImage, srcEnergyBar, srcUserImage, strokeTextColor }: SnowwarOwnStatsLayoutProps) => {
    return (
