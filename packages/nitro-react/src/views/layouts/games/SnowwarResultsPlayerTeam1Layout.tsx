...
export const SnowwarResultsPlayerTeam1LayoutPlayerStats = ({ captionPlayerHits, captionPlayerHitsLabel, captionPlayerHitsStroke, captionPlayerKills, captionPlayerKillsLabel, captionPlayerKillsStroke, layout }: SnowwarResultsPlayerTeam1LayoutPlayerStatsProps) => {
    const t = useTranslation();
...
export const SnowwarResultsPlayerTeam1LayoutPlayerTotalStats = ({ captionTotalScore, captionTotalScoreLabel, captionTotalScoreStroke, layout }: SnowwarResultsPlayerTeam1LayoutPlayerTotalStatsProps) => {
    const t = useTranslation();
...
export const SnowwarResultsPlayerTeam1LayoutPlayerDataContainer = ({ captionPlayerName, captionPlayerNameStroke, layout, playerStats, playerTotalStats, scoreTooltip, srcPlayerDataBackground }: SnowwarResultsPlayerTeam1LayoutPlayerDataContainerProps) => {
    return (
        <Region
...
export const SnowwarResultsPlayerTeam1LayoutPlayerScoreContainer = ({ captionPlayerScore, captionPlayerScoreStroke, layout, srcLoadingIcon, srcPlayerScoreBackground, srcPlayerScoreGlow }: SnowwarResultsPlayerTeam1LayoutPlayerScoreContainerProps) => {
    return (
        <Region
