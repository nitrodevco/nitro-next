...
export const SnowwarResultsPlayerTeam1LayoutAddFriend = ({ layout, onAddFriend, tags, visibleAddFriend }: SnowwarResultsPlayerTeam1LayoutAddFriendProps) => {
...
export const SnowwarResultsPlayerTeam1LayoutPlayerImageContainer = ({ addFriend, layout, srcPlayerImage, srcPlayerImageBackground, tags }: SnowwarResultsPlayerTeam1LayoutPlayerImageContainerProps) => {
    return (
        <Region
...
export const SnowwarResultsPlayerTeam1LayoutPlayerStats = ({ captionPlayerHits, captionPlayerHitsLabel, captionPlayerHitsStroke, captionPlayerKills, captionPlayerKillsLabel, captionPlayerKillsStroke, layout, tags }: SnowwarResultsPlayerTeam1LayoutPlayerStatsProps) => {
    const t = useTranslation();
            ...
            <Region layout={{ position: 'absolute', left: 62, width: 60, top: 0, height: 17 }}>
                ...
                >
                    <ThemeText
                        ...
                        textOptions={{ fill: '#6699cc', align: 'right' }}
                    />
                </Region>
                <Region
                    name="playerHits"
...
export const SnowwarResultsPlayerTeam1LayoutPlayerTotalStats = ({ captionTotalScore, captionTotalScoreLabel, captionTotalScoreStroke, layout, tags }: SnowwarResultsPlayerTeam1LayoutPlayerTotalStatsProps) => {
    const t = useTranslation();
...
export const SnowwarResultsPlayerTeam1LayoutScoreTooltip = ({ layout, onScoreTooltip, srcSkillLevel, tags, visibleScoreTooltip }: SnowwarResultsPlayerTeam1LayoutScoreTooltipProps) => {
    return (
        <Region
            name="scoreTooltip"
            tags={tags}
...
export const SnowwarResultsPlayerTeam1LayoutPlayerDataContainer = ({ captionPlayerName, captionPlayerNameStroke, layout, playerStats, playerTotalStats, scoreTooltip, srcPlayerDataBackground, tags }: SnowwarResultsPlayerTeam1LayoutPlayerDataContainerProps) => {
    return (
        <Region
...
export const SnowwarResultsPlayerTeam1LayoutPlayerScoreContainer = ({ captionPlayerScore, captionPlayerScoreStroke, layout, srcLoadingIcon, srcPlayerScoreBackground, srcPlayerScoreGlow, tags }: SnowwarResultsPlayerTeam1LayoutPlayerScoreContainerProps) => {
    return (
        <Region
