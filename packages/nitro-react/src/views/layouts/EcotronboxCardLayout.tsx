...
export const EcotronboxCardLayout = ({ layout, onEcotronboxCardBtnClose, onEcotronboxCardBtnOpen }: EcotronboxCardLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 257, height: 114, ...layout }}>
            ...
            >
                <ThemeImage
                    ...
                    params={19}
                    src="${image.library.url}Giftcards/ecotronbox_card_bg.png"
                    layout={{ position: 'absolute', left: 0, width: 257, top: 0, height: 114 }}
                />
                <ThemeImage
                ...
                >
                    <ThemeText
                        text={t('widget.furni.ecotronbox.title')}
