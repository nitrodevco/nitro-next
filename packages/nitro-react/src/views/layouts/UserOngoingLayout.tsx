...
export const UserOngoingLayout = ({ layout, onClose, onCloseLink, onGuideNameLink, onReportGuideLink }: UserOngoingLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText text={t('guide.help.request.user.ongoing.guide.desc')} />
                            </Region>
                        </Region>
                    </Region>
                    <Region
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('guide.help.request.user.ongoing.close.link')}
