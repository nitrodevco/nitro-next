...
export const ExpiringCatalogPageLayout = ({ layout, onOpenCatalogButton }: ExpiringCatalogPageLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 500, height: 186, ...layout }}>
            ...
            >
                ...
                <ThemeImage
                    name="promo_bitmap"
                    params={16}
                    src="${image.library.catalogue.url}kitchen_teaser_de.gif"
