    ...
    return (
        ...
        >
            <ThemeText
                ...
                name="doormode_label"
                layout={{ position: 'absolute', left: 0, width: 193, top: 0, height: 17 }}
            />
            <Region
                name="doormode"
