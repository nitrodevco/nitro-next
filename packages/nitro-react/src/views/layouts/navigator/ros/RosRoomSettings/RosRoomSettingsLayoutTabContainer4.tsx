    ...
    return (
        ...
        >
            ...
            <ThemeText
                ...
                name="vip_tab_info"
                verticalAlign="top"
                layout={{ position: 'absolute', left: 0, width: 310, top: 19, height: 63 }}
            />
            <ThemeText
                text={captionVipSettingsText ?? t('navigator.roomsettings.vip_settings')}
                textStyle="text-style-u-bold"
                name="vip_settings_text"
                layout={{ position: 'absolute', left: 0, width: 206, top: 84, height: 17 }}
            />
            <CheckBox
                variant="0"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 20, width: 194, top: 103, height: 17 }}
            />
            <Dropmenu
                variant="2"
                name="wall_thickness"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 0, width: 221, top: 191, height: 17 }}
            />
            <CheckBox
                variant="0"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 20, width: 292, top: 211, height: 17 }}
            />
            <CheckBox
                variant="0"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 20, width: 192, top: 233, height: 17 }}
            />
            <TextInput
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 77, width: 231, top: 257, height: 17 }}
            />
            <CheckBox
                variant="0"
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 20, width: 210, top: 279, height: 17 }}
            />
            <TextInput
            ...
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 77, width: 231, top: 303, height: 17 }}
            />
            <ThemeText
                text={captionChatSettingsText ?? t('navigator.roomsettings.chat.flood_sensitivity')}
                textStyle="text-style-u-bold"
                name="chat_settings_text"
                layout={{ position: 'absolute', left: 0, width: 260, top: 335, height: 17 }}
            />
            <Dropmenu
                variant="2"
