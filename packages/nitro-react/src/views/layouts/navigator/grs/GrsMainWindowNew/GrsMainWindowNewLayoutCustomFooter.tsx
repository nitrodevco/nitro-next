...
export const GrsMainWindowNewLayoutCustomFooter = ({ adCont, captionAdCaption, captionGetEventCaption, captionMoreRoomsCaption, layout, onAdCont, onAdFooter, onCreateRoomBut, onCustomFooter, onGetEventBut, onMeFooter, onRoomAdsFooter, srcCreateRoom, tintCreateRoom, visibleAdCaption }: GrsMainWindowNewLayoutCustomFooterProps) => {
