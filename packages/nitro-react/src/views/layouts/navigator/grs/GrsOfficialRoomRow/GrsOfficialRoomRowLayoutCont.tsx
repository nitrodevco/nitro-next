...
import { GrsOfficialRoomRowLayoutImageCont, GrsOfficialRoomRowLayoutImageContProps } from './GrsOfficialRoomRowLayoutImageCont';
...
export const GrsOfficialRoomRowLayoutCont = ({ captionArrowLabel, captionEntryCaption, captionEntryDesc, captionFolderNameText, imageCont, layout, onCont, srcArrowDownWhite, srcArrowRightWhite, srcFolderImage, srcRicoRndL, srcRicoRndLB, srcRicoRndM, srcRicoRndR, srcRicoRndRB, tintArrowDownWhite, tintArrowRightWhite, tintFolderImage, tintRicoRndL, tintRicoRndLB, tintRicoRndM, tintRicoRndR, tintRicoRndRB }: GrsOfficialRoomRowLayoutContProps) => {
    return (
        <Region
            name="cont"
