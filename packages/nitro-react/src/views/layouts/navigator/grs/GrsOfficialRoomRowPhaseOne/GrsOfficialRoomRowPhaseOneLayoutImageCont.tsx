...
export const GrsOfficialRoomRowPhaseOneLayoutImageCont = ({ captionPicText, layout, srcEnterRoomA, srcEnterRoomL, srcEnterRoomM, srcEnterRoomR, srcRicoRndL, srcRicoRndLB, srcRicoRndM, srcRicoRndR, srcRicoRndRB, srcRoomImage, tintEnterRoomA, tintEnterRoomL, tintEnterRoomM, tintEnterRoomR, tintRicoRndL, tintRicoRndLB, tintRicoRndM, tintRicoRndR, tintRicoRndRB, tintRoomImage }: GrsOfficialRoomRowPhaseOneLayoutImageContProps) => {
    return (
        <Region
            name="image_cont"
        ...
        >
            ...
            >
                <ThemeText
                    ...
                    name="picText"
                    verticalAlign="top"
                    layout={{ position: 'absolute', left: 8, width: 250, top: 5, height: 14 }}
                />
            </Border>
            <ThemeImage
                name="rico_rnd_l"
