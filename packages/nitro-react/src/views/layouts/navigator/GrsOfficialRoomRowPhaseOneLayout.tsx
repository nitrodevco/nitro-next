...
export const GrsOfficialRoomRowPhaseOneLayout = ({ captionArrowLabel, captionEntryCaption, captionEntryDesc, captionFolderNameText, captionPicText, layout, onCont, srcArrowDownWhite, srcArrowRightWhite, srcEnterRoomA, srcEnterRoomL, srcEnterRoomM, srcEnterRoomR, srcFolderImage, srcRicoRndL, srcRicoRndL2, srcRicoRndLB, srcRicoRndLB2, srcRicoRndM, srcRicoRndM2, srcRicoRndR, srcRicoRndR2, srcRicoRndRB, srcRicoRndRB2, srcRoomImage }: GrsOfficialRoomRowPhaseOneLayoutProps) => {
    return (
