...
export const RocCreateRoomLayout = ({ captionChooseLayoutCaption, captionCreateCategoryCaption, captionCreateDescCaption, captionCreateRoomCaption, captionCreateTradeCaption, captionCreateVisitorsCaption, layout, onBackButton, onCategoriesList, onClose, onCreateButton, onTradeSettingsList, onVisitorsList }: RocCreateRoomLayoutProps) => {
