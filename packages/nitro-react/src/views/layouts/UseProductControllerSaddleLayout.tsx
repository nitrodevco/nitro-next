...
export const UseProductControllerSaddleLayout = ({ layout, onSaveButton }: UseProductControllerSaddleLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text="${useproduct.widget.text.saddle "
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.info.saddle')}
