...
export const ComposeMessageViewLayout = ({ layout, onCancelBtn, onClose, onPostBtn }: ComposeMessageViewLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('groupforum.compose.subject')}
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('groupforum.compose.message')}
                    ...
                    >
                        <ThemeText
                            text={t('groupforum.compose.formatting_help')}
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('groupforum.compose.cancel')}
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('groupforum.compose.post')}
                            textStyle="text-style-u-bold"
                            textOptions={{ fill: '#ffffff' }}
                        />
                    </Region>
                ...
                >
                    <ThemeText
                        text="Thread subject should not be empty!"
