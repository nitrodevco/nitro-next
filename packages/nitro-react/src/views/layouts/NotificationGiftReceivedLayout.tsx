...
export const NotificationGiftReceivedLayout = ({ layout, onClose, onReceivedOkBtn }: NotificationGiftReceivedLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.received.title')}
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.received.desc')}
