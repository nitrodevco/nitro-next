...
export const PetCommandsLayout = ({ layout, onClose, onPetCommandTemplate }: PetCommandsLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText text={t('widgets.pet.commands.title')} />
                </Region>
                <Region
                ...
                >
                    ...
                    >
                        <ThemeText text={t('infostand.pet.text.skill.next')} />
                    </Region>
                </Region>
            </Region>
        </Frame>
