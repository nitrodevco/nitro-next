...
export const GrsPromotedRoomCategoryLayout = ({ layout, onEnterRoomButton }: GrsPromotedRoomCategoryLayoutProps) => {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText text={t('navigator.promotedrooms.owner')} />
                        </Region>
                        <Region
                        ...
                        >
                            <ThemeText text="WillyWallyWolly" />
                        </Region>
                    </Region>
                    <Region
                        name="room_name_txt"
                ...
                >
                    ...
                    >
                        <ThemeText text={t('navigator.promotedrooms.viewtopten')} />
                    </Region>
                    <Region
                        name="close_txt"
                        params={16}
                    ...
                    >
                        <ThemeText text={t('navigator.promotedrooms.hidetopten')} />
                    </Region>
                    <Icon
                        variant="5"
