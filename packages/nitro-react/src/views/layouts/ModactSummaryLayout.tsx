...
export const ModactSummaryLayout = ({ layout, onCfhTopics, onClose, onCustomSanctionButton, onDefaultSanctionButton, onSanctionType }: ModactSummaryLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text="Optional message to user, overrides default text:"
