...
export const NotificationGiftLockedLayout = ({ layout, onClose, onPostBtn, onSkipBtn }: NotificationGiftLockedLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.locked.title')}
                    ...
                    >
                        <ThemeText
                            text={t('widget.furni.teaser.gift.locked.desc')}
                    ...
                    <ContainerButton
                        ...
                        layout={{ position: 'absolute', left: 104, width: 306, top: 173, height: 46, minWidth: 306, maxWidth: 306, minHeight: 46, maxHeight: 46 }}
                    >
                        ...
                        >
                            <ThemeText
                                text={t('widget.furni.teaser.gift.locked.share')}
                                textStyle="text-style-bold"
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('widget.furni.teaser.gift.locked.skip')}
