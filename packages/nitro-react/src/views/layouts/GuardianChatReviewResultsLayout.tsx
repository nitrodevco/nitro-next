...
export const GuardianChatReviewResultsLayout = ({ layout, onClose, onCloseButton }: GuardianChatReviewResultsLayoutProps) => {
                    ...
                    >
                        ...
                        >
                            <Region
                                name="vote_text"
                                params={3088}
                                layout={{ position: 'absolute', left: 20, width: 110, top: 16, height: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
                                    text="The user behaved well"
                                    textStyle="text-style-il-heading-3"
