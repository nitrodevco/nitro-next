...
import { Border, BoxLayout, Button, Frame, Region, ThemeImage } from '#base/theme';
...
export const ClubGiftConfirmationLayout = ({ layout, onCancelButton, onClose, onSelectButton }: ClubGiftConfirmationLayoutProps) => {
