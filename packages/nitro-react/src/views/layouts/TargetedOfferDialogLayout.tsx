...
export const TargetedOfferDialogLayout = ({ layout, onBtnBuy, onBtnGetCredits, onClose }: TargetedOfferDialogLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="UFO - Ultimate first time offer"
                    ...
                    >
                        <ThemeText
                            text="This is just this insane offer which is going to span over several several lines. Yee.Lorem ipsumdolor sit amet etc. "
                ...
                <ThemeImage
                    name="pricebg"
                    params={16}
                    src={layoutImage('catalogue_ufo_pricebg.png')}
