...
export const ChestOverlayGriditemLayout = ({ layout }: ChestOverlayGriditemLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 36, height: 36, ...layout }}>
            ...
            >
                <ThemeImage
                    ...
                    params={16}
                    src={layoutImage('chest_overlay_brown_plaque.png')}
                    layout={{ position: 'absolute', left: 0, width: 36, top: 0, height: 36 }}
                />
                <ThemeImage
                ...
                <ThemeImage
                    ...
                    params={16}
                    src={layoutImage('chest_overlay_shine.png')}
                    layout={{ position: 'absolute', left: 0, width: 36, top: 0, height: 36 }}
                />
            </Region>
        </Region>
