    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                <Region
                    params={16}
                    layout={{ position: 'absolute', left: 0, width: 303, top: 0, height: 190 }}
                >
                    <Region
                        params={16}
                        layout={{ position: 'absolute', left: 6, width: 290, top: 21, height: 69, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    <Region
                        params={16}
                        layout={{ position: 'absolute', left: 8, width: 289, top: 96, height: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}
                    >
                        <ThemeText
                    ...
                    >
                        ...
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 12, width: 118, alignSelf: 'center', marginTop: -1, marginBottom: 1, height: 28, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'center' }}
                        >
                            <ThemeText
                    ...
                    >
                        ...
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 12, width: 108, alignSelf: 'center', height: 28, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'center' }}
                        >
                            <ThemeText
