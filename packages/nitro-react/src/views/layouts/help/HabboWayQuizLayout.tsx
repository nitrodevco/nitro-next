...
export interface HabboWayQuizLayoutProps {
    ...
    exitButtonContainer?: HabboWayQuizLayoutExitButtonContainerProps;
    failureButtons?: HabboWayQuizLayoutFailureButtonsProps;
    failurePane?: HabboWayQuizLayoutFailurePaneProps;
    layout?: BoxLayout;
    onClose?: () => void;
    prevNextButtons?: HabboWayQuizLayoutPrevNextButtonsProps;
    questionPane?: HabboWayQuizLayoutQuestionPaneProps;
    srcIndicatorImage?: string;
    successPane?: HabboWayQuizLayoutSuccessPaneProps;
}

export const HabboWayQuizLayout = ({ analysisPane, captionTopIndicator, exitButtonContainer, failureButtons, failurePane, layout, onClose, prevNextButtons, questionPane, srcIndicatorImage, successPane }: HabboWayQuizLayoutProps) => {
...
/** Named region `contents` of HabboWayQuizLayout - configured through the parent's `contents` prop. */
...
/** Named region `question_pane` of HabboWayQuizLayout - configured through the parent's `questionPane` prop. */
export interface HabboWayQuizLayoutQuestionPaneProps {
...
/** Named region `failure_pane` of HabboWayQuizLayout - configured through the parent's `failurePane` prop. */
export interface HabboWayQuizLayoutFailurePaneProps {
...
/** Named region `success_pane` of HabboWayQuizLayout - configured through the parent's `successPane` prop. */
export interface HabboWayQuizLayoutSuccessPaneProps {
...
/** Named region `answer_container` of HabboWayQuizLayout - configured through the parent's `answerContainer` prop. */
export interface HabboWayQuizLayoutAnswerContainerProps {
...
export interface HabboWayQuizLayoutAnalysisPaneProps {
    answerContainer?: HabboWayQuizLayoutAnswerContainerProps;
        ...
        >
            ...
            >
                <Region layout={{ flexShrink: 0, flexDirection: 'column', gap: 10 }}>
                    ...
                    <HabboWayQuizLayoutAnswerContainer {...answerContainer} />
                    <Border
                        variant="102"
...
export interface HabboWayQuizLayoutPrevNextButtonsProps {
    layout?: BoxLayout;
    nextDimmer?: HabboWayQuizLayoutNextDimmerProps;
    onNextButton?: () => void;
    onPrevButton?: () => void;
...
export const HabboWayQuizLayoutPrevNextButtons = ({ layout, nextDimmer, onNextButton, onPrevButton, prevDimmer }: HabboWayQuizLayoutPrevNextButtonsProps) => {
    ...
    return (
        ...
        >
            ...
            <HabboWayQuizLayoutNextDimmer {...nextDimmer} />
        </Region>
    );
};

/** Named region `failure_buttons` of HabboWayQuizLayout - configured through the parent's `failureButtons` prop. */
export interface HabboWayQuizLayoutFailureButtonsProps {
    layout?: BoxLayout;
    onExitButton?: () => void;
    onReviewButton?: () => void;
...
/** Named region `exit_button_container` of HabboWayQuizLayout - configured through the parent's `exitButtonContainer` prop. */
export interface HabboWayQuizLayoutExitButtonContainerProps {
