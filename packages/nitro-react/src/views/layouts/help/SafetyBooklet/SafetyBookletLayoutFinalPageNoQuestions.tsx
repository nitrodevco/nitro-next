...
export const SafetyBookletLayoutFinalPageNoQuestions = ({ layout, onBackButton, onOkButton, separatorWidget, separatorWidget2, srcIllustration, visibleFinalPageNoQuestions }: SafetyBookletLayoutFinalPageNoQuestionsProps) => {
