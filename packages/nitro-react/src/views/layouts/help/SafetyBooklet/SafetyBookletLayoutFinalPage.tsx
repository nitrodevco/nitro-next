...
export const SafetyBookletLayoutFinalPage = ({ layout, onBackButton, onQuizButton, separatorWidget, separatorWidget2, srcIllustration, visibleFinalPage }: SafetyBookletLayoutFinalPageProps) => {
