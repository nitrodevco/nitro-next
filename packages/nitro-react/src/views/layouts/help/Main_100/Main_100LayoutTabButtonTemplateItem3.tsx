...
export const Main_100LayoutTabButtonTemplateItem3 = ({ captionButtonText, layout, onSelectedView, onTabButtonTemplate, recolorDark, visibleButtonText, visibleNotselectedShape, visibleSelectedView }: Main_100LayoutTabButtonTemplateItem3Props) => {
