...
export const GuardianChatReviewVoteLayout = ({ captionIncidentTime, chatlog, layout, onClose, onCloseLink, onVoteBad, onVoteOk, onVoteVeryBad }: GuardianChatReviewVoteLayoutProps) => {
