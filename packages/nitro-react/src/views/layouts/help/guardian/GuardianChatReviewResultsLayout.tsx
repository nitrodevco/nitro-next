        ...
        >
            ...
            >
                ...
                <ThemeText
                    ...
                    name="result_text"
                    layout={{ position: 'absolute', left: 51, width: 113, top: 19, height: 15 }}
                />
            </Border>
            <ThemeText
                ...
                layout={{ position: 'absolute', left: 5, width: 216, top: 77, height: 15 }}
            />
            <Border
                variant="102"
                ...
                >
                    <Region layout={{ width: 232, height: 46, flexShrink: 0 }}>
                        <ThemeText
                            ...
                            textStyle="text-style-il-heading-3"
                            name="vote_text"
                            layout={{ position: 'absolute', left: 20, width: 110, alignSelf: 'center', marginTop: 0.5, marginBottom: -0.5, height: 15 }}
                        />
                        <ThemeImage
                            name="vote_image"
