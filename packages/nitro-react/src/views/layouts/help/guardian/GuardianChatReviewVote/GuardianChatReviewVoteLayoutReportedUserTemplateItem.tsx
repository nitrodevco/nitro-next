...
export const GuardianChatReviewVoteLayoutReportedUserTemplateItem = ({ captionMessage, layout, visibleMessage }: GuardianChatReviewVoteLayoutReportedUserTemplateItemProps) => {
    return (
        <Region
