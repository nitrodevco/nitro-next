    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                <Region
                    params={16}
                    layout={{ position: 'absolute', left: 10, width: 400, top: 0, height: 616, flexDirection: 'column' }}
                >
                    <WidgetSlot
                    ...
                    >
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 170, width: 157, top: 2, height: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                    ...
                    <Region
                        params={16400}
                        layout={{ width: 408, height: 140, flexShrink: 0 }}
                    >
                        <ThemeImage
                            params={16}
                        ...
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 180, width: 220, alignSelf: 'center', marginTop: -2.5, marginBottom: 2.5, height: 135, minWidth: 220, maxWidth: 220, flexDirection: 'column', gap: 5 }}
                        >
                            <Region
                                params={16}
                                layout={{ width: 220, height: 27, flexShrink: 0, maxWidth: 220, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
                            ...
                            <Region
                                params={16}
                                layout={{ width: 220, height: 16, flexShrink: 0, minWidth: 220, maxWidth: 220, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                            >
                                <ThemeText
                    ...
                    >
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 170, width: 127, top: 2, height: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                    ...
                    <Region
                        params={16400}
                        layout={{ width: 400, height: 155, flexShrink: 0 }}
                    >
                        <ThemeImage
                            params={16}
                        ...
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 180, width: 220, alignSelf: 'center', marginTop: -10, marginBottom: 10, height: 135, minWidth: 220, maxWidth: 220, flexDirection: 'column', gap: 5 }}
                        >
                            <Region
                                params={16}
                                layout={{ width: 220, height: 27, flexShrink: 0, maxWidth: 220, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    ...
                    >
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 0, width: 144, top: 2, height: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                    ...
                    >
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 10, width: 180, alignSelf: 'center', marginTop: 5, marginBottom: -5, height: 60, minWidth: 180, maxWidth: 180, flexDirection: 'column', gap: 5 }}
                        >
                            <Region
                                name="self_help_link"
                                params={1}
                        ...
                        <Region
                            params={3145744}
                            layout={{ position: 'absolute', left: 210, width: 180, alignSelf: 'center', marginTop: 2, marginBottom: -2, height: 42, minWidth: 180, maxWidth: 180, flexDirection: 'column', gap: 5 }}
                        >
                            <Region
                                name="habboway_link"
                                params={1}
                    ...
                    >
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 20, width: 182, top: 17, height: 19, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                        ...
                        <Region
                            params={1}
                            layout={{ position: 'absolute', left: 20, width: 162, top: 36, height: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
                        ...
                        <Region
                            params={16}
                            layout={{ position: 'absolute', left: 235, width: 149, top: 44, height: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                        >
                            <ThemeText
