...
export const SpecialItemsDisplayLayout = ({ layout, onClaimBtn, onClose }: SpecialItemsDisplayLayoutProps) => {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ThemeText
                                        text={t('special_items.wf15.header.title')}
                                ...
                                >
                                    <ThemeText
                                        text={t('special_items.wf15.header.desc')}
                                        textOptions={{ wordWrap: true, wordWrapWidth: 365, align: 'center' }}
                                    />
                                </Region>
                            </Region>
                ...
                >
                    ...
                    >
                        <ThemeImage
                            name="platform_img"
                            params={16}
                            src={layoutImage('special_items_item_platform.png')}
                            layout={{ position: 'absolute', left: 8, width: 323, top: 41, height: 155 }}
                        />
                        <ThemeImage
                            name="spotlight_base_img"
                            params={16}
                            src={layoutImage('special_items_spotlight2.png')}
                        ...
                        <ThemeImage
                            ...
                            tags={[ 'BLEND_ADD' ]}
                            params={16}
                            src={layoutImage('special_items_spotlight1.png')}
                    ...
                    >
                        ...
                        >
                            <Region
                                name="page_template"
                                params={17}
                                layout={{ width: 10, height: 11, flexShrink: 0 }}
                            >
                                <ThemeImage
                                    name="page_image"
                                    params={16}
                                    src={layoutImage('progress_disk_etched_on.png')}
                            ...
                            >
                                <ThemeImage
                                    name="page_image"
                                    params={16}
                                    src={layoutImage('progress_disk_etched_off.png')}
                                    layout={{ position: 'absolute', left: 0, width: 10, top: 0, height: 11 }}
                                />
                            </Region>
                            <Region
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ThemeText text={t('special_items.claim_info')} />
                            </Region>
                            <Button
                                variant="4"
                                name="claim_btn"
                        ...
                        >
                            ...
                            >
                                <Region
                                    name="item_title"
                                    params={16}
                                    layout={{ width: 300, height: 17, flexShrink: 0, maxWidth: 300, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                >
                                    <ThemeText
                                        text={t('special_items.wf15.body.wf15_act.title')}
                                ...
                                <Region
                                    name="item_desc"
                                    params={16}
                                    layout={{ width: 300, height: 57, flexShrink: 0, maxWidth: 300, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                                >
                                    <ThemeText
                                        text={t('special_items.wf15.body.wf15_act.desc')}
                                        textOptions={{ fill: '#ffffff', wordWrap: true, wordWrapWidth: 300 }}
                                    />
                                </Region>
                            </Region>
