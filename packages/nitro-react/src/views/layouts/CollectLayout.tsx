...
export const CollectLayout = ({ layout, onClose, onNeverLink, onOkButton, onSkipLink }: CollectLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                <Region layout={{ position: 'absolute', left: 0, width: 471, top: 0, height: 400 }}>
                    ...
                    >
                        <ThemeImage
                            ...
                            tags={[ 'ICON' ]}
                            params={16}
                            src="${image.library.url}returnusergifting/phone_frank.png"
                        ...
                        >
                            <ThemeText
                                text={t('phone.number.collect.summary')}
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={t('phone.number.collect.skip')}
                        ...
                        >
                            <ThemeText
                                text={t('phone.number.collect.never.again')}
                                textStyle="text-style-u-bold"
                                textOptions={{ align: 'center' }}
                            />
                        </Region>
