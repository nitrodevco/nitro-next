...
export const GuideClosedLayout = ({ layout, onClose, onCloseButton, onReportLink }: GuideClosedLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text="Lilyflower closed the case."
                    ...
                    <Region
                        ...
                        cursor="pointer"
                    >
                        <ThemeText text="Report Lilyflower" />
                    </Region>
                </Region>
            </Region>
        </Frame>
