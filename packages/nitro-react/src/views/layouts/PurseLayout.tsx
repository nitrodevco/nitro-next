...
export const PurseLayout = ({ layout, onHelpButton, onLogoutButton, onSettingsButton }: PurseLayoutProps) => {
            ...
            <Region layout={{ position: 'absolute', left: -38, width: 230, top: 0, height: 77 }}>
                ...
                >
                    <Region
                        ...
                        layout={{ width: 52, height: 19, flexShrink: 0 }}
                    >
                        <Region
                            name="diamond_count"
                            tags={[ '#icon' ]}
                    ...
                    <Region
                        ...
                        params={1}
                        dynamicStyle="brightness_and_shadow_under"
                        layout={{ width: 52, height: 17, flexShrink: 0 }}
                    >
                        <Region
                            name="ducket_count"
                            tags={[ '#icon' ]}
                ...
                >
                    ...
                    >
                        <ThemeImage
                            ...
                            tags={[ '#icon' ]}
                            params={16}
                            src={layoutImage('pursearea_unseen_indicator.png')}
                            layout={{ position: 'absolute', left: 1, width: 10, top: 0, height: 11 }}
                        />
                    </Region>
                </Region>
