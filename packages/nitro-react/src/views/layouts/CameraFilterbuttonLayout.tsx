...
export const CameraFilterbuttonLayout = ({ layout }: CameraFilterbuttonLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 62, height: 62, ...layout }}>
            ...
            >
                <ThemeImage
                    name="outline"
                    params={16}
                    src={layoutImage('camera_fx_button_outline.png')}
                    layout={{ position: 'absolute', left: 0, width: 62, top: 0, height: 62 }}
                />
                <ThemeImage
                    name="content"
                ...
                >
                    <ThemeImage
                        name="lock_indicator"
                        params={16}
                        src={layoutImage('camera_locked.png')}
                        layout={{ position: 'absolute', left: 2, width: 59, top: 0, height: 60 }}
                    />
                </Region>
                <Region
                ...
                >
                    <ThemeImage
                        ...
                        params={16}
                        src={layoutImage('camera_fx_button_active.png')}
                        layout={{ position: 'absolute', left: 0, width: 62, top: 0, height: 62 }}
                    />
                </Region>
                <Region
                ...
                >
                    <ThemeImage
                        ...
                        params={16}
                        src={layoutImage('camera_fx_button_selected.png')}
                        layout={{ position: 'absolute', left: 0, width: 62, top: 0, height: 62 }}
                    />
                </Region>
                <Region
