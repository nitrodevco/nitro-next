...
export const CalendarLayout = ({ layout, onBtnForceOpen, onClose }: CalendarLayoutProps) => {
    return (
        <Frame
            variant="3"
            params={1}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <ThemeImage
                                            ...
                                            params={4079635}
                                            src={layoutImage('campaign_calendar_opened.png')}
                                            layout={{ position: 'absolute', left: 0, width: 192, top: 0, height: 192 }}
                                        />
                                    </Region>
                                    <ThemeImage
                                ...
                                <ThemeImage
                                    name="bitmap_lock"
                                    params={4079635}
                                    src={layoutImage('campaign_calendar_generic_lock.png')}
