...
export const UnseenItemCounterLayout = ({ layout }: UnseenItemCounterLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 29, height: 18, ...layout }}>
            <Border
                ...
                params={262160}
                tintColor="#ee2924"
                layout={{ position: 'absolute', left: 3, width: 29, top: 0, height: 18 }}
            >
                <Region
                    name="count"
                    params={4194320}
                    layout={{ position: 'absolute', left: 4, width: 21, top: 0, height: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                >
                    <ThemeText
                        text="999"
