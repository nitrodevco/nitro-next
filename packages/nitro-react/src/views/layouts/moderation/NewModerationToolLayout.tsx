...
export interface NewModerationToolLayoutProps {
    layout?: BoxLayout;
    mainView?: NewModerationToolLayoutMainViewProps;
    onClose?: () => void;
    subviewWrapper?: NewModerationToolLayoutSubviewWrapperProps;
}

export const NewModerationToolLayout = ({ layout, mainView, onClose, subviewWrapper }: NewModerationToolLayoutProps) => {
...
/** Named region `main_view` of NewModerationToolLayout - configured through the parent's `mainView` prop. */
export interface NewModerationToolLayoutMainViewProps {
    layout?: BoxLayout;
    onBanUserBtn?: () => void;
    onGiveCoinsBtn?: () => void;
    onGiveFurniBtn?: () => void;
...
/** Named region `hotel_alert_view` of NewModerationToolLayout - configured through the parent's `hotelAlertView` prop. */
export interface NewModerationToolLayoutHotelAlertViewProps {
...
/** Named region `ban_type` of NewModerationToolLayout - configured through the parent's `banType` prop. */
export interface NewModerationToolLayoutBanTypeProps {
    layout?: BoxLayout;
    onBanRadio?: () => void;
    onUnbanRadio?: () => void;
}
...
export interface NewModerationToolLayoutBanViewProps {
    banType?: NewModerationToolLayoutBanTypeProps;
    captionUserTxt?: string;
    layout?: BoxLayout;
    onBanBtn?: () => void;
...
export const NewModerationToolLayoutBanView = ({ banType, captionUserTxt, layout, onBanBtn, onDurationSelector, visibleBanView }: NewModerationToolLayoutBanViewProps) => {
    ...
    return (
        ...
        >
            ...
            <NewModerationToolLayoutBanType {...banType} />
            <Button
                variant="103"
                name="ban_btn"
...
export interface NewModerationToolLayoutSubviewWrapperProps {
    ...
    hotelAlertView?: NewModerationToolLayoutHotelAlertViewProps;
    layout?: BoxLayout;
    onReturnBtn?: () => void;
...
export const NewModerationToolLayoutSubviewWrapper = ({ banView, giveCoinsView, giveFurniView, hotelAlertView, layout, onReturnBtn, sendWarningView }: NewModerationToolLayoutSubviewWrapperProps) => {
    return (
        ...
        >
            ...
            <NewModerationToolLayoutHotelAlertView {...hotelAlertView} />
