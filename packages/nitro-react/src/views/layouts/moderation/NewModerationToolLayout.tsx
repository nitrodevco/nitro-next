...
export const NewModerationToolLayout = ({ captionAmountTxt, captionAmountTxt2, captionHotelAlertTxt, captionProductNameTxt, captionTextTxt, captionUserTxt, captionUserTxt2, captionUserTxt3, captionUserTxt4, layout, onAddCoinsBtn, onAddFurniBtn, onBanBtn, onBanRadio, onBanUserBtn, onClose, onDurationSelector, onGiveCoinsBtn, onGiveFurniBtn, onHotelAlertBtn, onMinusBtnCoins, onMinusBtnFurni, onPlusBtnCoins, onPlusBtnFurni, onReturnBtn, onSendHotelAlertBtn, onSendWarningBtn, onSendWarningBtn2, onUnbanRadio, visibleBanView, visibleGiveCoinsView, visibleHotelAlertView, visibleMainView, visibleSendWarningView }: NewModerationToolLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={captionUserTxt2 ?? t('moderation.give_coins.user')}
                                textOptions={{ fill: '#333333' }}
                            />
                        </Region>
                        <Border
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={captionUserTxt3 ?? t('moderation.give_furni.user')}
                                textOptions={{ fill: '#333333' }}
                            />
                        </Region>
                        <Border
                        ...
                        >
                            <ThemeText
                                text={captionAmountTxt2 ?? t('moderation.give_furni.amount')}
                                textOptions={{ fill: '#333333' }}
                            />
                        </Region>
                        <Border
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text={captionUserTxt4 ?? t('moderation.ban_management.user')}
                                textOptions={{ fill: '#333333' }}
                            />
                        </Region>
                        <Border
