...
export const GroupCreatedWindowLayout = ({ layout, onClose, onOkButton }: GroupCreatedWindowLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                <ThemeImage
                    ...
                    params={1040}
                    src="${image.library.url}guilds/group_welcome_info.png"
                ...
                <Region
                    params={1}
                    layout={{ position: 'absolute', left: 22, width: 311, top: 10, height: 150, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                >
                    <ThemeText
