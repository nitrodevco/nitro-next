...
export const GroupRoomInfoLayout = ({ captionGroupNameTxt, captionHeaderTxt, layout, onInfoRegion, onJoinButton, onManageButton, onRequestMembershipButton, onTitleRegion, srcBgContracted, srcBgExpanded, srcGroupBaseIcon, srcGroupIcon }: GroupRoomInfoLayoutProps) => {
