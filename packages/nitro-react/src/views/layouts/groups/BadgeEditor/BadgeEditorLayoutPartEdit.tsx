        ...
        >
            ...
            >
                <ThemeText
                    ...
                    name="label_symbol"
                    layout={{ position: 'absolute', left: 0, width: 43, top: 8, height: 17 }}
                />
                <ThemeText
                    text={captionLabelPosition ?? t('group.edit.badge.position')}
                    textStyle="text-style-u-bold"
                    name="label_position"
                    layout={{ position: 'absolute', left: 64, width: 49, top: 8, height: 17 }}
                />
                <ThemeText
                    text={captionLabelColors ?? t('group.edit.badge.colors')}
                    textStyle="text-style-u-bold"
                    name="label_colors"
                    layout={{ position: 'absolute', left: 155, width: 40, top: 8, height: 17 }}
                />
            </Region>
            <Region
                name="part_edit_list"
