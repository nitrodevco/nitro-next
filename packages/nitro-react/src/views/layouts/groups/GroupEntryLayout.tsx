...
export const GroupEntryLayout = ({ layout, onBgRegion, onClearFavourite, onMakeFavourite, srcBgSelectedBitmap, srcBgUnselectedBitmap, srcIcon, srcIcon2 }: GroupEntryLayoutProps) => {
