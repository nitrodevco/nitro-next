...
export const GuildMembersWindowLayout = ({ captionFooterInfoTxt, captionPaginaTextEnd, captionPaginaTextStart, layout, onClose, onNextPageButton, onPreviousPageButton, onTypeDropMenu }: GuildMembersWindowLayoutProps) => {
