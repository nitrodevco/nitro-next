...
export const RejectedWindowLayout = ({ layout, onClose, onCloseButton }: RejectedWindowLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('guide.help.request.rejected.heading')}
                    ...
                    >
                        <ThemeText
                            text={t('guide.help.request.rejected.message')}
                            textOptions={{ wordWrap: true, wordWrapWidth: 221 }}
                        />
                    </Region>
                    <Button
