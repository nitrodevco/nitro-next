...
export const BundlesInfoItemLayout = ({ layout }: BundlesInfoItemLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 182, height: 142, ...layout }}>
            ...
            >
                <ThemeImage
                    ...
                    params={16}
                    src={layoutImage('catalogue_clakboard.png')}
                    layout={{ position: 'absolute', left: 0, width: 182, top: 0, height: 142 }}
                />
                <Region
                    name="header_text"
                ...
                >
                    <ThemeText
                        text={t('catalog.bundlewidget.info.header')}
                ...
                <ThemeImage
                    name="formula_bitmap"
                    params={16}
                    src="${image.library.catalogue.url}clakboard_formula.png"
                ...
                >
                    <ThemeText
                        text={t('catalog.bundlewidget.info.for.free')}
                ...
                >
                    <ThemeText
                        text={t('catalog.bundlewidget.info.equals.bundle')}
                ...
                >
                    <ThemeText
                        text={t('catalog.bundlewidget.info.footer')}
                        textOptions={{ fill: '#ffffff', wordWrap: true, wordWrapWidth: 174, align: 'center' }}
                    />
                </Region>
                <Region
