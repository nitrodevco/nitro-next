...
export const NewBarLayout = ({ layout }: NewBarLayoutProps) => {
                ...
                >
                    ...
                    >
                        ...
                        <ThemeImage
                            name="icon_1"
                            params={16}
                            src={layoutImage('friend_bar_friendlist_messenger_notify_0.png')}
                            layout={{ position: 'absolute', left: 0, width: 26, top: 0, height: 32 }}
                        />
                        <ThemeImage
                            name="icon_2"
                            params={16}
                            src={layoutImage('friend_bar_friendlist_messenger_notify_1.png')}
                            layout={{ position: 'absolute', left: 0, width: 26, top: 0, height: 32 }}
                        />
                    </Region>
                </Region>
