...
export const LandingViewJetsetLayout = ({ layout }: LandingViewJetsetLayoutProps) => {
    return (
            ...
            >
                ...
                >
                    <ThemeImage
                        ...
                        params={2192}
                        src="${image.library.url}reception/js_background_top_pixel.png"
                    ...
                    <ThemeImage
                        ...
                        params={1168}
                        src="${image.library.url}reception/js_reception_backdrop_BG_left.png"
                        layout={{ position: 'absolute', left: 0, width: 306, top: 314, height: 470 }}
                    />
                    <ThemeImage
                        name="background_horizon"
                        params={263248}
                        src="${image.library.url}reception/js_reception_BG_right_3.png"
                        layout={{ position: 'absolute', left: 305, width: 867, top: 314, height: 470 }}
                    />
                    <ThemeImage
                        name="background_right"
                        params={1104}
                        src="${image.library.url}reception/js_reception_backdrop_left.png"
                    ...
                    <ThemeImage
                        ...
                        params={2064}
                        src="${image.library.url}reception/js_reception_backdrop_hotel_top_stretch.png"
                        layout={{ position: 'absolute', left: 0, width: 138, top: 0, height: -44 }}
                    />
                    <ThemeImage
                        name="background_hotel_left"
                        params={1040}
                        src="${image.library.url}reception/js_reception_backdrop_right_2.png"
