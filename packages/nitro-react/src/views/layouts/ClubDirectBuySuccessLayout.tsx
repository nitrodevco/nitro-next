...
export const ClubDirectBuySuccessLayout = ({ layout, onButtonOk, onClose }: ClubDirectBuySuccessLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeImage
                        name="teaser_image"
                        params={16}
                        src="${image.library.url}directVipBuy/success_teaser_image_HC.png"
