...
export const AreaHideUiLayout = ({ layout, onApplyButton, onClearButton, onClose, onInvertCheckbox, onInvisiblityCheckbox, onOnOffButton, onSelectButton, onWallitemsCheckbox }: AreaHideUiLayoutProps) => {
                ...
                >
                    ...
                    >
                        <Region
                            ...
                            params={16}
                            visible={false}
                            layout={{ width: 270, height: 0, flexShrink: 0 }}
                        >
                            <Region
                                name="hidearea_info"
                                params={16}
                        ...
                        <Region
                            name="area_container"
                            params={16}
                            layout={{ width: 260, height: 98, flexShrink: 0 }}
                        >
                            <Region
                            ...
                            >
                                <Button
                                    ...
                                    layout={{ width: 211, height: 24, flexShrink: 0 }}
                                >
                                ...
                                <Button
                                    ...
                                    layout={{ width: 205, height: 24, flexShrink: 0 }}
                                >
                        ...
                        <Region
                            ...
                            params={16}
                            layout={{ width: 262, height: 143, flexShrink: 0 }}
                        >
                            <Region
                                name="options_title"
                                params={16}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <ThemeText
                                            text={t('widget.areahide.options.wallitems')}
                                            textStyle="text-style-u-small"
                                ...
                                >
                                    ...
                                    >
                                        <ThemeText
                                            text={t('widget.areahide.options.invert')}
                                            textStyle="text-style-u-small"
                                            textOptions={{ wordWrap: true, wordWrapWidth: 240 }}
                                        />
                                    </Region>
                                ...
                                >
                                    ...
                                    >
                                        <ThemeText
                                            text={t('widget.areahide.options.invisibility')}
                                            textStyle="text-style-u-small"
                                            textOptions={{ wordWrap: true, wordWrapWidth: 240 }}
                                        />
                                    </Region>
                                    ...
                                    >
                                        <ThemeText
                                            text={t('widget.areahide.options.invisibility.info')}
                                            textStyle="text-style-u-small"
                                            textOptions={{ fill: '#999999', wordWrap: true, wordWrapWidth: 242 }}
                                        />
                                    </Region>
