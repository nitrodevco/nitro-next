...
export const DiscountValueItemLayout = ({ layout }: DiscountValueItemLayoutProps) => {
        ...
        <Region layout={{ position: 'relative', width: 180, height: 37, ...layout }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <ThemeText text={t('catalog.bundlewidget.discount.total')} />
                    </Region>
                    <Region
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('catalog.bundlewidget.discount.save')}
