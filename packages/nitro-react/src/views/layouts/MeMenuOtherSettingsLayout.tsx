...
export const MeMenuOtherSettingsLayout = ({ layout, onBackBtn, onBtnResetPhoneNumberCollection, onDisableRoomCameraFollowCheckbox, onDisableWiredWhisperCheckbox, onIgnoreRoomInvitesCheckbox }: MeMenuOtherSettingsLayoutProps) => {
