...
export const EvidenceFrameLayout = ({ layout, onBtnHeaderAction, onBtnHeaderAction2, onClose }: EvidenceFrameLayoutProps) => {
    return (
        <Frame
            variant="0"
            params={98305}
                    ...
                    >
                        ...
                        >
                            ...
                            <Region
                                name="chatline"
                                params={144}
                                layout={{ width: 420, height: 41, flexShrink: 0 }}
                            >
                                <Region
                                    name="time_txt"
                                    params={16}
                                ...
                                >
                                    <ThemeText text="ROBIN_WAN_PERSI" />
                                </Region>
                                <Region
                                    name="msg_txt"
                                    params={16}
                                ...
                                >
                                    <ThemeText
                                        text="Sharing your password or personal details online is dangerous. The moderators might monitor these conversations for your safety."
