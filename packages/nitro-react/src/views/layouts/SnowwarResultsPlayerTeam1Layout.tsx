...
export const SnowwarResultsPlayerTeam1Layout = ({ layout }: SnowwarResultsPlayerTeam1LayoutProps) => {
            ...
            >
                ...
                >
                    <ThemeImage
                        ...
                        tags={[ 'bitmap' ]}
                        params={16}
                        src={layoutImage('blue_infobox.png')}
