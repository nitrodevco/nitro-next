...
export const AvatarEditorNameChangeLayout = ({ layout, onCancelSelectionButton, onCheckNameButton, onClose, onSelectNameButton }: AvatarEditorNameChangeLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('tutorial.name_change.title.main')}
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis non cursus lorem. Donec risus erat, lacinia id commodo ac, consectetur eget tellus. "
