...
export const LayoutGuildFrontpage_1682Layout = ({ layout, onStartGuildPurchase }: LayoutGuildFrontpage_1682LayoutProps) => {
            ...
            >
                ...
                >
                    <Button
                        ...
                        layout={{ position: 'absolute', left: 23, width: 213, top: 2, height: 28, minWidth: 190, minHeight: 28, maxHeight: 50 }}
                    >
