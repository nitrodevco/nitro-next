...
export const GuideOngoingLayout = ({ layout, onClose, onCloseLink, onInviteButton, onReportLink, onVisitButton }: GuideOngoingLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        <ThemeText
                            text={t('guide.help.request.guide.ongoing.close.link')}
