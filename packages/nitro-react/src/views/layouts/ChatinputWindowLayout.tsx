...
export const ChatinputWindowLayout = ({ layout, onHelpbutton, onSendButton }: ChatinputWindowLayoutProps) => {
                ...
                >
                    ...
                    >
                        <Border
                            ...
                            name="styles"
                            params={17}
                            layout={{ width: 83, height: 38, flexShrink: 0 }}
                        >
                            <ThemeImage
                                name="preview_bitmap"
                                params={16}
                        ...
                        <Border
                            ...
                            name="input_border"
                            params={16}
                            layout={{ width: 340, height: 38, flexShrink: 0 }}
                        >
                            <Region
                        ...
                        <ContainerButton
                            ...
                            layout={{ width: 47, height: 38, flexShrink: 0 }}
                        >
                            <Region
