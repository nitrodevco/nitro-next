...
export const MemenuSettingsMenu_1079Layout = ({ layout, onBack, onCharacterSettings, onSoundSettings }: MemenuSettingsMenu_1079LayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 170, height: 135, ...layout }}>
            <Region
                ...
                params={16}
                layout={{ position: 'absolute', left: 0, width: 170, top: 0, height: 135 }}
            >
                <Region
                    name="settings_title"
                    params={786640}
                    layout={{ position: 'absolute', left: 13, width: 144, top: 5, height: 13, maxWidth: 150, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                >
                    <ThemeText
                ...
                >
                    <ThemeText
                        text={t('widget.memenu.settings.no_identity')}
