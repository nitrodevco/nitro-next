...
export const VariablesManagementDetailLayout = ({ layout, onAddVarBtn, onClose, onCreateVarBtn, onDeleteVarBtn, onRefreshBtn }: VariablesManagementDetailLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ThemeText
                                text="Do not use this tool for users who are currently in the room/using the changed variable in another room."
                ...
                >
                    ...
                    >
                        <ThemeText text={t('wiredmenu.variable_management_detail.holder_info')} />
                    </Region>
                    <Border
                        variant="2"
                        name="preview"
                ...
                >
                    <Region
                        ...
                        layout={{ position: 'absolute', left: 0, width: 188, top: 0, height: 19, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                    >
                        <ThemeText text={t('wiredmenu.variable_management_detail.variables')} />
                    </Region>
                    <Region
