        ...
        >
            ...
            >
                <ThemeText
                    ...
                    name="task_title_txt"
                    layout={{ position: 'absolute', left: 20, width: 79, top: 5, height: 18 }}
                />
                <Region
                ...
                >
                    <ThemeText
                        text="?"
                        textOptions={{ fill: '#ffffff' }}
                        layout={{ position: 'absolute', left: 1, width: 12, top: 0, bottom: 0 }}
                    />
                </Region>
            </Border>
            ...
            <ThemeText
                ...
                name="task_desc_txt"
                verticalAlign="top"
                layout={{ position: 'absolute', left: 76, width: 198, top: 36, height: 55, minWidth: 198, maxWidth: 198, minHeight: 55, maxHeight: 55 }}
            />
            <Region
            ...
            >
                ...
                <ThemeText
                    ...
                    layout={{ position: 'absolute', right: 23, width: 143, top: 6, height: 17 }}
                />
            </Region>
        </Region>
    );
