...
export const AchievementSimpleLayout = ({ achievementPicBitmap, bgRegion, layout, onBgRegion, srcBgSelectedBitmap, srcBgUnselectedBitmap, visibleBgSelectedBitmap }: AchievementSimpleLayoutProps) => {
    return (
