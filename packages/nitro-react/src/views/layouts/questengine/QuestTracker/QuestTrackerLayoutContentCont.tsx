    ...
    return (
        ...
        >
            <ThemeText
                ...
                layout={{ position: 'absolute', marginLeft: -4, marginRight: 4, width: 134, top: 2, height: 18 }}
            />
            <ThemeText
                ...
                name="desc_txt"
                verticalAlign="top"
                layout={{ position: 'absolute', left: 71, right: 6, top: 27, height: 61 }}
            />
            <ThemeText
                text={captionMoreInfoTxt ?? t('quests.tracker.moreinfo')}
                textOptions={{ fill: '#23c5ff' }}
                name="more_info_txt"
                layout={{ position: 'absolute', marginLeft: 0.5, marginRight: -0.5, width: 139, top: 109, height: 17 }}
            />
            <Region
