...
export const NextQuestTimerLayoutNextQuestTimer = ({ captionDescTxt, captionMoreInfoTxt, captionQuestHeaderTxt, layout, onMoreInfoRegion, onNextQuestTimer, srcQuestPicBitmap, srcQuestTimerContracted, srcQuestTimerExpanded }: NextQuestTimerLayoutNextQuestTimerProps) => {
