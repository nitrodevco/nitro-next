...
export const RentConfirmationLayout = ({ layout, onCancelButton, onClose, onOkButton }: RentConfirmationLayoutProps) => {
            ...
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <Region
                        ...
                        params={16}
                        layout={{ width: 150, height: 30, flexShrink: 0, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start' }}
                    >
                        <ThemeText
                    ...
                    >
                        <ThemeText
                            text="The name of the furni in question"
