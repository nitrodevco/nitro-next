...
export const NestBreedingSuccessDialogLayout = ({ layout, onButtonOk, onClose }: NestBreedingSuccessDialogLayoutProps) => {
    ...
    return (
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text={t('breedpets.nestbreeding.success.name')}
                ...
                >
                    <ThemeText
                        text={t('breedpets.nestbreeding.success.raritycategory.0')}
                        textOptions={{ align: 'center' }}
                    />
                </Region>
                <Button
