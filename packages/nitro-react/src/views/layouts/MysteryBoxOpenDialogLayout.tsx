...
export const MysteryBoxOpenDialogLayout = ({ layout, onCancelButton, onClose }: MysteryBoxOpenDialogLayoutProps) => {
    return (
        <Frame
            variant="100"
            id="title_text"
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                >
                    <ThemeText
                        text="You have started opening the box."
                ...
                >
                    ...
                    >
                        <ThemeText text="Waiting for the other user to insert the key." />
                    </Region>
                </Border>
                <Button
                    variant="101"
