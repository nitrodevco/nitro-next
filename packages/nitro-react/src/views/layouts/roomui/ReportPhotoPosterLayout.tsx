...
export const ReportPhotoPosterLayout = ({ captionPhotoCaption, layout, on_130, on_131, on_132, on_133, on_134, on_135, on_136, onClose, onReportConfirm, srcSelfieLoader }: ReportPhotoPosterLayoutProps) => {
        ...
        >
            <Region layout={{ position: 'relative', flex: 1, width: '100%' }}>
                ...
                <Region
                    ...
                    params={147473}
                    layout={{ position: 'absolute', left: 20, width: 550, top: 445, height: 136 }}
                >
                    <RadioButton
                        variant="100"
                        name="130"
