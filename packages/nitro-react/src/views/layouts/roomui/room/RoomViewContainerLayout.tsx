...
export const RoomViewContainerLayoutBackgroundWrapper = ({ layout, visibleBackgroundWrapper }: RoomViewContainerLayoutBackgroundWrapperProps) => {
    return (
        <Region
...
export const RoomViewContainerLayoutRoomCanvasWrapper = ({ layout }: RoomViewContainerLayoutRoomCanvasWrapperProps) => {
    return (
        <Region
...
export const RoomViewContainerLayoutColorizerWrapper = ({ layout }: RoomViewContainerLayoutColorizerWrapperProps) => {
    return (
        <Region
...
export const RoomViewContainerLayoutRoomViewContainer = ({ backgroundWrapper, colorizerWrapper, layout, roomCanvasWrapper }: RoomViewContainerLayoutRoomViewContainerProps) => {
    return (
        <Region
