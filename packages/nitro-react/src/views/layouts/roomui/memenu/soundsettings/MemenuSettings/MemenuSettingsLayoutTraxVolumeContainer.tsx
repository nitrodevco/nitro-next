...
export const MemenuSettingsLayoutTraxVolumeContainer = ({ captionTitle, layout, onSliderButton, onSoundsOff, onSoundsOn, srcSliderBase, srcSliderBitmap, srcSoundsOffIcon, srcSoundsOnIcon, tintSliderBase, tintSliderBitmap, tintSoundsOffIcon, tintSoundsOnIcon }: MemenuSettingsLayoutTraxVolumeContainerProps) => {
