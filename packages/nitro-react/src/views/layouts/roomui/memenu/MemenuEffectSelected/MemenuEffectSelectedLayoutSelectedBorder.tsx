...
export const MemenuEffectSelectedLayoutSelectedBorder = ({ captionEffectAmount, captionEffectName, captionTimeLeft, layout, loaderHighlight, onSelectedBorder, srcEffectHilite, srcEffectIcon, srcEffectIconBg, tintEffectHilite, tintEffectIcon, tintEffectIconBg }: MemenuEffectSelectedLayoutSelectedBorderProps) => {
