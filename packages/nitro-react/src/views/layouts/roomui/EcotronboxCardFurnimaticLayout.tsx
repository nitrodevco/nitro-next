...
export interface EcotronboxCardFurnimaticLayoutProps {
    ecotronboxContainer?: EcotronboxCardFurnimaticLayoutEcotronboxContainerProps;
    layout?: BoxLayout;
}

export const EcotronboxCardFurnimaticLayout = ({ ecotronboxContainer, layout }: EcotronboxCardFurnimaticLayoutProps) => {
    return (
        <Region layout={{ position: 'relative', width: 257, height: 114, ...layout }}>
            <EcotronboxCardFurnimaticLayoutEcotronboxContainer {...ecotronboxContainer} />
        </Region>
    );
};

/** Named region `ecotronbox_container` of EcotronboxCardFurnimaticLayout - configured through the parent's `ecotronboxContainer` prop. */
export interface EcotronboxCardFurnimaticLayoutEcotronboxContainerProps {
