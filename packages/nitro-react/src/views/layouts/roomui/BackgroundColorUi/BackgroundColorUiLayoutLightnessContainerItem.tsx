...
export const BackgroundColorUiLayoutLightnessContainerItem = ({ captionParameter, layout, srcSliderBase, srcSliderButton, tintSliderBase, tintSliderButton, visibleParameter, visibleSliderBase, visibleSliderButton, visibleSliderMovementArea }: BackgroundColorUiLayoutLightnessContainerItemProps) => {
        ...
        >
            {(visibleParameter ?? true) && (
                <ThemeText
                    ...
                    name="parameter"
                    layout={{ position: 'absolute', left: 0, width: 170, top: 0, height: 15 }}
                />
            )}
