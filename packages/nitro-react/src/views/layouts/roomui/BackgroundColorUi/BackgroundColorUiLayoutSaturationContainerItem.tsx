...
export const BackgroundColorUiLayoutSaturationContainerItem = ({ captionParameter, layout, srcSliderBase, srcSliderButton, tintSliderBase, tintSliderButton, visibleParameter, visibleSliderBase, visibleSliderButton, visibleSliderMovementArea }: BackgroundColorUiLayoutSaturationContainerItemProps) => {
        ...
        >
            {(visibleParameter ?? true) && (
                <ThemeText
                    ...
                    name="parameter"
                    layout={{ position: 'absolute', left: 0, width: 178, top: 0, height: 15 }}
                />
            )}
