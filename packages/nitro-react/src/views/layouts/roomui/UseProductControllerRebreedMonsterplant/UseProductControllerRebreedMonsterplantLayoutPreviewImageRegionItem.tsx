...
export const UseProductControllerRebreedMonsterplantLayoutPreviewImageRegionItem = ({ layout, onPreviewImageRegion, srcPreviewImage, tintPreviewImage, visiblePreviewImage }: UseProductControllerRebreedMonsterplantLayoutPreviewImageRegionItemProps) => {
    return (
        <Region
