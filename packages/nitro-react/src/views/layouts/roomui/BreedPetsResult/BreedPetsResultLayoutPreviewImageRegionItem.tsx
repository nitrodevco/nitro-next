...
export const BreedPetsResultLayoutPreviewImageRegionItem = ({ layout, onPreviewImageRegion, srcPreviewImage, tintPreviewImage, visiblePreviewImage }: BreedPetsResultLayoutPreviewImageRegionItemProps) => {
    return (
        <Region
