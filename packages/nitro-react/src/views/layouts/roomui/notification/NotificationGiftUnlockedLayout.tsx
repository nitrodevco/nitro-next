...
export const NotificationGiftUnlockedLayout = ({ captionHeader, captionOpenTxt, captionText, layout, onClose, onOpenBtn, srcDecoImg, srcDialogBg, tintDecoImg, tintDialogBg }: NotificationGiftUnlockedLayoutProps) => {
