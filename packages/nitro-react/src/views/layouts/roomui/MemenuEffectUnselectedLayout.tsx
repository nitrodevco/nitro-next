...
export const MemenuEffectUnselectedLayout = ({ captionEffectAmount, captionEffectName, captionTimeLeft, layout, srcEffectHilite, srcEffectIcon, srcEffectIconBg }: MemenuEffectUnselectedLayoutProps) => {
