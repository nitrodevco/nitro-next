...
export const MemenuEffectUnselectedLayout = ({ captionEffectAmount, captionEffectName, captionTimeLeft, layout, onSelectedBorder, srcEffectHilite, srcEffectIcon, srcEffectIconBg }: MemenuEffectUnselectedLayoutProps) => {
