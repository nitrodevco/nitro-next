...
export const PlaylisteditorInventorySubwindowPlayPreviewLayout = ({ captionPreviewPlayAuthorName, captionPreviewPlayTrackName, layout, onStopPreviewButton, srcAuthorNameIconBitmap, srcPreviewPlayBackgroundImage, srcSongNameIconBitmap }: PlaylisteditorInventorySubwindowPlayPreviewLayoutProps) => {
