...
export const PlaylisteditorPlaylistItemLayout = ({ captionSongAuthorText, captionSongTitleText, layout, onButtonRemoveFromPlaylist, onPlaylistItem, srcAuthorNameIconBitmap, srcButtonRemoveFromPlaylistImage, srcDiskImage, srcSongNameIconBitmap }: PlaylisteditorPlaylistItemLayoutProps) => {
    return (
