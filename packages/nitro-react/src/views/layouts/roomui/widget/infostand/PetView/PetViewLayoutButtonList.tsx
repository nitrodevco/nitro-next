    ...
    return (
        ...
        >
            <Region
                ...
                onPointerTap={onPick}
                cursor="pointer"
                layout={{ position: 'absolute', left: 0, width: 54, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_pick"
                    ...
                    layout={{ position: 'absolute', left: 0, width: 139, top: 0, bottom: 0 }}
                >
            ...
            <Region
                ...
                cursor="pointer"
                layout={{ position: 'absolute', left: 64, width: 44, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_train"
            ...
            <Region
                ...
                cursor="pointer"
                layout={{ position: 'absolute', left: 118, width: 147, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_buy_food"
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 149, top: 0, bottom: 0 }}
                >
            ...
            <Region
                ...
                cursor="pointer"
                layout={{ position: 'absolute', left: 275, width: 163, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_petrespect"
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 165, top: 0, bottom: 0 }}
                >
            ...
            >
                <Button
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 152, top: 0, bottom: 0 }}
                >
            ...
            <Region
                ...
                onPointerTap={onKick}
                cursor="pointer"
                layout={{ position: 'absolute', left: 448, width: 141, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_kick"
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 143, top: 0, bottom: 0 }}
                >
            ...
            <Region
                ...
                cursor="pointer"
                layout={{ position: 'absolute', left: 600, width: 132, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_rotate"
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 141, top: 0, bottom: 0 }}
                >
            ...
            <Region
                ...
                onPointerTap={onMove}
                cursor="pointer"
                layout={{ position: 'absolute', left: 589, width: 132, top: 0, bottom: 0 }}
            >
                <Button
                    variant="1"
                    name="btn_move"
                    ...
                    textStyle="text-style-button-regular"
                    layout={{ position: 'absolute', left: 0, width: 134, top: 0, bottom: 0 }}
                >
