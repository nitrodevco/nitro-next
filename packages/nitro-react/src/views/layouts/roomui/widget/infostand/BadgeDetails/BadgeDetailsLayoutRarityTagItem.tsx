...
export const BadgeDetailsLayoutRarityTagItem = ({ captionRarity, captionRarityBorder, layout, visibleRarity, visibleRarityBorder, visibleRarityTag }: BadgeDetailsLayoutRarityTagItemProps) => {
    return (
