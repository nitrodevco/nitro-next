...
export const JukeboxViewLayoutOwnerRegionItem = ({ captionOwnerName, layout, onOwnerRegion, visibleOwnerLink, visibleOwnerName }: JukeboxViewLayoutOwnerRegionItemProps) => {
    return (
        <Region
            name="owner_region"
