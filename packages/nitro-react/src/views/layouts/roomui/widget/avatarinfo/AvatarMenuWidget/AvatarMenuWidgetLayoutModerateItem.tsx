...
export const AvatarMenuWidgetLayoutModerateItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIcon, visibleLabel }: AvatarMenuWidgetLayoutModerateItemProps) => {
