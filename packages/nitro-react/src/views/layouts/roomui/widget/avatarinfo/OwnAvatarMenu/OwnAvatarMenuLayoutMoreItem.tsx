...
export const OwnAvatarMenuLayoutMoreItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIcon, visibleLabel }: OwnAvatarMenuLayoutMoreItemProps) => {
