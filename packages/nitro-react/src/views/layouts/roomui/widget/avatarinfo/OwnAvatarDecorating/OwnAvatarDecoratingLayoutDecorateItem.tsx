...
export const OwnAvatarDecoratingLayoutDecorateItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups }: OwnAvatarDecoratingLayoutDecorateItemProps) => {
