...
export const UseProductMenuLayoutUseProductCustomPartItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups }: UseProductMenuLayoutUseProductCustomPartItemProps) => {
