...
export const UseProductMenuLayoutUseProductSaddleItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups }: UseProductMenuLayoutUseProductSaddleItemProps) => {
