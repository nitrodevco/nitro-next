...
export const AvatarMenuWidgetLayoutAmbassadorItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIcon, visibleLabel }: AvatarMenuWidgetLayoutAmbassadorItemProps) => {
