...
export const OwnAvatarMenuLayout_67Item = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIconVip, visibleLabel }: OwnAvatarMenuLayout_67ItemProps) => {
