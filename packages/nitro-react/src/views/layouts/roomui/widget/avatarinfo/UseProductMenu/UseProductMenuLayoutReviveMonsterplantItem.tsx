...
export const UseProductMenuLayoutReviveMonsterplantItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups }: UseProductMenuLayoutReviveMonsterplantItemProps) => {
