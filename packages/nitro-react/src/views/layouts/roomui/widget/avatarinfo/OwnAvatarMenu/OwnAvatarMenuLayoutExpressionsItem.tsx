...
export const OwnAvatarMenuLayoutExpressionsItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIcon, visibleLabel }: OwnAvatarMenuLayoutExpressionsItemProps) => {
