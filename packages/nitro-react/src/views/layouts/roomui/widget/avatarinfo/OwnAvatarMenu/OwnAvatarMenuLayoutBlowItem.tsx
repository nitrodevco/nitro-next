...
export const OwnAvatarMenuLayoutBlowItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIconVip, visibleLabel }: OwnAvatarMenuLayoutBlowItemProps) => {
