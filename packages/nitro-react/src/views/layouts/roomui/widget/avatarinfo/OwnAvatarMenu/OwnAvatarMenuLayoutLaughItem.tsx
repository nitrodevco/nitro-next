...
export const OwnAvatarMenuLayoutLaughItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIconVip, visibleLabel }: OwnAvatarMenuLayoutLaughItemProps) => {
