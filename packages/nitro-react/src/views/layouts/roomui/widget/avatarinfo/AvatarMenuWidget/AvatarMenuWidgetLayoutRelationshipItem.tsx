...
export const AvatarMenuWidgetLayoutRelationshipItem = ({ captionLabel, layout, onButton, visibleButton, visibleGroups, visibleIcon, visibleLabel }: AvatarMenuWidgetLayoutRelationshipItemProps) => {
