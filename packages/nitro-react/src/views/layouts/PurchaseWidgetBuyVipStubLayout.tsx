...
export const PurchaseWidgetBuyVipStubLayout = ({ layout, onCtlgBuyClubButton }: PurchaseWidgetBuyVipStubLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 360, height: 30, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText text={t('catalog.buy.widget.get.vip.to.unlock.this.product')} />
                </Region>
                <ButtonThick
                    variant="3"
