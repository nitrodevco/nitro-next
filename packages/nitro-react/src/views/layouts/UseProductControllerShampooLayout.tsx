...
export const UseProductControllerShampooLayout = ({ layout, onSaveButton }: UseProductControllerShampooLayoutProps) => {
    ...
    return (
        <Region layout={{ position: 'relative', width: 386, height: 180, ...layout }}>
            ...
            >
                ...
                >
                    <ThemeText
                        text="${useproduct.widget.text.shampoo "
                ...
                >
                    <ThemeText
                        text={t('useproduct.widget.info.shampoo')}
