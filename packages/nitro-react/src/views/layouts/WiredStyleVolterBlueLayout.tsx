...
export const WiredStyleVolterBlueLayout = ({ layout, onButton, onCheckbox, onCheckboxView, onDropdownView, onFrame, onIconbuttonDown, onIconbuttonLeft, onIconbuttonRight, onIconbuttonUp, onRadiobuttonView }: WiredStyleVolterBlueLayoutProps) => {
