...
export const AvatareditorWardrobeBaseLayout = ({ layout }: AvatareditorWardrobeBaseLayoutProps) => {
                        ...
                        >
                            ...
                            >
                                <Region
                                    ...
                                    params={786449}
                                    layout={{ width: 64, height: 412, flexShrink: 0, flexDirection: 'column', gap: 3 }}
                                >
                                    <Region
                                        name="slot_template"
                                        params={16}
