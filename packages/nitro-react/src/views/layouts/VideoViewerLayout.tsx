...
export const VideoViewerLayout = ({ layout, onClose, onPlaylistNext, onPlaylistPrev }: VideoViewerLayoutProps) => {
                    ...
                    >
                        ...
                        >
                            <Region
                                name="item"
                                params={147473}
                                layout={{ width: 278, height: 121, flexShrink: 0 }}
                            >
                                <Border
                                    variant="103"
                                ...
                                >
                                    ...
                                    >
                                        <Region
                                            name="item_title"
                                            params={16}
                                            layout={{ width: 57, height: 20, flexShrink: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}
                                        >
                                            <ThemeText
                                                text="Item Title"
