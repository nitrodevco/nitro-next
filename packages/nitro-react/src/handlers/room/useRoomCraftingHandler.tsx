 ...
 */
export const useRoomCraftingHandler = () => {
    ...
    useMessageListener(CraftableProductsMessage, (message) => {
        merge({
    ...
    useMessageListener(CraftingRecipeMessage, (message) => {
        merge({ ingredients: message.ingredients });
    });

    useMessageListener(CraftingRecipesAvailableMessage, (message) => {
        merge({ recipeComplete: message.recipeComplete });
    });

    useMessageListener(CraftingResultMessage, (message) => {
