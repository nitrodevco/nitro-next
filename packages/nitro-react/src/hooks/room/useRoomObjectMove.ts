...
/**
 * Dragging a floor or wall item to a new spot while it is being moved -
 * `RoomObjectEventHandler.handleObjectMove`: the object follows the tile or wall location under
 * the mouse, greyed out where it cannot go.
 */
