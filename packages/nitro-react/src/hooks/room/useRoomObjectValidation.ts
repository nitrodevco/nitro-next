...
/**
 * Whether a location is a valid place for an object -
 * `RoomObjectEventHandler.validateFurnitureLocation` and `validateWallItemLocation`, checked
 * against the stacking height map and the wall geometry, with the surface under the mouse that
 * the object is dragged over.
 */
